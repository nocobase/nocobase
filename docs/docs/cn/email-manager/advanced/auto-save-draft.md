...
title: "自动保存草稿"
description: "开启自动保存草稿后，邮件编辑过程中实时保存草稿，再次打开同一发件人收件人时提示是否使用已保存草稿。"
keywords: "自动保存草稿,邮件草稿,草稿保存,NocoBase"
---
# 自动保存草稿

在 **保存草稿** 按钮中可开启 **自动保存草稿** 功能。

![](https://static-docs.nocobase.com/email-manager/Loading--10-31-2025_08_29_PM.png)

启用后，系统在邮件编辑过程中会自动实时保存草稿，确保内容不丢失。

![](https://static-docs.nocobase.com/email-manager/Loading--10-31-2025_08_31_PM.png)

再次打开同一发件人和收件人的邮件编辑框时，系统会提示是否使用已保存的草稿。
