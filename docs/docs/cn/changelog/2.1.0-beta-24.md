...
NocoBase 2.1.0-beta.24 是一次**围绕 AI 能力**的重要升级。这个版本能够让你把 AI Agent 接入 NocoBase —— 从 CLI 接入、AI 搭建，到 AI 员工能力增强，AI 开发插件等，覆盖了环境接入、系统搭建和业务协作的完整流程。同时我们也继续补齐了 V2 页面与核心能力的适配。
