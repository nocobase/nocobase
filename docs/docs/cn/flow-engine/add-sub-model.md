...
description: "AddSubModelButton：在指定 FlowModel 中添加 subModel，支持异步菜单、分组、子菜单、继承类筛选与开关形态。"
keywords: "AddSubModelButton,subModel,子模型,FlowModel,FlowEngine,异步菜单,分组菜单"
---
