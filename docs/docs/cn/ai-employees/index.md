...
- [使用技能](/ai-employees/features/tools)：配置技能权限（`Ask` / `Allow`），控制执行风险。
...
- [内置 AI 员工](/ai-employees/built-in/)：了解预置员工定位与适用场景。
- [权限控制](/ai-employees/permission)：按组织权限模型控制员工、技能与数据访问。
- [AI 知识库](/ai-employees/knowledge-base/index)：引入企业知识，提升回答稳定性与可追溯性。
- [工作流 AI 员工节点](/ai-employees/workflow/nodes/employee/configuration)：将 AI 员工能力编排进自动化流程。
