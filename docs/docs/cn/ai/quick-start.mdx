...
`nb init` 完成后，你的应用里已经有一个 AI Portal 了。让 AI Agent 在它的源码目录里写 React 代码，NocoBase 负责认证、数据和权限——不用学配置规则，页面想怎么做就怎么做。请参阅 [AI 搭建快速开始](../ai-portal/index.md)。

### 开始 AI 无代码搭建

用自然语言描述需求，AI 帮你完成数据建模、页面搭建、工作流编排——用对话代替手动配置，不需要写代码。请参阅 [AI 无代码搭建快速开始](../ai-builder/index.md#用对话代替手动配置)。
