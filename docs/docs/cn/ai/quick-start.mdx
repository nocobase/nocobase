...
- Node.js >= 22
- Yarn 1.x
- pnpm（只有开发 [AI Portal](../ai-builder/ai-portal/index.md) 时需要，Portal 模板用它安装依赖和启动开发服务）
...
用自然语言描述需求，AI 帮你完成数据建模、页面搭建、工作流编排——用对话代替手动配置，不需要写代码。请参阅 [AI 搭建快速开始](../ai-builder/index.md#用对话代替手动配置)。
...
- [AI Portal](../ai-builder/ai-portal/index.md) — 让 AI Agent 写前端代码，NocoBase 做基座，搭建完整系统
