---
title: "工作流 - 使用变量"
description: "使用变量：触发上下文、上游节点数据、局域变量、系统变量，串接流程。"
keywords: "工作流,变量,Variable,触发上下文,流程变量,NocoBase"
---
...
我们在 [快速开始](../getting-started.md) 中已经多次使用了变量的功能，例如在运算节点中，我们可以使用变量来引用触发上下文数据，来进行计算：
