...
![启用引用区块（插件管理器）](https://static-docs.nocobase.com/block-reference-enable-20251102.png)
...
![引用区块添加与配置演示](https://static-docs.nocobase.com/20251102193949_rec_.gif)

### 如何获取区块 UID
- 打开目标区块的设置菜单，点击 `复制 UID` 即可复制该区块的 UID。  

![复制区块 UID 示例](https://static-docs.nocobase.com/block-reference-copy-uid-20251102.png)
...
![引用区块配置界面](https://static-docs.nocobase.com/block-reference-settings-20251102.png)
...
![目标区块无效时的错误状态](https://static-docs.nocobase.com/block-reference-error-20251102.png)
