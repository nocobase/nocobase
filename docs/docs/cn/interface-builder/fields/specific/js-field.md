---
title: "JSField JS 字段"
description: "JSField JS 字段：在表单字段中嵌入自定义 JavaScript 逻辑，支持 React、ctx 上下文。"
keywords: "JSField,JS 字段,自定义字段,JavaScript,界面搭建,NocoBase"
---
...
- [AI 员工 · Nathan：前端工程师](/ai-employees/built-in/nathan)
