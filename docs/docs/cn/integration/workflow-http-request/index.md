...
HTTP 请求节点是工作流插件的内置功能,确保 **[工作流](/plugins/@nocobase/plugin-workflow/index.md)** 插件已启用。
...
- [工作流插件文档](/plugins/@nocobase/plugin-workflow/index.md)
- [工作流：HTTP 请求节点](/workflow/nodes/request)
- [工作流：Webhook 触发器](/integration/workflow-webhook/index.md)
