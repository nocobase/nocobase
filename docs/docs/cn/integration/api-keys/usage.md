...
确保已启用内置的[认证：API 密钥](/plugins/@nocobase/plugin-api-keys/index.md)插件。启用后，系统设置中将出现新的 API 密钥配置页面。
...
打开 [API 文档](/plugins/@nocobase/plugin-api-doc/index.md)插件，查看每个 API 端点的请求方法、URL、参数和请求头。
...
**其他资源：**
- [API 密钥插件文档](/plugins/@nocobase/plugin-api-keys/index.md)
- [API 文档插件](/plugins/@nocobase/plugin-api-doc/index.md)
