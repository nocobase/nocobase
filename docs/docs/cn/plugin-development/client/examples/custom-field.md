...
完整源码见 [@nocobase-example/plugin-field-simple](https://github.com/nocobase/nocobase/tree/main/packages/plugins/%40nocobase-example/plugin-field-simple)。如果你想直接在本地跑起来看效果：
...
- [@nocobase-example/plugin-field-simple](https://github.com/nocobase/nocobase/tree/main/packages/plugins/%40nocobase-example/plugin-field-simple) — 自定义字段组件完整示例
