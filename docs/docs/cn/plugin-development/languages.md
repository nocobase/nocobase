...
NocoBase 提供了多语言支持（i18n），下面是当前内置的语言列表。每个语言配置由 **语言代码（Locale Code）** 和 **显示名称（Label）** 组成。
...
- **界面显示** — 在「语言切换」菜单中展示 `label`
- **国际化文件加载** — 根据语言代码加载对应的翻译 JSON 文件
...
- [服务端国际化](./server/i18n.md) — 服务端 i18n 多语言配置与使用
