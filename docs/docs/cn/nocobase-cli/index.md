...
1. 先看 [使用 CLI 安装应用](./installation/cli.md)，完成一次 `nb init`。
...
| 我想要…… | 去哪里看 |
| --- | --- |
| 还没有应用，先装一个新的 NocoBase，并保存成 CLI env | [使用 CLI 安装应用](./installation/cli.md) |
| 已经有一个运行中的 NocoBase，想接入 CLI 管理 | [使用 CLI 安装应用](./installation/cli.md) |
