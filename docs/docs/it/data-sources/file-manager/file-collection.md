...
I file sono record all'interno di una collezione con una struttura specifica, nota come collezione di file. Viene utilizzata per archiviare i metadati dei file e può essere gestita tramite il Gestore File.
