...
De subtabel is geschikt voor het beheren van 'één-op-veel' relatievelden. U kunt hiermee in bulk nieuwe gegevens aanmaken en koppelen aan de doel-collectie, of bestaande gegevens selecteren en koppelen.
...
> Bepaal of het is toegestaan om bestaande gegevens te ontkoppelen van het relatieveld in het bewerkingsformulier.
