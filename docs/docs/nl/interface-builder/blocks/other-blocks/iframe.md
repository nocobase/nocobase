...
In HTML-modus ondersteunt de blokinhoud het gebruik van de syntaxis van de **[Liquid templates-engine](https://shopify.github.io/liquid/basics/introduction/)**.
...
- Ondersteunt het selecteren van variabelen uit de huidige blokcontext via de variabelekiezer.
