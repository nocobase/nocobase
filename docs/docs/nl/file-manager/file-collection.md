...
Een bestands-collectie is een collectie die specifiek is ontworpen voor het opslaan van metadata van bestanden. Deze collectie bevat ingebouwde velden zoals bestandsnaam, grootte, type en opslagpad.

## Een bestands-collectie aanmaken

![20240324090414](https://static-docs.nocobase.com/20240324090414.png)

## Standaardvelden in de bestands-collectie
