...
Popis pole je krátký popisný text zobrazený světle šedým písmem pod komponentou pole, který pomáhá uživatelům porozumět účelu pole a požadavkům na zadávání dat.
