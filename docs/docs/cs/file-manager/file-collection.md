...
Kolekce souborů je kolekce určená speciálně k ukládání metadat souborů. Obsahuje předdefinovaná pole, jako je název souboru, velikost, typ a cesta k úložišti.

## Vytvoření kolekce souborů

![20240324090414](https://static-docs.nocobase.com/20240324090414.png)

## Předdefinovaná pole v kolekci souborů
