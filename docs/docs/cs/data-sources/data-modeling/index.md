...
Datové modelování je klíčovým krokem při návrhu databází, zahrnující hloubkovou analýzu a abstrakci různých typů dat a jejich vzájemných vztahů v reálném světě. V tomto procesu se snažíme odhalit vnitřní souvislosti mezi daty a formalizovat je do datových modelů, čímž pokládáme základy pro databázovou strukturu informačního systému. NocoBase je platforma řízená datovými modely, která nabízí následující funkce:

## Podpora přístupu k datům z různých zdrojů

NocoBase podporuje zdroje dat z různých původů, včetně běžných databází, platforem API/SDK a souborů.

![20240512085558](https://static-docs.nocobase.com/20240512085558.png)

NocoBase poskytuje [plugin pro správu zdrojů dat](/data-sources/data-source-manager), který slouží ke správě různých zdrojů dat a jejich kolekcí. Plugin pro správu zdrojů dat poskytuje pouze rozhraní pro správu všech zdrojů dat a neumožňuje přímý přístup k datům. Je třeba jej používat ve spojení s různými pluginy pro zdroje dat. Mezi aktuálně podporované zdroje dat patří:
...
- [KingbaseES](/data-sources/data-source-kingbase): Používá databázi KingbaseES jako zdroj dat, může být použita jako hlavní i externí databáze.
...
| [Stromová kolekce](/data-sources/collection-tree) | Stromově strukturovaná kolekce, v současné době podporuje pouze model sousednosti. |
...
| [Připojení k externím datům](/data-sources/collection-fdw) | Umožňuje databázovému systému přímý přístup a dotazování dat v externích zdrojích dat na základě technologie FDW. |

![20240512102212](https://static-docs.nocobase.com/20240512102212.png)

Více obsahu naleznete v sekci „[Kolekce / Přehled](/data-sources/data-modeling/collection)“.

## Nabízí bohatou škálu typů polí

![20240512110352](https://static-docs.nocobase.com/20240512110352.png)

Více obsahu naleznete v sekci „[Pole kolekcí / Přehled](/data-sources/data-modeling/collection-fields)“.