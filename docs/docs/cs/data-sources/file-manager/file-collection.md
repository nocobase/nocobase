...
Soubory jsou záznamy ve speciálně strukturované kolekci, známé jako kolekce souborů. Slouží k ukládání metadat souborů a lze ji spravovat prostřednictvím Správce souborů.

## Uživatelská příručka

Vytvoření kolekce souborů

![20240324090414](https://static-docs.nocobase.com/20240324090414.png)

Přednastavená pole v kolekci souborů
