...
Tento dokument byl přeložen pomocí AI. Pro přesné informace se podívejte na [anglickou verzi](/solution/crm/index).
:::
...
- **Multi-tenant support**: Horizontal scaling across multi-workspace/multi-app, distributing to independent sales teams
