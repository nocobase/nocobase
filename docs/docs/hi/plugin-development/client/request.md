...
NocoBase, [Axios](https://axios-http.com/) पर आधारित एक `APIClient` प्रदान करता है, जिसका उपयोग आप किसी भी ऐसी जगह से HTTP अनुरोध भेजने के लिए कर सकते हैं जहाँ `Context` उपलब्ध हो।
...
`ctx.api.request()` अनुरोध भेजने का सबसे अधिक उपयोग किया जाने वाला तरीका है। इसके पैरामीटर और रिटर्न वैल्यू [axios.request()](https://axios-http.com/docs/req_config) के समान ही हैं।
...
अधिक उपलब्ध कॉन्फ़िगरेशन के लिए, [Axios डिफ़ॉल्ट कॉन्फ़िगरेशन](https://axios-http.com/docs/config_defaults) देखें।
...
वास्तविक विकास में, आप अनुरोध के जीवनचक्र और स्थिति को अधिक आसानी से संभालने के लिए [ahooks](https://ahooks.js.org/hooks/use-request/index) द्वारा प्रदान किए गए `useRequest` हुक का उपयोग कर सकते हैं।
