...
`CronJobManager` NocoBase द्वारा प्रदान किया गया एक [cron](https://www.npmjs.com/package/cron) आधारित नियत कार्य प्रबंधक है। यह प्लगइन को सर्वर-साइड पर नियत कार्य रजिस्टर करने की अनुमति देता है, ताकि विशिष्ट लॉजिक को समय-समय पर निष्पादित किया जा सके।
...
`CronJobParameters` प्रकार की परिभाषा इस प्रकार है ([cron](https://www.npmjs.com/package/cron) से):
...
> 💡 आप एक्सप्रेशन बनाने में मदद के लिए [crontab.guru](https://crontab.guru/) का उपयोग कर सकते हैं।
