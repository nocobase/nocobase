...
यह दस्तावेज़ AI द्वारा अनुवादित है। सटीक जानकारी के लिए कृपया [अंग्रेज़ी संस्करण](/file-manager/file-preview/ms-office) देखें।
:::
...
Collection के फ़ाइल फ़ील्ड में Office फ़ाइल (Word / Excel / PowerPoint) सफलतापूर्वक अपलोड करने के बाद, आप संबंधित फ़ाइल आइकन या लिंक पर क्लिक करके, पॉपअप या एम्बेडेड पूर्वावलोकन इंटरफ़ेस में फ़ाइल सामग्री देख सकते हैं।
