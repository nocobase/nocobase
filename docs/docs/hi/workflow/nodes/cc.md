...
यह दस्तावेज़ AI द्वारा अनुवादित है। सटीक जानकारी के लिए कृपया [अंग्रेज़ी संस्करण](/workflow/nodes/cc) देखें।
:::
...
### टू-डू कार्ड <Badge>2.0+</Badge>

इसका उपयोग टू-डू सेंटर की "मुझे सीसी" (CC to Me) सूची में टास्क कार्ड को कॉन्फ़िगर करने के लिए किया जा सकता है।

![20260213010947](https://static-docs.nocobase.com/20260213010947.png)

कार्ड में आप उन व्यावसायिक फ़ील्ड्स (संबंध फ़ील्ड्स को छोड़कर) को स्वतंत्र रूप से कॉन्फ़िगर कर सकते हैं जिन्हें आप प्रदर्शित करना चाहते हैं।

वर्कफ़्लो सीसी टास्क बनने के बाद, टू-डू सेंटर सूची में कस्टमाइज़्ड टास्क कार्ड देखा जा सकता है:
