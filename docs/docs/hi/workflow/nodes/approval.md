...
यह दस्तावेज़ AI द्वारा अनुवादित है। सटीक जानकारी के लिए कृपया [अंग्रेज़ी संस्करण](/workflow/nodes/approval) देखें।
:::
...
प्रक्रिया में प्लस ("+") बटन पर क्लिक करें, "अनुमोदन" नोड जोड़ें, और फिर अनुमोदन नोड बनाने के लिए पास मोड में से एक चुनें:

![अनुमोदन नोड_बनाएँ](https://static-docs.nocobase.com/20251107000938.png)
...
1.  सीधा पास मोड: आमतौर पर सरल प्रक्रियाओं के लिए उपयोग किया जाता है, अनुमोदन नोड पास होता है या नहीं, यह केवल यह निर्धारित करता है कि प्रक्रिया समाप्त होती है या नहीं, यदि यह पास नहीं होता है, तो प्रक्रिया सीधे बाहर निकल जाती है।
    ...
    ![अनुमोदन नोड_पास मोड_सीधा पास मोड](https://static-docs.nocobase.com/20251107001043.png)

2.  शाखा मोड: आमतौर पर अधिक जटिल डेटा तर्क के लिए उपयोग किया जाता है, अनुमोदन नोड कोई भी परिणाम उत्पन्न करने के बाद, इसके परिणाम शाखा के भीतर अन्य नोड निष्पादित होते रह सकते हैं।

    ![अनुमोदन नोड_पास मोड_शाखा मोड](https://static-docs.nocobase.com/20251107001234.png)
...
अनुमोदक उन उपयोगकर्ताओं का समूह है जो इस नोड की अनुमोदन कार्रवाई के लिए जिम्मेदार हैं, यह एक या अधिक उपयोगकर्ता हो सकते हैं, चयन का स्रोत उपयोगकर्ता सूची से चयनित एक स्थिर मान हो सकता है, या एक चर द्वारा निर्दिष्ट एक गतिशील मान हो सकता है:

![अनुमोदन नोड_अनुमोदक](https://static-docs.nocobase.com/20251107001433.png)

एक चर का चयन करते समय, आप केवल संदर्भ और नोड परिणामों से उपयोगकर्ता डेटा की प्राथमिक कुंजी या विदेशी कुंजी का चयन कर सकते हैं। यदि चयनित चर निष्पादन के दौरान एक सरणी (एक-से-कई संबंध) है, तो सरणी में प्रत्येक उपयोगकर्ता को पूरे अनुमोदक समूह में विलय कर दिया जाएगा।
...
जब अनुमोदक समूह में कई उपयोगकर्ता हों, तो विभिन्न सहयोग मोड का चयन विभिन्न प्रसंस्करण तरीकों का प्रतिनिधित्व करता है:

1. कोई भी (Anyone): यदि कोई एक व्यक्ति पास करता है, तो नोड पास माना जाता है, सभी के अस्वीकार करने पर ही नोड अस्वीकार माना जाता है।
...
3. मतदान (Vote): नोड को पास करने के लिए पास करने वाले लोगों की संख्या एक निर्धारित अनुपात से अधिक होनी चाहिए, अन्यथा नोड अस्वीकार माना जाता है।

वापस करने की कार्रवाई के लिए, किसी भी मोड में, यदि अनुमोदक समूह में कोई उपयोगकर्ता इसे वापस करने के रूप में संसाधित करता है, तो नोड सीधे प्रक्रिया से बाहर निकल जाएगा।

### प्रसंस्करण क्रम

इसी तरह, जब अनुमोदक समूह में कई उपयोगकर्ता हों, तो विभिन्न प्रसंस्करण क्रम का चयन विभिन्न प्रसंस्करण तरीकों का प्रतिनिधित्व करता है:

1. समानांतर: सभी अनुमोदक किसी भी क्रम में संसाधित कर सकते हैं, पहले या बाद में संसाधित करने का कोई महत्व नहीं है।
2. अनुक्रमिक: अनुमोदक अनुमोदक समूह में क्रम के अनुसार क्रमिक रूप से संसाधित करते हैं, अनुमोदकों में से पिछला व्यक्ति सबमिट करने के बाद ही अगला व्यक्ति संसाधित कर सकता है।
...
जब "पास मोड" को "शाखा मोड" पर सेट किया जाता है, तो आप अस्वीकृति शाखा समाप्त होने के बाद वर्कफ़्लो से बाहर निकलने का विकल्प चुन सकते हैं। इसे चुनने के बाद, अस्वीकृति शाखा के अंत में एक "✗" प्रदर्शित होगा, जो यह दर्शाता है कि इस शाखा के समाप्त होने के बाद बाद के नोड जारी नहीं रहेंगे:

![अनुमोदन नोड_अस्वीकृति के बाद बाहर निकलें](https://static-docs.nocobase.com/20251107001839.png)
...
![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_पॉपअप](https://static-docs.nocobase.com/20251107001958.png)
...
![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_ब्लॉक जोड़ें](https://static-docs.nocobase.com/20251107002604.png)

#### मूल सबमिशन सामग्री

इसमें अनुमोदन सामग्री विवरण ब्लॉक वह डेटा ब्लॉक है जिसे आरंभकर्ता द्वारा सबमिट किया गया है, एक सामान्य डेटा ब्लॉक के समान, आप संग्रह के फ़ील्ड घटक जोड़ सकते हैं, और अनुमोदक को देखने के लिए आवश्यक सामग्री को व्यवस्थित करने के लिए उन्हें स्वतंत्र रूप से व्यवस्थित कर सकते हैं:

![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_विवरण ब्लॉक](https://static-docs.nocobase.com/20251107002925.png)

#### प्रसंस्करण फ़ॉर्म

संचालन फ़ॉर्म ब्लॉक में आप इस नोड द्वारा समर्थित कार्रवाई बटन जोड़ सकते हैं, जिनमें "पास", "अस्वीकार", "वापस करें", "पुनः असाइन करें" और "हस्ताक्षरकर्ता जोड़ें":

![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_संचालन फ़ॉर्म ब्लॉक](https://static-docs.nocobase.com/20251107003015.png)
...
![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_संचालन फ़ॉर्म_अनुमोदन सामग्री फ़ील्ड संशोधित करें](https://static-docs.nocobase.com/20251107003206.png)
...
![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_संचालन फ़ॉर्म_प्रसंस्करण कॉन्फ़िगरेशन](https://static-docs.nocobase.com/20251107003314.png)
...
![अनुमोदन नोड_इंटरफ़ेस कॉन्फ़िगरेशन_संचालन फ़ॉर्म_असाइनमेंट स्कोप](https://static-docs.nocobase.com/20241226232321.png)

नोड के मूल अनुमोदक कॉन्फ़िगरेशन के समान, असाइनमेंट स्कोप सीधे चयनित अनुमोदक भी हो सकते हैं, या उपयोगकर्ता संग्रह की क्वेरी शर्तों पर आधारित हो सकते हैं, यह अंततः एक समूह में विलय हो जाएगा, और इसमें वे उपयोगकर्ता शामिल नहीं होंगे जो पहले से ही अनुमोदक समूह में हैं।
...
### "मेरे अनुमोदन" कार्ड <Badge>2.0+</Badge>

इसका उपयोग टू-डू सेंटर की "मेरे अनुमोदन" सूची में टास्क कार्ड को कॉन्फ़िगर करने के लिए किया जा सकता है।

![20260214141554](https://static-docs.nocobase.com/20260214141554.png)

कार्ड में आप अपनी इच्छानुसार व्यावसायिक फ़ील्ड (संबंध फ़ील्ड को छोड़कर) या अनुमोदन से संबंधित जानकारी प्रदर्शित करने के लिए स्वतंत्र रूप से कॉन्फ़िगर कर सकते हैं।

अनुमोदन के इस नोड में प्रवेश करने के बाद, टू-डू सेंटर सूची में कस्टमाइज़ किया गया टास्क कार्ड देखा जा सकता है:
