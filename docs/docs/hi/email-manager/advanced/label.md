...
ईमेल विवरण के दाईं ओर, आप एक ईमेल के लिए **टैग चुन सकते हैं**:
...
यदि आप एक नया टैग बनाते हैं, तो वह डिफ़ॉल्ट रूप से चुना जाएगा। आप मैन्युअल रूप से अन्य टैग भी चुन सकते हैं:
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

ईमेल सूची में, आप ईमेल से संबंधित टैग देख सकते हैं:
