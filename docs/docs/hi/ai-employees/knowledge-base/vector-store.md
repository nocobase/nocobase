...
यह दस्तावेज़ AI द्वारा अनुवादित है। सटीक जानकारी के लिए कृपया [अंग्रेज़ी संस्करण](/ai-employees/knowledge-base/vector-store) देखें।
:::
...
- `LLM service` में, पहले से कॉन्फ़िगर की गई LLM सेवा चुनें। संदर्भ के लिए देखें: [LLM सेवा प्रबंधन](/ai-employees/features/llm-service);
