...
โปรดดูที่ [การติดตั้งและอัปเกรดปลั๊กอินเชิงพาณิชย์](https://www.nocobase.com/en/blog/nocobase-commercial-license-activation-guide) ครับ/ค่ะ

### การติดตั้ง LibreOffice (ไม่บังคับ)

การสร้างไฟล์ PDF จำเป็นต้องติดตั้ง LibreOffice ครับ/ค่ะ [โปรดดาวน์โหลดได้จากเว็บไซต์ทางการ](https://www.libreoffice.org/download/download-libreoffice) สำหรับเวอร์ชัน Docker คุณสามารถสร้างสคริปต์ได้โดยตรงในไดเรกทอรี `./storage/scripts` ครับ/ค่ะ
