...
| `--skip-download` | boolean | Pula o download dos arquivos da aplicação ou o pull da imagem Docker antes da instalação e reutiliza recursos locais já existentes |
