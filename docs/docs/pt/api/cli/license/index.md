...
Gerencia o licenciamento comercial do NocoBase, incluindo ativação da licença, IDs de instância, status da licença e plugins licenciados.
...
| Comando | Descrição |
| --- | --- |
| [`nb license activate`](./activate.md) | Ativar o licenciamento comercial para o env atual |
