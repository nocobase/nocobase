...
Acesse a página de configuração do **plugin** de Agente de IA e clique na aba superior `Vector database` para entrar na página de gerenciamento do banco de dados vetorial.
