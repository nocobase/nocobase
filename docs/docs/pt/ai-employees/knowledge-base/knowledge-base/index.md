...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Gerenciamento de documentos](./documents) |
| View, edit, disable, or delete document segments | [Gerenciamento de segmentos](./segments) |
| Test which segments a question can match | [Testes de acerto](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Configurações](./settings) |
