...
As rotas no NocoBase v2 recebem o prefixo `/studio` por padrão. Por exemplo, se você registrou `path: '/hello'`, o endereço de acesso real é `/studio/hello`:

```ts
this.router.add('hello', {
  path: '/hello', // 实际访问 -> /studio/hello
...
- [Router de rotas](../router) — registro de rotas e prefixo `/studio`
