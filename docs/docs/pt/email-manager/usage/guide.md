...
E-mails com o mesmo assunto serão agrupados, e o campo de assunto indicará o número total de e-mails na conversa.
Quando alguns e-mails dentro da mesma conversa corresponderem aos critérios de filtro, o e-mail raiz da conversa será exibido, e o tipo do e-mail raiz atual será indicado ao lado do campo de assunto.
