...
No lado direito dos detalhes do e-mail, você pode **selecionar tags** para um e-mail:
...
Se você criar uma nova tag, ela será selecionada por padrão. Você também pode selecionar outras tags manualmente:

![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

Na lista de e-mails, você pode visualizar as tags correspondentes aos e-mails:
