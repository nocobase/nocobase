---
displayName: "Workflow: Evento de ação personalizada"
...
Este documento foi traduzido por IA. Para informações precisas, consulte a [versão em inglês](/plugins/@nocobase/plugin-workflow-custom-action-trigger/index).
:::
