...
Para gerar PDFs, é necessário instalar o LibreOffice. [Você pode baixá-lo no site oficial](https://www.libreoffice.org/download/download-libreoffice). Para a versão Docker, você pode criar um script diretamente no diretório `./storage/scripts`.
