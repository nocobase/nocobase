...
- [`@nocobase/plugin-auth-sms`](../auth-sms/index.md) - Oferece a funcionalidade de login com verificação por SMS
- [`@nocobase/plugin-auth-saml`](../auth-saml/index.md) - Oferece a funcionalidade de login SAML SSO
- [`@nocobase/plugin-auth-oidc`](../auth-oidc/index.md) - Oferece a funcionalidade de login OIDC SSO
- [`@nocobase/plugin-auth-cas`](../auth-cas/index.md) - Oferece a funcionalidade de login CAS SSO
- [`@nocobase/plugin-auth-ldap`](../auth-ldap/index.md) - Oferece a funcionalidade de login LDAP SSO
- [`@nocobase/plugin-auth-wecom`](../auth-wecom/index.md) - Oferece a funcionalidade de login com WeCom
- [`@nocobase/plugin-auth-dingtalk`](../auth-dingtalk/index.md) - Oferece a funcionalidade de login com DingTalk
