...
> Consulte a "[Documentação de Instalação](https://docs.nocobase.com/get-started/quickstart)"
...
> Consulte a "[Documentação de Implantação](https://docs.nocobase.com/get-started/deployment/production)"
