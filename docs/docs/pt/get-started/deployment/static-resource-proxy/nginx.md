...
Se você quer configurar hoje o proxy de produção para uma aplicação NocoBase, o melhor ponto de partida é [Reverse proxy em produção](../../../quickstart/production/reverse-proxy/index.md) e, em seguida, a página [Nginx](../../../quickstart/production/reverse-proxy/nginx.md).
