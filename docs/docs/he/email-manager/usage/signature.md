...
כאן תוכלו לנהל את החתימות שלכם. סמנו את האפשרות שלפני חתימה כדי להגדיר אותה כחתימת ברירת המחדל:

![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_05_37_PM.png)

## שימוש בחתימות

בתוך תיבת תוכן הדוא"ל, לחצו על אייקון החתימה כדי לבחור את החתימה הרצויה:
