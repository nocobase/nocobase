...
בצד ימין של פרטי הדוא"ל, באפשרותכם **לבחור תגיות** עבור הדוא"ל:
...
אם תיצרו תגית חדשה, היא תיבחר אוטומטית כברירת מחדל. תוכלו גם לבחור תגיות אחרות באופן ידני:
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

ברשימת הדוא"ל, תוכלו לראות את התגיות המשויכות לדוא"ל:
