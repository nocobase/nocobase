...
מסמך זה תורגם על ידי AI. למידע מדויק, אנא עיינו ב[גרסה באנגלית](/solution/crm/index).
:::
...
- **Configuration-first**: Data models, interface configurations, and business processes are all configurable via UI — no code required
