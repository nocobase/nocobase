...
עיינו בתיעוד אודות התקנה ושדרוג של תוספים מסחריים.

### התקנת LibreOffice (אופציונלי)

כדי ליצור קובצי PDF, יש להתקין את LibreOffice. [הורידו אותו מהאתר הרשמי](https://www.libreoffice.org/download/download-libreoffice). עבור גרסת Docker, תוכלו ליצור סקריפט ישירות בספריית `./storage/scripts`.
...
תוכן הקובץ `install-libreoffice.sh` הוא כדלקמן:
