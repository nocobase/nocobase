...
-   **מאמת (`Authenticator`)**: ישות המייצגת שיטת אימות, הנשמרת בפועל ב[אוסף](/collections) ומתאימה לרשומת תצורה של סוג אימות מסוים (`AuthType`). שיטת אימות אחת יכולה לכלול מספר מאמתים, המתאימים למספר תצורות, ומספקים שיטות אימות משתמשים שונות.
