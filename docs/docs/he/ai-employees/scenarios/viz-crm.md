---
title: סוכן AI · Viz: מדריך הגדרת תרחיש CRM
description: באמצעות דוגמת ה-CRM, למדו כיצד לגרום לאנליסט התובנות מבוסס ה-AI שלכם להבין באמת את העסק שלכם ולממש את מלוא הפוטנציאל שלו.
---
:::tip הודעת תרגום AI
