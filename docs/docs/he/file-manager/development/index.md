...
* `list`: רשימת הקבצים
* `originalNode`: צומת תצוגת תמונה מובנה, ניתן לשימוש חוזר

`originalNode` משמש לעיתים קרובות כדי להשתמש מחדש בצומת התצוגה המובנה עבור סוגי תמונות ולהימנע ממימוש מחדש.
