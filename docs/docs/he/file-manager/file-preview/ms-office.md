...
מסמך זה תורגם על ידי AI. למידע מדויק, אנא עיינו ב[גרסה באנגלית](/file-manager/file-preview/ms-office).
:::
...
לאחר העלאה מוצלחת של קובץ Office (Word / Excel / PowerPoint) לשדה קובץ ב-Collection, תוכלו ללחוץ על אייקון הקובץ או על הקישור המתאים כדי לצפות בתוכן הקובץ בממשק תצוגה מקדימה שיופיע בחלון קופץ או יוטמע בדף.
