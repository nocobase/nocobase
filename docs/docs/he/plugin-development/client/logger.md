...
NocoBase מספקת מערכת יומנים בעלת ביצועים גבוהים המבוססת על [pino](https://github.com/pinojs/pino). בכל מקום שבו יש לכם גישה ל-`context`, תוכלו לקבל מופע של יומן דרך `ctx.logger` כדי לתעד יומנים חשובים במהלך ריצת ה[תוסף](./plugin-development/overview.md) או המערכת.
...
`ctx.logger` מזריק באופן אוטומטי מידע הקשר, כגון ה[תוסף](./plugin-development/overview.md) הנוכחי, המודול או מקור הבקשה, מה שמאפשר לעקוב אחר מקור היומנים בצורה מדויקת יותר.
...
באפשרותכם ליצור מופעי יומן מותאמים אישית ב[תוספים](./plugin-development/overview.md) שלכם, תוך ירושה או הרחבה של הגדרות ברירת המחדל:
...
## שיטות עבודה מומלצות בפיתוח [תוספים](./plugin-development/overview.md)

1.  **השתמשו ביומן ההקשר**
    השתמשו ב-`ctx.logger` בהקשרי [תוסף](./plugin-development/overview.md), מודל או יישום, כדי לשאת באופן אוטומטי מידע על המקור.
...
באמצעות שיטות אלו, מפתחים יכולים לעקוב ביעילות רבה יותר אחר תהליכי ביצוע של [תוספים](./plugin-development/overview.md), לפתור בעיות, ולשמור על מערכת יומנים מובנית וניתנת להרחבה.