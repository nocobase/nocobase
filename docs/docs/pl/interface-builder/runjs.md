...
- Niestandardowe renderowanie treści (pól, bloków, kolumn, elementów itp.)  
- Niestandardową logikę interakcji (kliknięcia przycisków, powiązania zdarzeń)  
- Dynamiczne zachowania w połączeniu z danymi kontekstowymi  
...
Dokumentacja: [Blok JS](/interface-builder/blocks/other-blocks/js-block)
...
Dokumentacja: [Akcja JS](/interface-builder/actions/types/js-action)
...
Dokumentacja: [Pole JS](/interface-builder/fields/specific/js-field)
...
Dokumentacja: [Element JS](/interface-builder/fields/specific/js-item)
...
Dokumentacja: [Kolumna tabeli JS](/interface-builder/fields/specific/js-column)
...
Dokumentacja: [Reguły powiązań](/interface-builder/linkage-rule)
...
Dokumentacja: [Przepływ zdarzeń](/interface-builder/event-flow)