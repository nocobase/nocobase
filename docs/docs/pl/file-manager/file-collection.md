...
Kolekcja plików to kolekcja przeznaczona specjalnie do przechowywania metadanych plików. Zawiera wbudowane pola, takie jak nazwa pliku, rozmiar, typ i ścieżka przechowywania.
