...
Ten dokument został przetłumaczony przez AI. Aby uzyskać dokładne informacje, zapoznaj się z [wersją angielską](/solution/crm/index).
:::
...
**Competing products on the market:** Salesforce, HubSpot, Zoho CRM, Pipedrive, Odoo CRM, SuiteCRM, etc.
...
- **Multi-tenant support**: Horizontal scaling across workspaces/multi-app, distributing to independent sales teams
