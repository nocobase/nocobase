...
Proszę zapoznać się z instrukcją [Instalacja i aktualizacja wtyczek komercyjnych](https://www.nocobase.com/c/blog/nocobase-commercial-license-activation-guide).

### Instalacja LibreOffice (opcjonalnie)

Generowanie plików PDF wymaga zainstalowania LibreOffice. [Proszę pobrać go z oficjalnej strony internetowej](https://www.libreoffice.org/download/download-libreoffice). W przypadku wersji Docker, może Pani/Pan utworzyć skrypt bezpośrednio w katalogu `./storage/scripts`.
