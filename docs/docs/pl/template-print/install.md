...
Do generowania plików PDF niezbędna jest instalacja LibreOffice. [Proszę pobrać pakiet ze strony oficjalnej](https://www.libreoffice.org/download/download-libreoffice). W przypadku wersji Dockerowej, mogą Państwo utworzyć skrypt bezpośrednio w katalogu `./storage/scripts`.
...
Zawartość pliku `install-libreoffice.sh` przedstawia się następująco:
...
Proszę sprawdzić, czy instalacja zakończyła się pomyślnie:
