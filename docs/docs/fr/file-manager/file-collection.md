...
Une collection de fichiers est une collection dédiée au stockage des métadonnées de fichiers. Elle intègre des champs prédéfinis tels que le nom du fichier, sa taille, son type et son chemin de stockage.

## Créer une collection de fichiers

![20240324090414](https://static-docs.nocobase.com/20240324090414.png)

## Champs prédéfinis de la collection de fichiers
