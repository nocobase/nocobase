    ...
    return (
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        <AddSubModelButton model={this} subModelKey="items" subModelBaseClasses={[GroupBase, SubmenuBase]}>
          <Button>Ajouter un sous-modèle</Button>
        </AddSubModelButton>
      </Space>
    );
  }
...
GroupBase.define({
  label: 'Groupe (à plat)',
  sort: 200,
  children: () => [{ key: 'group-leaf', label: 'Élément du groupe', createModelOptions: { use: 'Leaf' } }],
});

class SubmenuBase extends FlowModel {}

SubmenuBase.define({
  label: 'Menu de second niveau',
  menuType: 'submenu',
  sort: 110,
  children: () => [{ key: 'submenu-leaf', label: 'Élément du sous-menu', createModelOptions: { use: 'Leaf' } }],
});
