...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Gestion des documents](./documents) |
| View, edit, disable, or delete document segments | [Gestion des segments](./segments) |
| Test which segments a question can match | [Tests de correspondance](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Paramètres](./settings) |
