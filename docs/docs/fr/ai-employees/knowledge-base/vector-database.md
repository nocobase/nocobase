...
Rendez-vous sur la page de configuration du plugin d'agent IA, puis cliquez sur l'onglet `Vector database` en haut pour accéder à la page de gestion des bases de données vectorielles.
