...
title: "Nœud de base de connaissances AI - Supprimer un document"
description: "Supprime les documents de base de connaissances après la suppression des enregistrements."
