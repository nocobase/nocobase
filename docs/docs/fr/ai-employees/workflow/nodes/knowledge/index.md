...
title: "Vue d'ensemble des nœuds de base de connaissances AI dans les workflows"
description: "Présente le scénario, la structure de tables et la synchronisation de la base de connaissances avec les nœuds de création, mise à jour et suppression de documents."
