...
title: "Nœud de base de connaissances AI - Créer un document"
description: "Synchronise les nouveaux enregistrements vers la base de connaissances AI avec un déclencheur d’événement de collection."
