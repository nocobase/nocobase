...
title: "Nœud de base de connaissances AI - Récupérer un document"
description: "Récupère des fragments de documents et les transmet aux nœuds Employé AI en aval."
