...
Le bloc Iframe vous permet d'intégrer des pages web ou du contenu externe directement dans la page actuelle. Vous pouvez facilement intégrer des applications externes en configurant une URL ou en insérant directement du code HTML. Lorsque vous utilisez une page HTML, vous avez la flexibilité de personnaliser le contenu pour répondre à des besoins d'affichage spécifiques. Cette méthode est particulièrement adaptée aux scénarios nécessitant un affichage sur mesure, car elle permet de charger des ressources externes sans redirection, améliorant ainsi l'expérience utilisateur et l'interactivité de la page.

![20251026205102](https://static-docs.nocobase.com/20251026205102.png)

## Syntaxe des modèles

En mode HTML, le contenu du bloc prend en charge la syntaxe du **[moteur de modèles Liquid](https://shopify.github.io/liquid/basics/introduction/)**.

![20251026205331](https://static-docs.nocobase.com/20251026205331.png)

## Prise en charge des variables

### Prise en charge des variables HTML

- Permet de sélectionner des variables du contexte du bloc actuel à l'aide du sélecteur de variables.
  ![20251026205441](https://static-docs.nocobase.com/20251026205441.png)

- Permet d'injecter et d'utiliser des variables dans l'application via du code.

Vous pouvez également injecter des variables personnalisées dans l'application via du code et les utiliser en HTML. Par exemple, créez une application de calendrier dynamique en utilisant Vue 3 et Element Plus :
...
### Prise en charge des variables d'URL
