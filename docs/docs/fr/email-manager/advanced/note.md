...
Dans la partie droite des détails de l'e-mail, vous pouvez **modifier les notes** :
...
Une fois ajoutées, vous pouvez consulter les notes dans les détails de l'e-mail :
