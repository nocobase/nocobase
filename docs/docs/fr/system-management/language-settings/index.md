...
Lorsque plusieurs langues sont activées, les utilisateurs peuvent définir leur préférence linguistique personnelle dans le Centre personnel (en haut à droite de la page).
