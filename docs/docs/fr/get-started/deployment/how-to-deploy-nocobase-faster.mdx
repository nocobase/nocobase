...
> Voir « [Documentation d'installation](https://docs.nocobase.com/get-started/quickstart) »
...
> Voir « [Documentation de déploiement](https://docs.nocobase.com/get-started/deployment/production) »
