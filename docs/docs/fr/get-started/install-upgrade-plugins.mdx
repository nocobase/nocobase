...
Pour les méthodes détaillées d’activation et de mise à niveau, veuillez consulter : [Activation et mise à niveau des plugins commerciaux](../quickstart/plugins/commercial)
