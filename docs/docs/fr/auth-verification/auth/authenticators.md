...
Lors de l'installation du plugin d'authentification utilisateur, le système initialise une méthode d'authentification par `mot de passe`, basée sur le nom d'utilisateur et l'e-mail de l'utilisateur.
