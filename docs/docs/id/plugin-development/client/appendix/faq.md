...
Route NocoBase v2 secara default akan memiliki prefix `/studio`. Misalnya Anda mendaftarkan `path: '/hello'`, alamat akses sebenarnya adalah `/studio/hello`:

```ts
this.router.add('hello', {
  path: '/hello', // Akses sebenarnya -> /studio/hello
...
- [Router](../router) — Registrasi route dan prefix `/studio`
