...
Memulai mode development di env yang berasal dari npm atau Git. Perlu dijalankan di direktori source code (`<app-path>/source/`). Untuk env Docker, gunakan [`nb app logs`](../app/logs.md) untuk melihat log runtime.
