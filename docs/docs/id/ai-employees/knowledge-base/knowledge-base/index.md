...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Manajemen dokumen](./documents) |
| View, edit, disable, or delete document segments | [Manajemen segmen](./segments) |
| Test which segments a question can match | [Uji kecocokan](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Pengaturan](./settings) |
