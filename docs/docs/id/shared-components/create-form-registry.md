...
description: "createFormRegistry: Membuat registry internal untuk item ekstensi plugin."
keywords: "createFormRegistry,NocoBase,client-v2"
---

# createFormRegistry

`createFormRegistry` digunakan untuk membuat registry internal untuk item ekstensi plugin.
