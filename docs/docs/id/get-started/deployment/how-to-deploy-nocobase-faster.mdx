...
> Lihat "[Dokumentasi Instalasi](https://v2.docs.nocobase.com/get-started/quickstart)"
...
> Lihat "[Dokumentasi Deployment](https://v2.docs.nocobase.com/get-started/deployment/production)"
