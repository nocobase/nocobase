...
Multi-Space memberi isolasi data logis di dalam satu instance aplikasi.

## Instalasi

Enable **Multi-Space** in plugin manager.
...
Open **Users & Permissions** and switch to **Spaces**.
...
### Beralih dan Melihat Multi-Space
...
### Klasifikasi Data Lama ke Multi-Space
