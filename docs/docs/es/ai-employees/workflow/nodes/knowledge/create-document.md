...
title: "Nodo de base de conocimientos de IA - Crear documento"
description: "Sincroniza registros nuevos con la base de conocimientos de IA usando un disparador de evento de colección."
