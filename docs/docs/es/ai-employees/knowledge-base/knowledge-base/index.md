...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Gestión de documentos](./documents) |
| View, edit, disable, or delete document segments | [Gestión de segmentos](./segments) |
| Test which segments a question can match | [Pruebas de coincidencia](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Configuración](./settings) |
