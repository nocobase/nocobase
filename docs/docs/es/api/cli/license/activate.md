...
Después de activar la licencia correctamente, reinicia la aplicación para que la licencia y el estado de los plugins comerciales surtan efecto de verdad:
