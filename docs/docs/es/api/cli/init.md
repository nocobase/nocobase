...
| `--skip-download` | boolean | Omitir la descarga de los archivos de la aplicación o el pull de la imagen de Docker antes de la instalación y reutilizar recursos locales existentes |
