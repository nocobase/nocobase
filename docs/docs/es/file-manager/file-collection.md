...
Una colección de archivos es una colección diseñada específicamente para almacenar metadatos de archivos. Incluye campos predefinidos como el nombre del archivo, tamaño, tipo y ruta de almacenamiento.

## Crear una Colección de Archivos

![20240324090414](https://static-docs.nocobase.com/20240324090414.png)

## Campos Predefinidos en la Colección de Archivos
