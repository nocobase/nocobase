...
* `originalNode`: nodo de vista previa de imagen integrado, reutilizable directamente

`originalNode` suele usarse para reutilizar el nodo de vista previa integrado en tipos de imagen y evitar reimplementarlo.
