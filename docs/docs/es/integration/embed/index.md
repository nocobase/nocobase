...
Este plugin le permite incrustar páginas de NocoBase en otros sitios web o aplicaciones.

## Instalación

Este plugin es comercial. Para instalarlo, debe subirlo y activarlo a través del gestor de plugins.

![20240323162741](https://static-docs.nocobase.com/20240323162741.png)

## Guía de uso

Una vez que haya activado la configuración de la interfaz, haga clic en «Copiar enlace de incrustación» en el configurador de la página (esquina superior derecha).
