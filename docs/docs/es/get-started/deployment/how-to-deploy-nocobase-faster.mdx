...
> Consulte la "[Documentación de instalación](https://docs.nocobase.com/get-started/quickstart)"
...
> Consulte la "[Documentación de despliegue](https://docs.nocobase.com/get-started/deployment/production)"
