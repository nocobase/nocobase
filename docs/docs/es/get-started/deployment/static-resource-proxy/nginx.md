...
Si hoy quieres configurar el proxy de producción para una aplicación NocoBase, lo mejor es empezar por [Reverse proxy en producción](../../../quickstart/production/reverse-proxy/index.md) y después por la página [Nginx](../../../quickstart/production/reverse-proxy/nginx.md).
