...
För att generera PDF-filer måste ni installera LibreOffice. [Ladda ner det från den officiella webbplatsen](https://www.libreoffice.org/download/download-libreoffice). Om ni använder Docker-versionen kan ni skapa ett skript direkt i katalogen `./storage/scripts`.
