...
Більше статусів повернення інструкцій можна знайти в розділі [Довідка API робочого процесу](TODO_LINK).
...
Визначення різних параметрів для типів вузлів дивіться в розділі [Довідка API робочого процесу](TODO_LINK).
