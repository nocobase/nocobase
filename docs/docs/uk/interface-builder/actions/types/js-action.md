...
Цей документ було перекладено за допомогою ШІ. Для точної інформації зверніться до [англійської версії](/interface-builder/actions/types/js-action).
:::
...
- Ви можете використовувати AI-співробітників для генерації/модифікації скриптів: [AI-співробітник · Натан: Frontend-інженер](/ai-employees/features/built-in-employee)
