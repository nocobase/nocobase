...
4. Phía trên bảng sẽ xuất hiện một nút "Thêm", click sẽ mở một [popup](../../interface-builder/actions/types/pop-up.md).
...
- [Linkage rule](../../interface-builder/linkage-rule.md) — Mô tả linkage rule Field
