...
> Để hợp nhất bảo trì, CRM 2.0 đã được tích hợp vào [Hệ thống quản lý kinh doanh tích hợp](../all-in-one/installation.md). Nếu bạn cần phiên bản CRM 2.0 độc lập (bản chụp ngày 06-04-2026, không còn cập nhật), hãy sử dụng các tệp lưu trữ bên dưới:
