...
- Bạn đã tải xuống các file tương ứng của hệ thống CRM:
  - **File backup**: [nocobase_all_in_one_backup_260521.nbdata](https://static-docs.nocobase.com/nocobase_all_in_one_backup_260521.nbdata) - dùng cho cách 1
  - **File SQL**: [nocobase_all_in_one_sql_260521.zip](https://static-docs.nocobase.com/nocobase_all_in_one_sql_260521.zip) - dùng cho cách 2
...
* **Phương án A: Qua command line server (ví dụ với Docker)**
  Nếu bạn cài NocoBase và cơ sở dữ liệu bằng Docker, có thể upload file `.sql` lên server, sau đó dùng lệnh `docker exec` để thực thi import. Giả sử container PostgreSQL của bạn tên là `my-nocobase-db`, file tên là `nocobase_all_in_one_sql_260521.sql`:
