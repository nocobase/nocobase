...
Khối Thẻ lưới hiển thị thông tin tóm tắt của các bản ghi dữ liệu dưới dạng thẻ. Khối này hỗ trợ cấu hình số lượng cột cho các kích thước màn hình khác nhau, nhằm đảm bảo hiển thị thân thiện với người dùng trên nhiều thiết bị.
...
Để biết thêm chi tiết, tham khảo [Thiết lập phạm vi dữ liệu](/interface-builder/blocks/block-settings/data-scope)

### Thiết lập số cột hiển thị trên một hàng

![20251023210137](https://static-docs.nocobase.com/20251023210137.gif)

Hỗ trợ cấu hình số lượng cột cho các kích thước màn hình khác nhau.
...
Để biết các tùy chọn cấu hình trường của khối Thẻ lưới, bạn có thể tham khảo [Trường chi tiết](/interface-builder/fields/generic/detail-form-item)
