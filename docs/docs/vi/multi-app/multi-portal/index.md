...
Để xem sự khác biệt và cách kết hợp giữa Multi-portal, Multi-app và Multi-space, hãy tham khảo: [Multi-app vs Multi-portal vs Multi-space](/multi-app/multi-app-vs-multi-portal-vs-multi-space/).
