...
Điểm quan trọng là `APP_PUBLIC_PATH` và path trong `proxy_pass` phải nhất quán. Nếu một trong hai bên thiếu `/nocobase/`, tài nguyên tĩnh và routing thường sẽ không hoạt động đúng.
