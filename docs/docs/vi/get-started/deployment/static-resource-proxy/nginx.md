...
Nếu hiện tại bạn muốn cấu hình proxy production cho một ứng dụng NocoBase, tốt nhất hãy bắt đầu từ [Reverse proxy trong production](../../../quickstart/production/reverse-proxy/index.md), rồi tiếp tục với trang [Nginx](../../../quickstart/production/reverse-proxy/nginx.md).
