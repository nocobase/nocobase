...
> Tham khảo "[Tài liệu cài đặt](https://v2.docs.nocobase.com/get-started/quickstart)"
...
> Tham khảo "[Tài liệu triển khai](https://v2.docs.nocobase.com/get-started/deployment/production)"
