...
- [Tổng quan cơ sở tri thức](../../knowledge-base/knowledge-base/index.md) - Hiểu ranh giới của Local, Readonly và External
...
- [Tổng quan cơ sở tri thức](../../knowledge-base/knowledge-base/index.md) - Ranh giới của Local, Readonly và External
