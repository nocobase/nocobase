...
title: "Nguồn dữ liệu chính - MySQL"
description: "Tìm hiểu về các phiên bản được hỗ trợ, cách cài đặt plugin, hướng dẫn sử dụng và ánh xạ trường khi sử dụng MySQL làm cơ sở dữ liệu chính của NocoBase."
keywords: "Nguồn dữ liệu chính,MySQL,cơ sở dữ liệu chính,ánh xạ trường,NocoBase"
---
...
4. Khi cấu hình trường của bảng dữ liệu, bạn có thể tham khảo danh mục [bảng dữ liệu](../data-modeling/collection.md) và [trường](../data-modeling/collection-fields/index.md) để chọn loại trường và giao diện trường.
...
| Loại trường MySQL | NocoBase Field type | Field interface có thể chọn |
| --- | --- | --- |
