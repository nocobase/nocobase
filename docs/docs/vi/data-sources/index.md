...
## Cung cấp nhiều công cụ mô hình hóa dữ liệu đa dạng
...
**Giao diện trực quan kiểu ERD**: Dùng để trích xuất các thực thể và mối quan hệ giữa chúng từ yêu cầu của người dùng và nghiệp vụ. Nó cung cấp một cách trực quan và dễ hiểu để mô tả các mô hình dữ liệu. Thông qua biểu đồ ERD, bạn có thể hiểu rõ hơn về các thực thể dữ liệu chính trong hệ thống và mối liên hệ giữa chúng.
...
| Bộ sưu tập | Mô tả |
| - | - |
| [Bộ sưu tập chung](/data-sources/data-source-main/general-collection) | Tích hợp các trường hệ thống phổ biến. |
...
| [Bộ sưu tập cấu trúc cây](/data-sources/collection-tree) | Bộ sưu tập cấu trúc cây, hiện chỉ hỗ trợ mô hình danh sách kề. |
...
| [Kết nối đến view cơ sở dữ liệu](/data-sources/collection-view) | Kết nối đến các view cơ sở dữ liệu hiện có. |
| Bộ sưu tập biểu thức | Dùng cho các kịch bản biểu thức động trong luồng công việc. |
| [Kết nối dữ liệu ngoài](/data-sources/collection-fdw) | Cho phép hệ thống cơ sở dữ liệu truy cập và truy vấn trực tiếp dữ liệu trong các nguồn dữ liệu bên ngoài dựa trên công nghệ FDW. |

![20240512102212](https://static-docs.nocobase.com/20240512102212.png)

Để biết thêm chi tiết, vui lòng xem mục 「[Bộ sưu tập / Tổng quan](/data-sources/data-modeling/collection)」.

## Cung cấp nhiều loại trường phong phú

![20240512110352](https://static-docs.nocobase.com/20240512110352.png)

Để biết thêm chi tiết, vui lòng xem mục 「[Trường bộ sưu tập / Tổng quan](/data-sources/data-modeling/collection-fields)」.