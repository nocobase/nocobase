...
Ở phía bên phải của chi tiết email, bạn có thể **chọn nhãn** cho email:
...
Nếu bạn tạo một nhãn mới, nhãn đó sẽ được chọn mặc định. Bạn cũng có thể chọn thủ công các nhãn khác:
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

Trong danh sách email, bạn có thể xem các nhãn tương ứng với email:
