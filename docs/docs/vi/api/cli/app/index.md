...
Quản lý runtime của ứng dụng NocoBase. Env npm/Git sẽ chạy lệnh ứng dụng trong thư mục source cục bộ, còn env Docker sẽ quản lý container ứng dụng dựa trên cấu hình env đã lưu.
...
| Lệnh | Mô tả |
| --- | --- |
| [`nb app start`](./start.md) | Khởi động ứng dụng hoặc tạo lại Docker container |
| [`nb app stop`](./stop.md) | Dừng ứng dụng hoặc xóa Docker container |
