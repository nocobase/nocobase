...
NocoBase 2.1 は、**AI 関連機能、マルチアプリ、および 2.0 対応**に関する重要なアップグレードです。NocoBase CLI を新たに導入し、人と AI Agent の双方が NocoBase アプリへ接続・管理しやすくなりました。アプリの作成、AI による構築、AI 社員の機能強化、AI 開発プラグインなど、環境接続からシステム構築、業務上の協働まで一連の流れを網羅しています。あわせて、2.0 ページとコア機能の整備も大幅に進め、より多くのブロック、フィールド、アクション、プラグインが 2.0 に対応し、さらにバージョン管理機能を追加しました。
...
バージョン管理機能は、アプリのバージョン反復と変更履歴をより適切に管理するのに役立ちます。バージョン管理機能を通じてアプリの異なるバージョンを作成、確認、復元でき、開発・運用の過程でバージョンの切り替えや問題からの復旧を行いやすくなります。
