...
NocoBase 2.1 は、**AI 関連機能、マルチアプリ、および 2.0 対応**に関する重要なアップグレードです。NocoBase CLI を新たに導入し、人と AI Agent の双方が NocoBase アプリへ接続・管理しやすくなりました。アプリの作成、AI による構築、AI 社員の機能強化、AI 開発プラグインなど、環境接続からシステム構築、業務上の協働まで一連の流れを網羅しています。さらに、マルチアプリの機能を強化し、アプリ間の連携と協働をより容易にしました。あわせて、バージョン管理機能を新たに追加し、2.0 ページとコア機能の整備も大幅に進め、より多くのブロック、フィールド、アクション、プラグインが 2.0 に対応しました。
...
バージョン管理機能は、アプリのバージョン反復と変更履歴をより適切に管理するのに役立ちます。バージョン管理機能を通じてアプリの異なるバージョンを作成、確認、復元でき、開発・運用の過程でバージョンの切り替えや問題からの復旧を行いやすくなります。**注意：本機能を利用するには Professional 版以上が必要です。**

![](https://static-docs.nocobase.com/20260526220510.png)

関連ドキュメント：

- [バージョン管理](https://docs.nocobase.com/ja/ops-management/version-control/)
- [バックアップ管理](https://docs.nocobase.com/ja/ops-management/backup-manager/)
