...
部門編集フォームで上位部門フィールドを変更します。現在の部門と、その下位部門は選択できません。
...
ユーザーは複数の部門に同時に参加できます。最初に所属した部門がデフォルトの主担当部門となり、1人のユーザーが持てる主担当部門は1つだけです。

![](https://static-docs.nocobase.com/60afd282f33b555e6fe0662b9da544cc.png)

すでに部門メンバーであるユーザーは、ユーザー選択リストには表示されません。

![](https://static-docs.nocobase.com/6bcd93173c169973f970de35d2657993.png)

### 部門責任者を設定

部門編集フォームで「責任者」フィールドをクリックし、部門メンバーから責任者を選択します。複数選択が可能です。すでに部門責任者であるメンバーは、メンバー選択リストには表示されません。

![](https://static-docs.nocobase.com/92970546cbd0aeb5a8b6a36da87583bd.png)

### ユーザーに部門を割り当てる

部門にメンバーを追加するだけでなく、ユーザーの視点からユーザーに部門を割り当てることもできます。
...
ユーザーはニックネーム、ユーザー名、電話番号、メールアドレスで検索でき、部門は部門名で検索できます。
