...
部門に1つ以上のロールを関連付けることで、その部門のメンバーはこれらのロールを持つことができます。

部門にロールを関連付ける方法は2つあります。

1つ目は、部門編集フォームのロールフィールドでロールを選択する方法です。

![](https://static-docs.nocobase.com/70f77bb89aa1fb415c152a51a51cc23b.png)

2つ目は、ロール管理で該当するロールに部門を追加する方法です。

![](https://static-docs.nocobase.com/f2a7bec937cf2f179ce868a92b98416d.png)

すでにこのロールを持つ部門は選択できません。
