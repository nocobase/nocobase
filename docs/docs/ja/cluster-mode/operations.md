...
title: "クラスター運用"
description: "クラスター運用：初回起動順序、バージョンアップ手順（停止、バックアップ、更新、検証）、アプリ内メンテナンス（プラグイン、バックアップ）は単一ノードで。"
keywords: "クラスター運用,アップグレード,アプリ内メンテナンス,プラグイン管理,バックアップ,ローリングアップグレード,NocoBase"
---
