...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [ドキュメント管理](./documents) |
| View, edit, disable, or delete document segments | [セグメント管理](./segments) |
| Test which segments a question can match | [ヒットテスト](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [設定](./settings) |
