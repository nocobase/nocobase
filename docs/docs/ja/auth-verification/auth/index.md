...
- [@nocobase/plugin-auth-sms](/auth-verification/auth-sms/index.md) - SMS認証ログイン機能を提供します
- [@nocobase/plugin-auth-saml](/auth-verification/auth-saml/index.md) - SAML SSOログイン機能を提供します
- [@nocobase/plugin-auth-oidc](/auth-verification/auth-oidc/index.md) - OIDC SSOログイン機能を提供します
- [@nocobase/plugin-auth-cas](/auth-verification/auth-cas/index.md) - CAS SSOログイン機能を提供します
- [@nocobase/plugin-auth-ldap](/auth-verification/auth-ldap/index.md) - LDAP SSOログイン機能を提供します
- [@nocobase/plugin-auth-wecom](/auth-verification/auth-wecom/index.md) - WeComログイン機能を提供します
- [@nocobase/plugin-auth-dingtalk](/auth-verification/auth-dingtalk/index.md) - DingTalkログイン機能を提供します
