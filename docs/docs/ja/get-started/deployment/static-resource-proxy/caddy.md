...
現在 NocoBase アプリケーション向けに本番用プロキシを設定したい場合は、まず [本番環境のリバースプロキシ](../../../nocobase-cli/production/reverse-proxy/index.md) を読み、その後に [Caddy](../../../nocobase-cli/production/reverse-proxy/caddy.md) のページへ進むのがおすすめです。
