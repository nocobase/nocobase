...
組み込みの[認証：APIキー](/plugins/@nocobase/plugin-api-keys/index.md)プラグインが有効になっていることを確認してください。有効にすると、システム設定に新しいAPIキー設定ページが表示されます。
...
[APIドキュメント](/plugins/@nocobase/plugin-api-doc/index.md)プラグインを開き、各APIエンドポイントのリクエストメソッド、URL、パラメーター、およびリクエストヘッダーを確認します。
...
**その他のリソース：**
-   [APIキープラグインのドキュメント](/plugins/@nocobase/plugin-api-keys/index.md)
-   [APIドキュメントプラグイン](/plugins/@nocobase/plugin-api-doc/index.md)
