...
マルチアプリは、次のようなシナリオに適しています。

- CRM、アフターサービス、運用、データ分析など、業務モジュールごとに大きなシステムを複数アプリへ分割する
- 業務ラインやモジュールごとにチームが並行開発し、モジュール間の設定やリリースの影響を抑える
- 顧客、テナント、組織ごとに独立したアプリを作成する
- デモ、テスト、サンドボックス環境をまとめて作成する
- アプリ数や負荷の増加に応じて、アプリを異なる実行環境へ配置する
