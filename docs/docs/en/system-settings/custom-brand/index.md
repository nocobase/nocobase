...
HTML is used for the configuration to allow users more flexibility in customizing their content. If you only need to make simple text changes, you can directly modify the existing content, as shown in the image below:


![20240409114740](https://static-docs.nocobase.com/20240409114740.png)


### Set Favicon<Badge>v1.2.23-alpha+</Badge>
