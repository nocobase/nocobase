...
In addition to the authentication types provided by existing plugins, developers can also extend user authentication types themselves. For details, refer to the [Developer's Guide](./dev/).
