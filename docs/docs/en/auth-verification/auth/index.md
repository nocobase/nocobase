...
- [@nocobase/plugin-auth-sms](/auth-verification/auth-sms/index.md) - Provides SMS verification login function
- [@nocobase/plugin-auth-saml](/auth-verification/auth-saml/index.md) - Provides SAML SSO login function
- [@nocobase/plugin-auth-oidc](/auth-verification/auth-oidc/index.md) - Provides OIDC SSO login function
- [@nocobase/plugin-auth-cas](/auth-verification/auth-cas/index.md) - Provides CAS SSO login function
- [@nocobase/plugin-auth-ldap](/auth-verification/auth-ldap/index.md) - Provides LDAP SSO login function
- [@nocobase/plugin-auth-wecom](/auth-verification/auth-wecom/index.md) - Provides WeCom login function
- [@nocobase/plugin-auth-dingtalk](/auth-verification/auth-dingtalk/index.md) - Provides DingTalk login function
