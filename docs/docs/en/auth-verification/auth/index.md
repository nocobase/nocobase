...
- [@nocobase/plugin-auth-sms](/auth-verification/index.md) - Provides SMS verification login function
- [@nocobase/plugin-auth-saml](/auth-verification/index.md) - Provides SAML SSO login function
- [@nocobase/plugin-auth-oidc](/auth-verification/index.md) - Provides OIDC SSO login function
- [@nocobase/plugin-auth-cas](/auth-verification/index.md) - Provides CAS SSO login function
