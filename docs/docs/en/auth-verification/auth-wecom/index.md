...
## Create and Configure a WeCom In-house Application

Go to the WeCom admin console to create an in-house application.
...
Click on the application to enter its details page, scroll down, and click on "WeCom Authorized Login".
...
Return to the application details page and click on "Web Authorization and JS-SDK".


![](https://static-docs.nocobase.com/202406272107063.png)


Set and verify the callback domain for the application's OAuth2.0 web authorization.


![](https://static-docs.nocobase.com/202406272107899.png)


On the application details page, click on "Corporate Trusted IP".
...
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| When a phone number does not match an existing user, <br />should a new user be created automatically | When a phone number does not match an existing user, should a new user be created automatically.                                                                      | -                   |
| Company ID                                                                                            | Company ID, obtained from the WeCom admin console.                                                                                                                      | -                   |
| AgentId                                                                                               | Obtained from the in-house application configuration in the WeCom admin console.                                                                                        | -                   |
| Secret                                                                                                | Obtained from the in-house application configuration in the WeCom admin console.                                                                                        | -                   |
...
| Workbench application homepage link                                                                   | The workbench application homepage link.                                                                                                                                | -                   |

## Configure the WeCom Application Homepage
...
Go to the WeCom admin console, and paste the copied workbench application homepage link into the application homepage URL field of the corresponding application.
...
:::warning
Due to WeCom's permission restrictions on sensitive information such as phone numbers, authorization can only be completed within the WeCom client. When logging in with WeCom for the first time, please follow the steps below to complete the initial login authorization within the WeCom client.
:::

## First-time Login

From the WeCom client, go to the Workbench, scroll to the bottom, and click on the application to enter the homepage you previously configured. This will complete the initial authorization. After that, you can use WeCom to log in within the NocoBase application.
