...
NocoBase 2.1.0-beta.24 is a major upgrade **centered on AI capabilities**. This release lets you bring AI Agents into NocoBase — covering CLI integration, AI-assisted building, enhanced AI Employees, and an AI development plugin — spanning the full flow from environment onboarding to system building and business collaboration. We have also continued to round out V2 page support and core capabilities.

## Highlights

### NocoBase CLI becomes the official entry point for AI Agents

In NocoBase 2.1.0-beta.24, the NocoBase CLI (`nb`) is the core entry point for AI Agents to connect to NocoBase.
...
AI Employees existed in earlier releases, but in NocoBase 2.1.0-beta.24 the related capabilities have been enhanced and the AI kernel has been rounded out:
...
If your team needs to bring intelligent collaboration, automated analysis, and task execution into your business systems, this is one of the most notable directions in 2.1.0-beta.24.

Related documentation:

- [AI Employees](https://docs.nocobase.com/ai-employees/)

### Continuing to round out the 2.0 ecosystem with key capabilities

Beyond AI, NocoBase 2.1.0-beta.24 also continues to fill out configuration capabilities for real-world business scenarios:
...
Some of these target data and interaction extensions, others target common business interfaces, helping you ship concrete systems faster.
