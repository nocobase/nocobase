...
If you already have a NocoBase application running, or have successfully completed initialization and want to continue developing, debugging, or managing your application, see [NocoBase CLI Command Reference](../api/cli/) for full parameter documentation of all `nb` commands.
...
- [NocoBase CLI Command Reference](../api/cli/) — Full parameter documentation for all commands
