...
This plugin provides a user management interface in the configuration center. After the application is initialized, a non-deletable super administrator account will be added. The administrator has Root permissions and can access all resources.


![](https://static-docs.nocobase.com/44bf40f56b45d4dd96c424fb08082cf6.png)


In addition, you can also use the users collection on a page to add various blocks to manage users, such as a table block:
...
Set whether to allow editing user profiles and changing user passwords (applies to all users).
