...
| --- | --- |
| [General collection](/data-sources/data-source-main/general-collection) | Built-in with common system fields. |
...
| [Tree collection](/data-sources/collection-tree) | A tree-structured collection, currently only supporting the adjacency list model. |
...
| [Connect to foreign data](/data-sources/collection-fdw) | Connects to remote data collections based on the database's FDW technology. |
