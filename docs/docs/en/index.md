...
features:
  - title: Start
    ...
    items:
      - title: Quick Start
        details: Install NocoBase CLI, configure NocoBase Skills, and connect your AI Agent so you're ready to build, use, and develop with NocoBase.
        link: /ai/quick-start
  ...
  - title: Development
    details: Provides rich extension and integration capabilities for NocoBase developers.
    items:
      - title: More...
