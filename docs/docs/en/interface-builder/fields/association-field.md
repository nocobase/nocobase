...
Sub-details is the corresponding component to the sub-form in read-only mode. It supports displaying data with nested multi-level relationships.


![20240822223651](https://static-docs.nocobase.com/20240822223651.png)


For more details, see [Sub-details](/interface-builder/fields/specific/sub-detail)
