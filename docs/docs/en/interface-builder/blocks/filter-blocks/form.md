...
1. Enable configuration mode and add a "Filter form" block and a "Table" block to the page.
...
In addition to selecting fields from data tables, you can also create form fields using "Custom fields". For example, you can create a dropdown select field with custom options. Here's how:
