...
Enter your message and click the send button to start the conversation.
...
- Have the AI reply again
- Copy the AI message content


![20251021235847](https://static-docs.nocobase.com/20251021235847.png)


Click the "Upload" icon to upload and send a file to the AI employee.


![20251022000327](https://static-docs.nocobase.com/20251022000327.png)


In the top left corner of the chatbox is the conversation history list. Click to expand the list and view past conversations.


![20251021234640](https://static-docs.nocobase.com/20251021234640.png)


Click the "pencil" icon in the top right corner to start a new conversation.
