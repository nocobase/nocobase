...
description: "Use the AI knowledge base Retrieve document node in a workflow to retrieve snippets from the knowledge base and pass them to downstream AI employee nodes."
