...
description: "Introduces workflow AI knowledge base node scenarios, table structure, and how create, update, delete, and retrieve document nodes work together."
