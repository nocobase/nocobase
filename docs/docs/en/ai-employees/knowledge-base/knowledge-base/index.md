...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Document management](./documents) |
| View, edit, disable, or delete document segments | [Segment management](./segments) |
| Test which segments a question can match | [Hit tests](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Settings](./settings) |
