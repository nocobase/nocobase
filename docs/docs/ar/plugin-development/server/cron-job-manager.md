...
`CronJobManager` هو مدير مهام مجدولة توفره NocoBase، يعتمد على [cron](https://www.npmjs.com/package/cron). يسمح هذا المدير للإضافات (Plugins) بتسجيل مهام مجدولة على الخادم لتنفيذ منطق معين بشكل دوري.
...
تعريف نوع `CronJobParameters` هو كما يلي (من [cron](https://www.npmjs.com/package/cron)):
...
> 💡 يمكنك استخدام [crontab.guru](https://crontab.guru/) للمساعدة في إنشاء التعبيرات.
