...
تمت ترجمة هذا المستند بواسطة الذكاء الاصطناعي. للحصول على معلومات دقيقة، يرجى الرجوع إلى [النسخة الإنجليزية](/file-manager/file-preview/ms-office).
:::
...
بعد رفع ملف Office (Word / Excel / PowerPoint) بنجاح في Field الملفات في الـ Collection، يمكنك النقر على أيقونة الملف أو الرابط المقابل لمعاينة محتواه في واجهة معاينة منبثقة أو مضمنة.
...
- تقوم الواجهة الأمامية (Frontend) بإنشاء رابط URL عام للملف الذي رفعه المستخدم (بما في ذلك روابط URL الموقعة من S3).
