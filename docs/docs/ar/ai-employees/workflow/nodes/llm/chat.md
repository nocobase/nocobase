...
تمت ترجمة هذا المستند بواسطة الذكاء الاصطناعي. للحصول على معلومات دقيقة، يرجى الرجوع إلى [النسخة الإنجليزية](/ai-employees/workflow/nodes/llm/chat).
:::
...
أولاً، اختر خدمة LLM متصلة. إذا لم تكن هناك خدمة LLM متصلة بعد، فستحتاج إلى إضافة إعدادات خدمة LLM أولاً. راجع: [إدارة خدمة LLM](/ai-employees/features/llm-service)
