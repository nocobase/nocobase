...
على الجانب الأيمن من تفاصيل البريد الإلكتروني، يمكنك **اختيار علامات** للبريد الإلكتروني:
...
إذا أنشأت علامة جديدة، فسيتم تحديدها افتراضيًا. يمكنك أيضًا تحديد علامات أخرى يدويًا:
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

في قائمة البريد الإلكتروني، يمكنك عرض العلامات المقابلة للرسائل:
