...
- توفر إمكانية الإعداد والإدارة المركزية للمتغيرات والمفاتيح البيئية، وتُستخدم لتخزين البيانات الحساسة، وإعادة استخدام بيانات الإعداد، وعزل إعدادات البيئات، وما إلى ذلك. ([عرض الوثائق](../variables-and-secrets/index.md)).
