...
تمت ترجمة هذا المستند بواسطة الذكاء الاصطناعي. للحصول على معلومات دقيقة، يرجى الرجوع إلى [النسخة الإنجليزية](/interface-builder/blocks/other-blocks/js-block).
:::
...
- [الموظف الذكاء الاصطناعي · Nathan: مهندس الواجهة الأمامية](/ai-employees/features/built-in-employee)
