...
تمت ترجمة هذا المستند بواسطة الذكاء الاصطناعي. للحصول على معلومات دقيقة، يرجى الرجوع إلى [النسخة الإنجليزية](/interface-builder/fields/specific/js-column).
:::
...
- [موظف AI · ناثان: مهندس واجهة أمامية](/ai-employees/features/built-in-employee)
