...
부서 편집 양식에서 상위 부서 필드를 수정합니다. 현재 부서와 현재 부서의 하위 부서는 선택할 수 없습니다.
...
한 명의 사용자는 여러 부서에 동시에 참여할 수 있습니다. 처음 참여하는 부서가 기본 주 부서가 되며, 사용자는 하나의 주 부서만 가질 수 있습니다.

![](https://static-docs.nocobase.com/60afd282f33b555e6fe0662b9da544cc.png)

이미 부서 멤버인 사용자는 사용자 선택 목록에 나타나지 않습니다.

![](https://static-docs.nocobase.com/6bcd93173c169973f970de35d2657993.png)

### 부서 책임자 설정

부서 편집 양식에서 책임자 필드를 클릭하여 부서 멤버를 책임자로 선택합니다. 다중 선택이 가능하며, 이미 부서 책임자인 멤버는 멤버 선택 목록에 나타나지 않습니다.

![](https://static-docs.nocobase.com/92970546cbd0aeb5a8b6a36da87583bd.png)

### 사용자에게 부서 할당

부서에 멤버를 추가하는 것 외에도, 사용자 관점에서 사용자에게 부서를 할당할 수 있습니다.

![](https://static-docs.nocobase.com/ca82a802012572e225570e8be93a4094.png)

이미 참여한 부서는 선택할 수 없습니다.
...
사용자 닉네임, 사용자 이름, 휴대폰, 이메일로 사용자를 검색하고, 부서 이름으로 부서를 검색합니다.
