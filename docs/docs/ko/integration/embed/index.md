...
이 플러그인은 NocoBase 페이지를 다른 웹사이트나 애플리케이션에 임베드하는 데 사용됩니다.

## 설치

이 플러그인은 상용 플러그인이므로, 플러그인 관리자를 통해 업로드하고 활성화해야 합니다.

![20240323162741](https://static-docs.nocobase.com/20240323162741.png)

## 사용 방법

인터페이스 설정을 활성화한 후, 페이지 설정 메뉴(우측 상단)에서 「임베드 링크 복사」를 클릭합니다.
