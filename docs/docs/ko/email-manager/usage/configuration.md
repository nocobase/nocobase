...
두 가지 방법 모두 완전한 이메일 보내기 폼을 생성할 수 있습니다.
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_04_53_PM%20(1).png)

이메일 폼의 각 필드는 일반 폼과 동일하며, **기본값** 또는 **연동 규칙** 등을 설정할 수 있습니다.

> 이메일 상세 하단에 기본으로 제공되는 이메일 답장 폼과 이메일 전달 폼은 일부 데이터 처리를 기본으로 포함하고 있으며, **플로우 엔진**을 통해 수정할 수 있습니다.