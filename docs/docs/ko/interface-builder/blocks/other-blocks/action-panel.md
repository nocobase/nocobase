...
다양한 빠른 작업을 배치하는 데 사용됩니다. 현재 다음을 지원합니다:

- [링크](/interface-builder/actions/types/link)
- [QR 코드 스캔]
- [팝업 작업](/interface-builder/actions/types/pop-up)

![20251023225754](https://static-docs.nocobase.com/20251023225754.png)

> 💡 향후 버전에서 더 많은 작업 유형이 계속해서 추가될 예정입니다.
## 작업 유형

- **링크**: 지정된 페이지 또는 외부 URL로 이동합니다.

![20251023230643](https://static-docs.nocobase.com/20251023230643.png)

- **QR 코드 스캔**: QR 코드를 스캔하여 해당 작업을 트리거합니다.

- **팝업 열기**: 팝업을 열어 블록 콘텐츠를 표시합니다.
