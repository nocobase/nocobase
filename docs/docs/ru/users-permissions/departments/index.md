...
Измените поле вышестоящего отдела в форме редактирования отдела. Текущий отдел и его подотделы выбрать нельзя.
...
Пользователь может одновременно состоять в нескольких отделах. Первый отдел, в который он вступает, становится основным отделом по умолчанию. У пользователя может быть только один основной отдел.

![](https://static-docs.nocobase.com/60afd282f33b555e6fe0662b9da544cc.png)

Пользователи, которые уже являются участниками отдела, не отображаются в списке выбора пользователей.

![](https://static-docs.nocobase.com/6bcd93173c169973f970de35d2657993.png)

### Назначить руководителя отдела

В форме редактирования отдела нажмите поле руководителя, чтобы выбрать участников отдела и назначить их руководителями. Поддерживается множественный выбор. Участники, которые уже являются руководителями отдела, не отображаются в списке выбора участников.

![](https://static-docs.nocobase.com/92970546cbd0aeb5a8b6a36da87583bd.png)

### Настроить отделы для пользователей

Помимо добавления участников в отдел, можно также настраивать отделы для пользователей со стороны пользователя.

![](https://static-docs.nocobase.com/ca82a802012572e225570e8be93a4094.png)

Отделы, в которые уже выполнено вступление, выбрать нельзя.

![](https://static-docs.nocobase.com/70e16d17ee9c4b5d43f8a5e1c633b177.png)

### Изменить основной отдел

![](https://static-docs.nocobase.com/da92dd1e10268adcd35445e9f1dac771.png)

## Поиск пользователей и отделов

Ищите пользователей по псевдониму, имени пользователя, телефону, электронной почте, а отделы — по названию отдела.
