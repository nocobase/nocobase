...
Этот плагин предоставляет интерфейс управления пользователями в центре конфигурации. После инициализации приложения автоматически создаётся неудаляемая учётная запись суперадминистратора. Суперадминистратор имеет права root-пользователя и может получать доступ ко всем ресурсам.

![](https://static-docs.nocobase.com/44bf40f56b45d4dd96c424fb08082cf6.png)

Кроме того, вы также можете добавлять разные блоки коллекции Пользователи для управления пользователями, например блоки таблицы:
...
:::info{title=Совет}
Требуется NocoBase v1.3.34-beta или выше.
:::

Настройте, разрешено ли редактирование профиля пользователя и смена пароля пользователя (применяется ко всем пользователям).
