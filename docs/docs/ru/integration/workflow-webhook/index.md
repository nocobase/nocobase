...
Найдите и установите плагин **[Рабочий процесс: Webhook](../../plugins/@nocobase/plugin-workflow-webhook/index.md)** в менеджере плагинов.
...
- [Документация по плагину «Рабочий процесс»](../../plugins/@nocobase/plugin-workflow/index.md)
- [Рабочий процесс: Триггер Webhook](/workflow/triggers/webhook)
- [Рабочий процесс: Узел HTTP-запроса](../workflow-http-request/index.md)
- [Аутентификация с помощью ключей API](../api-keys/index.md)