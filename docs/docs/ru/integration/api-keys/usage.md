...
Убедитесь, что встроенный [плагин "Аутентификация: ключи API"](../../plugins/@nocobase/plugin-api-keys/index.md) активирован. После его включения в системных настройках появится новая страница конфигурации ключей API.
...
Откройте [плагин "Документация API"](../../plugins/@nocobase/plugin-api-doc/index.md), чтобы просмотреть методы запросов, URL-адреса, параметры и заголовки для каждой конечной точки API.
...
-   [Документация плагина "Ключи API"](../../plugins/@nocobase/plugin-api-keys/index.md)
-   [Плагин "Документация API"](../../plugins/@nocobase/plugin-api-doc/index.md)