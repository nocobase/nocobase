...
База данных MySQL по умолчанию не включает модуль federated. Вам нужно изменить конфигурацию `my.cnf`. Если вы используете Docker-версию, ситуацию с расширением можно обработать через volumes:
