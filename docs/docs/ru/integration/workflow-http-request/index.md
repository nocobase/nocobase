...
Узел HTTP-запроса является встроенной функцией **плагина** **[Рабочий процесс](../../plugins/@nocobase/plugin-workflow/index.md)**. Убедитесь, что этот **плагин** включен.
...
- [Документация **плагина** «**Рабочий процесс**»](../../plugins/@nocobase/plugin-workflow/index.md)
- [**Рабочий процесс**: Узел HTTP-запроса](/workflow/nodes/request)
- [**Рабочий процесс**: Триггер Webhook](../workflow-webhook/index.md)
- [Аутентификация по API-ключам](../api-keys/index.md)
- [**Плагин** документации API](../../plugins/@nocobase/plugin-api-doc/index.md)