...
features:
  ...
  - title: ИИ
    ...
    items:
      - title: Конструктор ИИ-приложений (AI Builder)
        details: Создавайте приложения NocoBase с нуля при помощи ИИ — от моделирования данных и настройки интерфейса до рабочих процессов (workflow) и публикации.
        link: /ai-builder
      - title: ИИ-сотрудники
