...
Этот документ был переведён с помощью ИИ. Для получения точной информации обратитесь к [английской версии](/multi-app/multi-app/remote).
:::
...
При создании приложения можно выбрать одну или несколько сред исполнения. Обычно достаточно одной. Несколько сред нужны в сценариях [разделение сервисов](/cluster-mode/services-splitting).
