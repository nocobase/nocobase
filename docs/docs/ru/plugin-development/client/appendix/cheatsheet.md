...
При создании плагина через `nb scaffold plugin @my-project/plugin-name` автоматически генерируется следующая структура каталогов. Не создавайте каталоги вручную, чтобы не пропустить шаг регистрации и не получить неработающий плагин. Подробности см. в [Написание первого плагина](../../write-your-first-plugin).
