...
В NocoBase v2 маршруты по умолчанию имеют префикс `/studio`. Например, если Вы зарегистрировали `path: '/hello'`, фактический адрес — `/studio/hello`:
...
- [Router (Маршрутизация)](../router) — регистрация маршрутов и префикс `/studio`
