...
Этот раздел описывает только специфические параметры движка хранения Aliyun OSS. Общие параметры см. в разделе [Общие параметры движков](./index.md#общие-параметры).
:::
