...
Этот документ был переведён с помощью ИИ. Для получения точной информации обратитесь к [английской версии](/interface-builder/fields/specific/js-item).
:::
...
- Может использоваться с AI-сотрудником для генерации/изменения скриптов: [AI-сотрудник · Натан: Frontend-инженер](/ai-employees/features/built-in-employee)
