...
Шаблоны полей позволяют переиспользовать конфигурацию секции полей (выбранные поля, макет и настройки полей) в блоках деталей. См. [Шаблон поля](/interface-builder/fields/field-template).
