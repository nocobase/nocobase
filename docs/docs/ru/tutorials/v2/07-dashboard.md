...
На этом наша система заявок функционально полностью готова: моделирование данных, страницы, формы, права, автоматизированные рабочие процессы, дашборд — всё на месте. В планах **учебник по сборке через ИИ-агента** — он сам соберёт систему локально, ждите!
