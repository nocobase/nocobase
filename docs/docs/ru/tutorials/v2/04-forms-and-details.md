...
3. Отметьте **«Add»**.
4. Над таблицей появится кнопка «Add», открывающая [всплывающее окно](../../interface-builder/actions/types/pop-up.md).
...
- [Связные правила](../../interface-builder/linkage-rule.md) — описание связных правил
