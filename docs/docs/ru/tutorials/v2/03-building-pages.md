...
1. Включите переключатель **UI Editor** в правом верхнем углу — войдёте в [режим конфигурации](/quickstart/how-nocobase-works) (вокруг страницы появятся оранжевые рамки).
