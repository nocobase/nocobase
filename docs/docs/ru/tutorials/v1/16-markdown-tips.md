...
В системе на «Онлайн-демо» можно посмотреть, как используется Markdown — на главной, странице заказов и в разделе «Больше примеров».
...
## III. Дополнительные элементы оформления

Когда Вы освоите синтаксис Markdown и переменные, в блок можно добавлять и другие элементы — например, HTML!
