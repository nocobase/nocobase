...
Прежде всего, мы рекомендуем Вам быстро попробовать NocoBase, чтобы оценить его возможности. Вы можете воспользоваться [онлайн-демо](https://demo.nocobase.com/new): укажите электронную почту и нужную информацию и нажмите кнопку активации. Вы получите тестовую систему сроком на 2 дня со всеми коммерческими плагинами:
...
При первом входе в NocoBase Вы увидите простой и понятный главный экран. В правом верхнем углу находится кнопка [**Конфигурация интерфейса**](https://docs.nocobase.com/handbook/ui/ui-editor); по нажатию на неё система переключится в режим конфигурации интерфейса. Это основная рабочая область для построения страниц системы.

![Режим конфигурации UI](https://static-docs.nocobase.com/Solution/401734164740202414162512.png)

**Шаги:**

1. **Войдите в режим конфигурации**: нажмите кнопку «Конфигурация интерфейса» в правом верхнем углу.
2. **Добавьте страницу [меню](https://docs.nocobase.com/handbook/ui/menus)**:
...
![demov4-001.gif](https://static-docs.nocobase.com/Solution/demoE3v1-01.gif)

3. **Создайте [блок](https://docs.nocobase.com/handbook/ui/blocks)**:
   - На тестовой странице нажмите кнопку «Создать блок».
   - Из списка типов выберите блок данных, например «Табличный блок».
   - Подключите коллекцию, например встроенную коллекцию «Пользователи».
...
Плагин — важный инструмент расширения возможностей NocoBase. В [**Менеджере плагинов**](https://docs.nocobase.com/handbook/plugin-manager) Вы можете просматривать, устанавливать, включать и отключать плагины под разные бизнес-задачи.

Плагины позволяют расширять функциональность платформы и реализовывать удобные или неожиданные интеграции, упрощая Вашу работу и разработку.
...
3. **Тестирование плагина**:
   - После активации «Редактора тем» в личном меню в правом верхнем углу можно быстро менять тему системы.
     ![Смена темы](https://static-docs.nocobase.com/Solution/demoE3v1-03.gif)
   - В центре настроек Вы увидите интерфейс редактора тем, в котором можно настраивать цвета, шрифты и другие параметры. ![Интерфейс редактора тем](https://static-docs.nocobase.com/Solution/111734167291202414170812.png)
...
- [**Управление источниками данных**](https://docs.nocobase.com/handbook/data-source-manager): управление всеми коллекциями, настройка основной базы данных или внешних баз данных.
- [**Системные настройки**](https://docs.nocobase.com/handbook/system-settings): изменение названия системы, логотипа, языка и другой базовой информации.
- [**Пользователи и права**](https://docs.nocobase.com/handbook/users): управление учётными записями и настройка прав для разных ролей.
- [**Настройки плагинов**](https://docs.nocobase.com/handbook/plugin-manager): детальная конфигурация и управление установленными плагинами.
...
Некоторые плагины также расширяют возможности этого меню.
...
1. **Установка через Docker (рекомендуется)**
   ...
   - **Шаги**:
     - Следуйте [официальному руководству по установке](https://docs.nocobase.com/welcome/getting-started/installation/docker-compose) и разверните NocoBase с помощью Docker Compose.
2. **Установка через Create-NocoBase-App**

   - **Подходит**: фронтенд-разработчикам и пользователям, знакомым с npm.
   - **Шаги**:
     - Следуйте [руководству по установке](https://docs.nocobase.com/welcome/getting-started/installation/create-nocobase-app) и установите NocoBase через npm-пакет.
3. **Установка из исходников**

   - **Подходит**: разработчикам, которым нужна глубокая кастомизация NocoBase.
   - **Шаги**:
     - Следуйте [руководству по установке](https://docs.nocobase.com/welcome/getting-started/installation/git-clone), клонируйте исходники с GitHub и устанавливайте систему под свои требования.
...
services:
  app:
        ...
        depends_on:
          - postgres
        environment:
          # Секретный ключ приложения, используется для генерации токена и т. п.
          # При изменении APP_KEY старые токены становятся недействительными.
          # Можно использовать произвольную случайную строку — главное, не разглашать её.
          - APP_KEY=your-secret-key
          # Тип базы данных, поддерживаются postgres, mysql, mariadb, sqlite
          - DB_DIALECT=postgres
          # Хост базы данных, можно заменить на IP уже имеющегося сервера базы данных
          - DB_HOST=postgres
          # Имя базы данных
  ...
  # Если используется существующая база данных, postgres можно не запускать
  postgres:
...
Надеемся, что этих шагов достаточно, чтобы Вы освоились с базовым интерфейсом и процессом установки NocoBase. В [следующей главе (Глава 2: Проектирование системы управления задачами)](https://www.nocobase.com/ru/tutorials/task-tutorial-system-design) мы продолжим знакомство с возможностями NocoBase и поможем Вам построить полноценное приложение. Сделаем следующий шаг и начнём новое путешествие в мир no-code-разработки!
