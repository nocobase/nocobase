...
- Вы скачали файл резервной копии CRM: [nocobase_crm_v2_backup_260523.nbdata](https://static-docs.nocobase.com/nocobase_crm_v2_backup_260523.nbdata)
...
Этот метод использует встроенный плагин NocoBase «[Менеджер резервных копий](https://docs.nocobase.com/ru/plugins/@nocobase/plugin-backups/)» (Professional/Enterprise) для восстановления «в один клик». Этот плагин теперь имеет открытый исходный код и доступен во всех версиях (включая Community).
