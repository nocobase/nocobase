...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Управление документами](./documents) |
| View, edit, disable, or delete document segments | [Управление сегментами](./segments) |
| Test which segments a question can match | [Тесты совпадений](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Настройки](./settings) |
