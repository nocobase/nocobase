...
Этот документ был переведён с помощью ИИ. Для получения точной информации обратитесь к [английской версии](/ai-employees/knowledge-base/vector-store).
:::
...
- В поле `LLM service` выберите уже настроенный LLM-сервис. См. также: [Управление LLM-сервисами](/ai-employees/features/llm-service);
