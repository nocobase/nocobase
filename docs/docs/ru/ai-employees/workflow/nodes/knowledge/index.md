...
title: "Обзор узлов базы знаний AI в workflow"
description: "Описание сценария, структуры таблиц и синхронизации базы знаний узлами создания, обновления и удаления документов."
