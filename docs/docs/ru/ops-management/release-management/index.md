...
- Обеспечивает централизованную настройку и управление переменными среды и ключами, используемыми для хранения конфиденциальных данных, повторного использования данных конфигурации, изоляции конфигураций по средам и т.д. ([Просмотреть документацию](../variables-and-secrets/index.md)).
