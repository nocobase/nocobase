...
Управляет коммерческим лицензированием NocoBase, включая активацию лицензии, instance ID, статус лицензии и лицензированные плагины.
...
| Команда | Описание |
| --- | --- |
| [`nb license activate`](./activate.md) | Активировать коммерческую лицензию для текущего env |
