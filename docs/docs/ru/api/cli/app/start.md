---
title: "nb app start"
description: "Справочник по команде nb app start: запуск приложения NocoBase указанного env; локальные env автоматически выполняют необходимую подготовку установки или обновления перед запуском, а для Docker env контейнер приложения пересоздаётся из сохранённой конфигурации."
keywords: "nb app start,NocoBase CLI,запуск приложения,Docker,pm2"
---

# nb app start

Запуск приложения NocoBase указанного env. Установки npm/Git автоматически выполняют необходимую подготовку установки или обновления перед запуском локальных команд приложения, а установки Docker пересоздают контейнер приложения из сохранённой конфигурации env.
