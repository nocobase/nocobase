...
Документация использует [Rspress](https://rspress.dev/) в качестве генератора статических сайтов и поддерживает 8 языков. Структура организована следующим образом:
