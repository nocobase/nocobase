...
Если вам сейчас нужно настроить production-proxy для приложения NocoBase, лучше начать со страницы [Reverse proxy в продакшене](../../../quickstart/production/reverse-proxy/index.md), а затем перейти к странице [Caddy](../../../quickstart/production/reverse-proxy/caddy.md).
