...
**Задано**: разрешены только запросы, чей хост соответствует записи в белом списке; несовпадающие запросы возвращают ошибку. В будущих версиях поведение по умолчанию может постепенно стать строже. Если вашей установке нужен доступ к внутренним сервисам, заранее настройте явный белый список.
