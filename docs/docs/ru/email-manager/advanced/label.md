...
В правой части окна с деталями письма вы можете **выбрать теги** для него:
...
Если вы создаете новый тег, он будет выбран по умолчанию. Вы также можете вручную выбрать другие теги:
![](https://static-docs.nocobase.com/email-manager/Email-10-31-2025_06_06_PM%20(1).png)

В списке писем вы можете просмотреть теги, соответствующие письмам:
