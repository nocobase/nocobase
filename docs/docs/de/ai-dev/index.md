...
- [AI Portal](../ai-builder/ai-portal/index.md) — Die KI Frontend-Seiten schreiben lassen. Ein Plugin erweitert NocoBase selbst, ein Portal baut auf diesen Fähigkeiten einen eigenständigen Einstieg auf
