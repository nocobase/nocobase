...
E-Mails mit demselben Betreff werden zusammengefasst, und im Betreff-Feld wird die Gesamtzahl der E-Mails in der Konversation angezeigt.
Wenn bestimmte E-Mails innerhalb derselben Konversation den Filterkriterien entsprechen, wird die Stamm-E-Mail der Konversation angezeigt, und der Typ der aktuellen Stamm-E-Mail wird neben dem Betreff-Feld angegeben.
