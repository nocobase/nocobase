...
> Aus Wartungsgründen wurde CRM 2.0 in das [All-in-One-Business-System](../all-in-one/installation.md) integriert. Wenn Sie die eigenständige Version von CRM 2.0 benötigen (Snapshot vom 06.04.2026, wird nicht mehr aktualisiert), verwenden Sie die folgenden archivierten Dateien:
