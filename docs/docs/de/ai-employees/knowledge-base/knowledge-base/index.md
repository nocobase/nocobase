...
| --- | --- |
| Upload files, view vectorization status, and rerun vectorization | [Dokumentverwaltung](./documents) |
| View, edit, disable, or delete document segments | [Segmentverwaltung](./segments) |
| Test which segments a question can match | [Treffertests](./hit-tests) |
| Modify knowledge base information and default segmentation settings | [Einstellungen](./settings) |
