...
- [@nocobase/plugin-auth-sms](/auth-verification/auth-sms/index.md) – Bietet die Anmeldung per SMS-Verifizierung.
- [@nocobase/plugin-auth-saml](/auth-verification/auth-saml/index.md) – Bietet die SAML SSO-Anmeldung.
- [@nocobase/plugin-auth-oidc](/auth-verification/auth-oidc/index.md) – Bietet die OIDC SSO-Anmeldung.
- [@nocobase/plugin-auth-cas](/auth-verification/auth-cas/index.md) – Bietet die CAS SSO-Anmeldung.
- [@nocobase/plugin-auth-ldap](/auth-verification/auth-ldap/index.md) – Bietet die LDAP SSO-Anmeldung.
- [@nocobase/plugin-auth-wecom](/auth-verification/auth-wecom/index.md) – Bietet die WeCom-Anmeldung.
- [@nocobase/plugin-auth-dingtalk](/auth-verification/auth-dingtalk/index.md) – Bietet die DingTalk-Anmeldung.
