...
> Siehe „[Installationsdokumentation](https://docs.nocobase.com/get-started/quickstart)"
...
> Siehe „[Deployment-Dokumentation](https://docs.nocobase.com/get-started/deployment/production)"
