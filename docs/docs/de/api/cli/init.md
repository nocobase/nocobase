...
| `--skip-download` | boolean | Überspringt das Herunterladen der Anwendungsdateien oder das Pullen des Docker-Images vor der Installation und verwendet vorhandene lokale Ressourcen weiter |
