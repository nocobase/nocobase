...
- **[cli]**
  ...
  - 支持 basic auth ([#9558](https://github.com/nocobase/nocobase/pull/9558)) by @chenos
...
- **[client-v2]**
  ...
  - v2表格区块新增启用行选择设置项 ([#9614](https://github.com/nocobase/nocobase/pull/9614)) by @katherinehhh
...
- **[AI 员工]**
  ...
  - 工作流 AI 员工节点交互UI调整及bug修复 ([#9213](https://github.com/nocobase/nocobase/pull/9213)) by @cgyrock
