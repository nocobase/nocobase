...
const category: TokenTree<keyof AliasToken | string> = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        seedToken: ['colorBgHeader', 'colorBgHeaderMenuHover', 'colorBgHeaderMenuActive', 'colorTextHeaderMenu'],
      },
      {
        key: 'settingsColor',
        type: 'Color',
        ...
        desc: '用于配置 UI 配置组件的颜色',
        descEn: 'Used to configure the color of the UI configuration component.',
        // seedToken: ['colorPrimarySettings'],
        seedToken: ['colorBgSettings', 'colorBorderSettings', 'colorTextSettings'],
      },
    ],
  },
  {
