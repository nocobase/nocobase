...
const category: TokenTree<keyof AliasToken | string> = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        mapToken: ['colorBgHeader', 'colorBgHeaderMenuHover', 'colorBgHeaderMenuActive', 'colorTextHeaderMenu'],
      },
      {
        key: 'settingsColor',
        type: 'Color',
        ...
        mapToken: ['colorBgSettings', 'colorBorderSettings', 'colorTextSettings'],
      },
    ],
  },
  {
