...
import {
  ...
  isTemplateDescriptorImport,
  isRelativeImportOutsideCurrentTemplate,
...
class ForbiddenRuntimeApiValidator {
  validateCodeFile(
    ...
    boundary: 'template' | 'shared' = 'template',
        ...
        if (specifier && !specifier.startsWith('.')) {
          diagnostics.push(
            diagnosticAt(
              ...
              'import_not_allowed',
              'error',
              `Re-export from "${specifier}" is not allowed in js-template source`,
              target,
            ),
          );
        } else if (specifier && isTemplateDescriptorImport(file.path, specifier)) {
          ...
          diagnostics.push(
            diagnosticAt(
              ...
              boundary === 'shared'
                ...
                : `Relative re-export "${specifier}" must stay within the current JS Template or src/shared`,
              target,
            ),
          );
        }
        ...
        if (specifier) {
          diagnostics.push(
            diagnosticAt(
              ...
              'require_not_allowed',
              'error',
              'import = require(...) is not allowed in js-template source',
              target,
            ),
          );
        }
      ...
      if (ts.isCallExpression(node) && node.expression.kind === ts.SyntaxKind.ImportKeyword) {
        diagnostics.push(
          diagnosticAt(
            ...
            'error',
            'Dynamic import(...) is not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'require_not_allowed',
            'error',
            'require(...) is not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (forbiddenRequireReference) {
        diagnostics.push(
          diagnosticAt(
            ...
            'require_not_allowed',
            'error',
            'require references are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (forbiddenReflectGetReference) {
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Reflect.get references are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Reflect.get higher-order calls are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'require_not_allowed',
            'error',
            'require call helpers are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Reflect.get call helpers are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Global object prototype exposure is not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Dynamic privileged static calls are not allowed in js-template source',
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'eval is not allowed in js-template source',
            target,
          ),
        );
      }
        ...
        if (privilegedObjectStaticAccessName) {
          diagnostics.push(
            diagnosticAt(
              ...
              'blocked_global_api',
              'error',
              `${privilegedObjectStaticAccessName} references are not allowed in js-template source`,
              target,
            ),
          );
        }
        ...
        if (staticHelperName) {
          diagnostics.push(
            diagnosticAt(
              ...
              'blocked_global_api',
              'error',
              `${staticHelperName} call helpers are not allowed in js-template source`,
              target,
            ),
          );
        }
        ...
        if (globalConstructorName) {
          diagnostics.push(
            diagnosticAt(
              ...
              'blocked_global_api',
              'error',
              `${globalConstructorName} global access is not allowed in js-template source`,
              target,
            ),
          );
        }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Function constructor is not allowed in js-template source',
            target,
          ),
        );
      }
        ...
        if (computedBlockedApiName) {
          diagnostics.push(
            diagnosticAt(
              ...
              'error',
              `${computedBlockedApiName} is not allowed in js-template source`,
              target,
            ),
          );
        }
      ...
      if (descriptorValueMemberName) {
        diagnostics.push(
          diagnosticAt(
            ...
            'error',
            `${descriptorValueMemberName} is not allowed in js-template source`,
            target,
          ),
        );
      }
      ...
      if (
        ...
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${memberName || 'Global API'} is not allowed in js-template source`,
            target,
          ),
        );
      }
        ...
        if (reflectedMemberName) {
          diagnostics.push(
            diagnosticAt(
              ...
              'blocked_global_api',
              'error',
              `${reflectedMemberName} is not allowed in js-template source`,
              target,
            ),
          );
        }
      ...
      if (blockedIdentifierApi) {
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${blockedIdentifierApi} is not allowed in js-template source`,
            target,
          ),
        );
      }
      ...
      if (isProcessGlobalMemberAccess(node, globalObjectAliases, reflectObjectAliases, reflectGetAliases)) {
        diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'process is not allowed in js-template source',
            target,
          ),
        );
      }
  ...
  private recordForbiddenAlias(input: {
    ...
    if (isObjectConstructorExpression(expression, input.staticStringAliases) || privilegedObjectStaticMethodName) {
      input.diagnostics.push(
        diagnosticAt(
          ...
          'blocked_global_api',
          'error',
          `${privilegedObjectStaticMethodName || 'Object'} aliasing is not allowed in js-template source`,
          input.target,
        ),
      );
    }
    ...
    if (
      ...
      input.diagnostics.push(
        diagnosticAt(
          ...
          'require_not_allowed',
          'error',
          'require aliasing is not allowed in js-template source',
          input.target,
        ),
      );
    }
    ...
    if (
      ...
      input.diagnostics.push(
        diagnosticAt(
          ...
          'require_not_allowed',
          'error',
          'require call helper aliasing is not allowed in js-template source',
          input.target,
        ),
      );
    }
    ...
    if (
      ...
      input.diagnostics.push(
        diagnosticAt(
          ...
          'blocked_global_api',
          'error',
          'Reflect.get call helper aliasing is not allowed in js-template source',
          input.target,
        ),
      );
    }
    ...
    input.diagnostics.push(
      diagnosticAt(
        ...
        'blocked_global_api',
        'error',
        `${blockedApiName} is not allowed in js-template source`,
        input.target,
      ),
    );
  }
        ...
        if (
          ...
          input.diagnostics.push(
            diagnosticAt(
              ...
              'error',
              'Dynamic computed destructuring from privileged objects is not allowed in js-template source',
              input.target,
            ),
          );
          continue;
      ...
      if (bindsFromObjectConstructor && memberName && privilegedObjectStaticMethods.has(memberName)) {
        input.diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${memberName} aliasing is not allowed in js-template source`,
            input.target,
          ),
        );
        continue;
      ...
      if (blockedMemberName) {
        input.diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${blockedMemberName} is not allowed in js-template source`,
            input.target,
          ),
        );
        if (ts.isIdentifier(element.name)) {
      ...
      if (
        ...
        input.diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${bindsFromGlobalPropertyDescriptor} is not allowed in js-template source`,
            input.target,
          ),
        );
        if (ts.isIdentifier(element.name)) {
      ...
      if (
        ...
        input.diagnostics.push(
          diagnosticAt(
            ...
            'error',
            'Nested destructuring from privileged global descriptors is not allowed in js-template source',
            input.target,
          ),
        );
        continue;
      ...
      if (bindsFromObjectConstructor && privilegedObjectStaticMethods.has(propertyTarget.memberName)) {
        input.diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            `${propertyTarget.memberName} aliasing is not allowed in js-template source`,
            input.target,
          ),
        );
        continue;
      ...
      if (
        ...
        input.diagnostics.push(
          diagnosticAt(
            ...
            'blocked_global_api',
            'error',
            'Global object aliasing into object properties is not allowed in js-template source',
            input.target,
          ),
        );
        continue;
      ...
      if (
        ...
        input.diagnostics.push(
          diagnosticAt(
            ...
            propertyTarget.memberName === 'require' ? 'require_not_allowed' : 'blocked_global_api',
            'error',
            `${propertyTarget.memberName} is not allowed in js-template source`,
            input.target,
          ),
        );
        continue;
...
export function validateCodeFile(
  ...
  return forbiddenRuntimeApiValidator.validateCodeFile(file, target, boundary, templateRootPath);
}
      ...
      forbidden: {
        ...
        message:
          forbidden.code === 'require_not_allowed'
            ? 'Passing require references into calls is not allowed in js-template source'
            : 'Passing privileged object or API references into calls is not allowed in js-template source',
      },
    });
  }
  return findings;
...
function getForbiddenStoredExpressionDiagnostic(
  ...
  if (isObjectConstructorExpression(expression, staticStringAliases) || objectStaticMethodName) {
    return {
      ...
      } aliasing into object properties is not allowed in js-template source`,
    };
  }
  ...
  if (
    ...
    return {
      ...
      message: 'require aliasing into object properties is not allowed in js-template source',
    };
  }
  ...
  if (descriptorMemberName) {
    return {
      ...
      message: `${descriptorMemberName} is not allowed in js-template source`,
    };
  }
  ...
  if (blockedApiName) {
    return {
      ...
      message: `${blockedApiName} is not allowed in js-template source`,
    };
  }
  ...
  if (
    ...
    return {
      code: 'blocked_global_api',
      message: 'Global property descriptors are not allowed in js-template source',
    };
  }
  ...
  if (
    ...
    return {
      code: 'blocked_global_api',
      message: 'Global object aliasing into object properties is not allowed in js-template source',
    };
  }
  ...
  if (isReflectGetFunctionExpression(expression, reflectObjectAliases, reflectGetAliases, staticStringAliases)) {
    return {
      code: 'blocked_global_api',
      message: 'Reflect.get aliasing into object properties is not allowed in js-template source',
    };
  }
  ...
  if (isReflectObjectExpression(expression, reflectObjectAliases, staticStringAliases)) {
    return {
      code: 'blocked_global_api',
      message: 'Reflect aliasing into object properties is not allowed in js-template source',
    };
  }
...
function getForbiddenComputedElementAccessDiagnostic(
  ...
  if (!memberName) {
    if (
      ...
      return {
        code: 'blocked_global_api',
        message: 'Dynamic global property access is not allowed in js-template source',
      };
    }
    if (
      isGlobalPropertyDescriptorsObjectExpression(
      ...
      return {
        code: 'blocked_global_api',
        message: 'Dynamic global descriptor access is not allowed in js-template source',
      };
    }
    if (isReflectObjectExpression(expression.expression, reflectObjectAliases, staticStringAliases)) {
      return {
        code: 'blocked_global_api',
        message: 'Dynamic Reflect property access is not allowed in js-template source',
      };
    }
    return null;
  }
  ...
  if (
    ...
    if (memberName === 'require') {
      return {
        code: 'require_not_allowed',
        message: 'require is not allowed in js-template source',
      };
    }
    if (blockedGlobalMembers.has(memberName)) {
      return {
        code: 'blocked_global_api',
        message: `${memberName} is not allowed in js-template source`,
      };
    }
    if (globalAliasMemberNames.has(memberName)) {
      return {
        code: 'blocked_global_api',
        message: 'Global object aliasing is not allowed in js-template source',
      };
    }
  }
