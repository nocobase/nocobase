...
export function createJsTemplateUsageServiceFixture(
  input: {
...
export function createRepository(input: FixtureRepositoryInput = {}) {
...
export function createJsActionSourceBinding(
  ...
  return createSourceBinding({
    projectId: 'jtp_actions',
    templateId: 'jtt_mark_approved',
    kind: 'js-action',
    ...input,
  });
}
...
export function createProjectRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
  return {
    id: 'jtp_sales',
...
export function createJsFieldTemplateRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
...
export function createJsActionTemplateRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
  return createTemplateRecord({
    id: 'jtt_mark_approved',
    projectId: 'jtp_actions',
    kind: 'js-action',
    healthStatus: 'ready',
    ...input,
...
export function createJsItemTemplateRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
  return createTemplateRecord({
    id: 'jtt_level_label',
    projectId: 'jtp_items',
    kind: 'js-item',
...
export function createTemplateRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
...
export function createUsageRecord(input: Record<string, unknown> = {}): Record<string, unknown> {
...
export function hashOwnerLocator(ownerLocator: JsTemplateUsageOwnerLocator): string {
...
function matchesFilterByTk(record: MutableModel, filterByTk?: string | string[]): boolean {
  ...
  return (
    ...
    record.get('templateId') === filterByTk
  );
}
