...
export default defineCollection({
  ...
  fields: [
    ...
    { type: 'bigInt', name: 'storageId', index: true },
    { type: 'string', name: 'objectPath', hidden: true },
    { type: 'string', name: 'objectFilename', hidden: true },
    { type: 'string', name: 'objectKey', hidden: true },
    { type: 'jsonb', name: 'chunkManifestJson', defaultValue: [], hidden: true },
