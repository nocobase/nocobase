...
/** Stable public error codes retained for legacy HTTP, CLI, and SDK consumers. */
export const LIGHT_EXTENSION_ERROR_CODES = [
...
export type LightExtensionErrorCode = (typeof LIGHT_EXTENSION_ERROR_CODES)[number];
...
const defaultStatusByCode: Record<LightExtensionErrorCode, number> = {
  ...
  LIGHT_EXTENSION_REPO_DISABLED: 409,
  ...
  LIGHT_EXTENSION_IDEMPOTENCY_CONFLICT: 409,
  LIGHT_EXTENSION_IDEMPOTENCY_IN_PROGRESS: 409,
