...
function isAutoGeneratedPopupTemplate(row: FlowSurfaceTemplateRow) {
  ...
  return (
    name.endsWith(AUTO_GENERATED_SUFFIX) ||
    name.startsWith(LEGACY_AUTO_POPUP_PREFIX) ||
...
export async function resolveFlowTemplateDisplayRow(
  ...
  if (String(nextRow.type || '').trim() !== 'popup' || !isAutoGeneratedPopupTemplate(nextRow)) {
    return nextRow;
  }
