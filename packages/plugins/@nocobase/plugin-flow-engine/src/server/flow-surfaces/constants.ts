...
export const FLOW_SURFACE_ACTION_DEFINITIONS = {
  ...
  getEventFlowMeta: { method: 'post', read: true, transaction: false, mutate: false, valueSource: 'default' },
  addEventFlow: { method: 'post', read: false, transaction: true, mutate: true, valueSource: 'default' },
  setEventFlow: { method: 'post', read: false, transaction: true, mutate: true, valueSource: 'default' },
  removeEventFlow: { method: 'post', read: false, transaction: true, mutate: true, valueSource: 'default' },
