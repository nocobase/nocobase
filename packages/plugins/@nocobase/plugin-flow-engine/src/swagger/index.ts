    ...
    schemas: {
      ...
      FlowSchemaRegistrySummary: {
        ...
        required: [
          ...
          'pluginModels',
          'thirdPartyModels',
          'publicOfficialModelsTotal',
          'publicOfficialModelsCovered',
          'publicOfficialStrictModels',
          'publicOfficialUnresolvedModels',
          'missingModelUses',
          'missingActionNames',
        ],
        properties: {
          ...
          publicOfficialModelsTotal: { type: 'number' },
          publicOfficialModelsCovered: { type: 'number' },
          publicOfficialStrictModels: { type: 'number' },
          publicOfficialUnresolvedModels: { type: 'number' },
          missingModelUses: { type: 'array', items: { type: 'string' } },
          missingActionNames: { type: 'array', items: { type: 'string' } },
        },
        additionalProperties: false,
      },
