...
import { CollectionTriggerNode, ConditionYesNode, QueryRecordNode } from '@nocobase/plugin-workflow-test/client';
import { ClculationNode, ConditionBranchNode } from '@nocobase/plugin-workflow-test/client';
