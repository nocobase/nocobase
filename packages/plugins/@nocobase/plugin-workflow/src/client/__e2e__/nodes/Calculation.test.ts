...
test('Collection event add data trigger, Math engine, get trigger node single line text variable', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test('Collection event add data trigger, Formula engine, get trigger node single line text variable', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test('Collection event add data triggers, Math engine, get predecessor Math engine arithmetic node data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test('Collection event add data triggers, Formula engine, get predecessor Formula engine arithmetic node data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
  ...
  const preCalculationNodeData = {
    ...
    branchIndex: null,
    title: preCalculationNodeTitle,
    config: { engine: 'formula.js', expression: '{{$context.data.orgname}}' },
  };
  const preCalculationNode = await apiCreateWorkflowNode(workflowId, preCalculationNodeData);
  const preCalculationNodeObj = JSON.parse(JSON.stringify(preCalculationNode));
  const preCalculationNodeId = preCalculationNodeObj.id;
...
test('Collection event add data trigger, Math engine, get front added data node single line text data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test('Collection event add data trigger, Formula engine, get front added data node single line text data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test.skip('Collection event add data trigger, Math engine, get front manual node add form single line text data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
...
test.skip('Collection event add data trigger, Formula engine, get front manual node add form single line text data', async ({
  page,
  mockCollections,
  mockRecords,
}) => {
