...
import { CollectionTriggerNode, DeleteRecordNode, apiCreateWorkflow, apiDeleteWorkflow, apiGetList, apiUpdateWorkflowTrigger, appendJsonCollectionName, generalWithNoRelationalFields } from '@nocobase/plugin-workflow-test/e2e';
