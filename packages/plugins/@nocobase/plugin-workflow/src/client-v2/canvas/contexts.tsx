...
export const FlowContext = getWorkflowSingleton('FlowContext', () => createContext<WorkflowCanvasFlowContextValue>({}));
...
export const CurrentWorkflowContext = getWorkflowSingleton('CurrentWorkflowContext', () =>
  createContext<Partial<WorkflowCanvasRecord>>({}),
);
...
export const WorkflowVariableSourceContext = getWorkflowSingleton('WorkflowVariableSourceContext', () =>
  createContext<Partial<WorkflowCanvasRecord> | null>(null),
);
...
export const NodeContext = getWorkflowSingleton('NodeContext', () => createContext<CanvasNode>({} as CanvasNode));
