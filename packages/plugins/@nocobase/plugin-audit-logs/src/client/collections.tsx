import { CollectionOptionsV2 } from '@nocobase/client';

export const auditLogsCollection: CollectionOptionsV2 = {
  name: 'auditLogs',
  title: '{{t("Audit logs")}}',
  fields: [
    {
...
export const auditChangesCollection: CollectionOptionsV2 = {
  name: 'auditChanges',
...
export const auditCollectionsCollection = {
  name: 'collections',
  title: '{{t("Collections")}}',
  fields: [
    {
