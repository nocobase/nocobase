  ...
  fieldset: {
    ...
    options: {
      ...
      properties: {
        ...
        isPrivate: {
          title: `{{t("Private bucket", { ns: "${NAMESPACE}" })}}`,
          type: 'boolean',
          'x-decorator': 'FormItem',
          'x-component': 'Checkbox',
          default: false,
          description: `{{t('If enabled, the system will generate signed URLs for file access when the bucket is private.', { ns: "${NAMESPACE}" })}}`,
        },
      },
    },
    path: common.path,
