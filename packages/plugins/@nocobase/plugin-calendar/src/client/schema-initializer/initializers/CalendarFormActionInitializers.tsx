 ...
 * 表单的操作配置
 */
export const CalendarFormActionInitializers_deprecated = new CompatibleSchemaInitializer({
...
export const calendarFormActionInitializers = new CompatibleSchemaInitializer(
  {
    title: generateNTemplate('Configure actions'),
    name: 'actionInitializers:calendarForm',
    icon: 'SettingOutlined',
    style: {
      marginLeft: 8,
    },
