...
const { ChannelManager } = createLazyComponents(() => import('./manager/channel/components'), 'ChannelManager');
...
const { LogManager } = createLazyComponents(() => import('./manager/log/components/Manager'), 'LogManager');
