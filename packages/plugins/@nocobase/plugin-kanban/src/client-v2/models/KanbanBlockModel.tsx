...
KanbanBlockModel.registerFlow({
  key: 'kanbanSettings',
  sort: 500,
  title: tExpr('Kanban settings'),
  steps: {
    grouping: {
      title: tExpr('Grouping settings'),
      preset: true,
      uiSchema: (ctx) => {
        ...
        return {
          grouping: {
            ...
            properties: {
              ...
              groupOptions: {
                type: 'array',
                title: tExpr('Select group values'),
    ...
    dragSortBy: {
      ...
      uiSchema: (ctx) => {
        ...
        const sortFields = model.getSortFieldCandidates(groupField?.name);
        const resourceParams = model.getResourceSettingsInitParams?.() || {};
        return {
          dragSortBy: {
            type: 'string',
            ...
            'x-component-props': {
              ...
              groupField: groupField
                ...
                : undefined,
              collectionName: model.collection?.name || resourceParams.collectionName,
              dataSource: model.collection?.dataSourceKey || resourceParams.dataSourceKey,
            },
          },
        };
      },
