...
export default {
  name: 'flow-resource',
  content: String.raw`# FlowResource 及资源体系
...
resource.setMeta({ page: 1, count: 100 });
console.log(resource.getMeta('page')); // 1
console.log(resource.getMeta()); // { page: 1, count: 100 }
\`\`\`
...
console.log('列表数据', listResource.getData());
console.log('当前页码', listResource.getMeta('page'));
console.log('每页记录数', listResource.getMeta('pageSize'));
console.log('总记录数', listResource.getMeta('count'));
console.log('总页数', listResource.getMeta('totalPage'));
