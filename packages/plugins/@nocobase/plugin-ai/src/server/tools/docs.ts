...
export function createDocsSearchTool(options?: { description?: string }): ToolOptions {
  return {
    ...
    description:
      options?.description ?? 'Search docs modules generated by ai:create-docs-index (use module keys such as runjs).',
    schema: z.object({
...
export function createReadDocEntryTool(options?: { description?: string }): ToolOptions {
  return {
    ...
    description:
      options?.description ??
      'Read files or list directories inside storage/ai/docs using canonical module-based paths.',
    schema: z.object({
      path: z
        .string()
