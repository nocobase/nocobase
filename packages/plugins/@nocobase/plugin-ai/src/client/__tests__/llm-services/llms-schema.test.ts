...
describe('LLM Schema', () => {
  describe('P0: createLLMSchema (New Form)', () => {
    ...
    it('should have enabledModels field with object type', () => {
      ...
      expect(drawerProperties.enabledModels).not.toHaveProperty('required');
    });

    it('should have title field as optional (no required)', () => {
      expect(drawerProperties.title).toBeDefined();
      expect(drawerProperties.title).not.toHaveProperty('required');
    ...
    it('should have options.baseURL field as optional', () => {
      ...
      expect(drawerProperties['options.baseURL']).not.toHaveProperty('required');
    });
    ...
    describe('P1: Field order', () => {
      it('should have correct field order in schema', () => {
        ...
        expect(fieldKeys.indexOf('provider')).toBeLessThan(fieldKeys.indexOf('title'));
        expect(fieldKeys.indexOf('title')).toBeLessThan(fieldKeys.indexOf('options'));
        expect(fieldKeys.indexOf('options')).toBeLessThan(fieldKeys.indexOf('options.baseURL'));
        expect(fieldKeys.indexOf('options.baseURL')).toBeLessThan(fieldKeys.indexOf('enabledModels'));
        expect(fieldKeys.indexOf('enabledModels')).toBeLessThan(fieldKeys.indexOf('footer'));
      });
    });
  });
  ...
  describe('P0: llmsSchema (Edit Form)', () => {
    ...
    it('should have enabledModels field with object type', () => {
      ...
      expect(editDrawerProperties.enabledModels).not.toHaveProperty('required');
    });

    it('should have title field as optional', () => {
      expect(editDrawerProperties.title).toBeDefined();
      expect(editDrawerProperties.title).not.toHaveProperty('required');
    });
  ...
  describe('P1: TestFlight component in footer', () => {
    it('should have testFlight component in create form footer', () => {
      const drawerProperties = createLLMSchema.properties.drawer.properties;
      expect(drawerProperties.footer).toBeDefined();
      expect(drawerProperties.footer.properties.testFlight).toBeDefined();
      expect(drawerProperties.footer.properties.testFlight['x-component']).toBe('LLMTestFlight');
    });

    it('should have testFlight component in edit form footer', () => {
      const tableProperties = llmsSchema.properties.card.properties.table.properties;
      const editDrawerProperties =
        tableProperties.column5.properties.actions.properties.edit.properties.drawer.properties;
      expect(editDrawerProperties.footer).toBeDefined();
      expect(editDrawerProperties.footer.properties.testFlight).toBeDefined();
