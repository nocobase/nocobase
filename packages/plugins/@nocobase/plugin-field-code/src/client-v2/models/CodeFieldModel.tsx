...
import { EditableItemModel, FilterableItemModel, largeField } from '@nocobase/flow-engine';
...
@largeField()
export class CodeFieldModel extends FieldModel {
...
(CodeFieldModel as any).define({
  label: tExpr('Code'),
});

(CodeFieldModel as any).registerFlow({
...
EditableItemModel.bindModelToInterface('CodeFieldModel', ['code'], { isDefault: true });
FilterableItemModel.bindModelToInterface('InputFieldModel', ['code'], { isDefault: true });
