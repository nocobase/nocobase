...
export interface NumberToWordsFieldOptions extends BaseFieldOptions {
  type: 'NumberToWords';
  engine: string;
  expression: string;
}
...
export class NumberToWordsField extends Field {
  get dataType() {
  ...
  calculate(scope) {
    const { expression, engine = 'math.js', dataType = 'string', currency, uiSchema } = this.options;
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log(uiSchema?.['x-component-props']?.['ignoreDecimal'], uiSchema?.['x-component-props']?.['doNotAddOnly']);
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
    // console.log('***************************************');
