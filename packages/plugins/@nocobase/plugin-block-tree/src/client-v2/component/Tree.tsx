...
import { compileUiSchema, useFlowEngine } from '@nocobase/flow-engine';
...
export const Tree: FC<TreeProps> = (props) => {
  ...
  const compile = useCallback(
    (source: any) => compileUiSchema({ t: flowEngine.context.t.bind(flowEngine.context) }, source),
    [flowEngine],
  );
