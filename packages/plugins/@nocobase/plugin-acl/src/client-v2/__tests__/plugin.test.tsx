...
describe('plugin-acl client-v2', () => {
  it('should register the /v2-demo/ homepage route', async () => {
    const app = await loadPlugin();

    expect(app.router.getRoutes()['acl-v2.homepage']).toMatchObject({
      path: '/v2-demo/',
    });
  });
  ...
  it('should register the /v2-demo/app-info route', async () => {
    ...
    expect(app.router.getRoutes()['acl-v2.app-info']).toMatchObject({
  ...
  it('should register the /v2-demo/flow-settings-component-loader route and lazy field', async () => {
    ...
    expect(app.router.getRoutes()['acl-v2.flow-settings-component-loader']).toMatchObject({
