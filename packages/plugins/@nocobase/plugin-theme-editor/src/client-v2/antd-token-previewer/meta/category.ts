...
const category: TokenTree<keyof AliasToken | string> = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        type: 'Color',
        name: '侧边菜单色',
        nameEn: 'Sider Menu Color',
        desc: '只会影响页面侧边菜单',
        descEn: 'Only affects the sider menu at the left of the page.',
        // seedToken: ['colorPrimaryHeader'],
        seedToken: [
          'colorBgSider',
