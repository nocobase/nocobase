  ...
  test('supported options', async ({ page, mockPage }) => {
    ...
    await expectSettingsMenu({
      ...
      showMenu: async () => {
        ...
        await page.getByLabel(`block-item-CollectionField-general-form-general.JSON-JSON`).hover();
        await page
          .getByLabel(`designer-schema-settings-CollectionField-FormItem.Designer-general-general.JSON`)
          .hover();
      },
      supportedOptions: [
        'Edit field title',
