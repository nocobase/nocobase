...
import { setCachedConfig, type FilePreviewerConfig } from '../hooks';
import { KKFILEVIEW_DEFAULT_EXTENSIONS } from '../../client-v2/utils';
...
export const Configuration = () => {
  ...
  const [formData, setFormData] = useState({
    previewType: 'microsoft' as FilePreviewerConfig['previewType'],
