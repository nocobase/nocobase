...
const CustomTheme = () => {
  ...
  const editSave = useCallback(() => {
    ...
    const themeConfig = themeConfigContent.text ? JSON.parse(themeConfigContent.text) : themeConfigContent.json;
        ...
        <div className={styles.header}>
          ...
          <div>
            ...
            >
              ...
              >
                {/* <JSONEditor content={themeConfigContent} onChange={handleEditConfigChange} mainMenuBar={false} /> */}
              </Suspense>
            </Modal>
