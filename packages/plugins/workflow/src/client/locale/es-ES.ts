export default {
  ...
  "String operation": "Operación de String",
  ...
  "Branch into \"Yes\" and \"No\"": "Bifurcarse en \"Sí\" y \"No\"",
  ...
  "Continue after any branch succeeded": "Continuar después de cualquier rama con éxito",
  ...
  "Fields that are not assigned a value will be set to the default value, and those that do not have a default value are set to null.": "Los campos a los que no se les asigne un valor se establecerán en el valor predeterminado, y los que no tengan un valor predeterminado se establecerán en null.",
  ...
  "URL": "URL",
  "Headers": "Cabeceras",
  "Add request header": "Añadir cabecera de petición",
