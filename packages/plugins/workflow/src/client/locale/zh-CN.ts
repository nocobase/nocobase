export default {
  ...
  'HTTP request url': 'HTTP 请求地址',
  'Input HTTP request url': '输入 HTTP 请求地址',
  'HTTP request headers': 'HTTP 请求头',
  'Name(e.g. Content-Type)': '名称(例如 Content-Type)',
  'Value(e.g. Application/json)': '值(例如 Application/json)',
  'Add HTTP request header': '添加 HTTP 请求头',
  'HTTP method': 'HTTP 方法',
  'Available variables': '可用变量',
  'POST method request data': 'POST 方法请求数据',
  'Input POST method request data': '输入 POST 方法请求数据',
  'You can use the above available variables in request data (supported by ejs https://ejs.co )': '您可以在请求数据中使用上面的可用变量(由 ejs 支持 https://ejs.co )',
  'GET method request param': 'GET 方法请求参数',
  'Input GET method request param': '输入 GET 方法请求参数',
  'You can use the above available variables in request param (supported by ejs https://ejs.co )': '您可以在请求参数中使用上面的可用变量(由 ejs 支持 https://ejs.co )',
  'Copy success!': '拷贝成功！',
