export default {
  ...
  'URL': '地址',
  'Headers': '请求头',
  'Name(e.g. Authorization)': '名称(例如 Authorization)',
  'Value(e.g. Bearer abc)': '值(例如 Bearer abc)',
  ...
  'Variables could be used under json-templates format': '可以通过 json-templates 的格式使用变量',
  'Copy success!': '拷贝成功！',
