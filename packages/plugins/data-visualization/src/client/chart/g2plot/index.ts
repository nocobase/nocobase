...
export default [
  new G2PlotChart({ name: 'line', title: 'Line Chart', component: Line, config: ['smooth', 'isStack'] }),
  new G2PlotChart({ name: 'area', title: 'Area Chart', component: Area, config: ['smooth', 'isStack', 'isPercent'] }),
  new G2PlotChart({
    name: 'column',
    title: 'Column Chart',
    component: Column,
