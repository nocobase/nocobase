...
describe('collections repository', () => {
  it('case 1', async () => {
    ...
    await app1.plugin(PluginErrorHandler, { name: 'error-handler' });
    await app1.plugin(Plugin, { name: 'collection-manager' });
    ...
    await app2.plugin(PluginErrorHandler, { name: 'error-handler' });
    await app2.plugin(Plugin, { name: 'collection-manager' });
    await app2.load();
