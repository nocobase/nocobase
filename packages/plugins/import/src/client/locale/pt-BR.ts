export default {
  ...
  'Import done, total success have {{successCount}} , total failure have {{failureCount}}':
    'Importação concluída, com um total de {{successCount}} sucesso e {{failureCount}} falhas',
