...
export interface GoogleMapForwardedRefProps {
  setOverlay: (t: MapEditorType, v: any, o?: OverlayOptions) => any;
  getOverlay: (t: MapEditorType, v: any, o?: OverlayOptions) => any;
  ...
  map: google.maps.Map;
  editor: () => {
    getTarget: () => google.maps.MVCObject;
...
const GoogleMapComponent = React.forwardRef<GoogleMapForwardedRefProps, GoogleMapComponentProps>((props, ref) => {
  ...
  const createDraw = useMemoizedFn(() => {
  ...
  useEffect(() => {
    ...
    Promise.all([loader.importLibrary('drawing'), loader.importLibrary('core')])
      .then(async () => {
