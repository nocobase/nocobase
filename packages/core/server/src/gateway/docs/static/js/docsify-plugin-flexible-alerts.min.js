...
!(function () {
  ...
  !(function (t, e) {
    ...
    if (t && 'undefined' != typeof document) {
      ...
      (l.type = 'text/css'),
        'top' === a && o.firstChild ? o.insertBefore(l, o.firstChild) : o.appendChild(l),
        l.styleSheet ? (l.styleSheet.cssText = t) : l.appendChild(document.createTextNode(t));
    }
  })(
    ...
    (function () {
      var e = {
        ...
        warning: { label: 'Warning', icon: 'icon-warning', className: 'warning' },
        attention: { label: 'Attention', icon: 'icon-attention', className: 'attention' },
