!(function () {
  ...
  function g(e) {
    var n = e.match(/^([^:/?#]+:)?(?:\/{2,}([^/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
    return (
      ('string' == typeof n[1] && 0 < n[1].length && n[1].toLowerCase() !== location.protocol) ||
      ('string' == typeof n[2] &&
        0 < n[2].length &&
        n[2].replace(new RegExp(':(' + { 'http:': 80, 'https:': 443 }[location.protocol] + ')?$'), '') !==
          location.host) ||
      !!/^\/\\/.test(e)
    );
  }
  ...
  function E(e, n) {
    ...
    var i,
      o = [];
    for (i in e) -1 < n.indexOf(i) || o.push(e[i] ? (z(i) + '=' + z(e[i])).toLowerCase() : z(i));
  ...
  (I.prototype.getBasePath = function () {
    ...
    (I.prototype.getFile = function (e, n) {
      ...
      var i,
        ...
        t = this.config,
        a = this.getBasePath(),
        r = 'string' == typeof t.ext ? t.ext : '.md';
      return (
        (e = t.alias
          ? (function e(n, i, o) {
        ...
        (o = r),
        (e =
          ((e = new RegExp('\\.(' + o.replace(/^\./, '') + '|html)$', 'g').test(i)
            ? i
            : /\/$/g.test(i)
            ? i + 'README' + o
            : '' + i + o) ===
  ...
  var H = (function (o) {
      ...
      return (
        ...
        (e.prototype.onchange = function (i) {
          ...
          p('click', function (e) {
            ...
            p('hashchange', function (e) {
              ...
              (o = !1), i({ event: e, source: n });
            });
        }),
        (e.prototype.normalize = function () {
          var e = this.getCurrentPath();
          if ('/' === (e = P(e)).charAt(0)) return N(e);
          N('/' + e);
        }),
        (e.prototype.parse = function (e) {
          ...
          return (
            0 <= i && ((n = e.slice(i + 1)), (e = e.slice(0, i))), { path: e, file: this.getFile(e, !0), query: F(n) }
          );
        }),
    ...
    D = (function (n) {
      function e(e) {
        n.call(this, e), (this.mode = 'history');
      }
      return (
        n && (e.__proto__ = n),
        (((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.getCurrentPath = function () {
          ...
          return (
            ((n = e && 0 === n.indexOf(e) ? n.slice(e.length) : n) || '/') +
          ...
          void 0 === i && (i = d),
            p('click', function (e) {
              ...
              n &&
                ...
                i({ event: e, source: 'navigate' }));
            }),
            p('popstate', function (e) {
              i({ event: e, source: 'history' });
            });
        }),
        (e.prototype.parse = function (e) {
          var n = '',
            i = (e = void 0 === e ? location.href : e).indexOf('?');
          0 <= i && ((n = e.slice(i + 1)), (e = e.slice(0, i)));
          var o = q(location.origin),
            i = e.indexOf(o);
          return { path: (e = -1 < i ? e.slice(i + o.length) : e), file: this.getFile(e), query: F(n) };
        }),
        e
      );
    })(I),
  ...
  function G(e) {
    var n,
      ...
      o = e.total,
      t = e.step;
    Z || ((e = w('div')).classList.add('progress'), r(h, e), (Z = e)),
      ...
      95 <= n &&
        ...
        (B = setTimeout(function (e) {
          (Z.style.opacity = 0), (Z.style.width = '0%');
        }, 200)));
  }
  var W = {};
  function X(t, e, n) {
    ...
    for (i in (r.open('GET', t), n)) u.call(n, i) && r.setRequestHeader(i, n[i]);
    return (
      r.send(),
      {
        then: function (n, i) {
          ...
          void 0 === i && (i = d),
            e &&
              ((o = setInterval(function (e) {
                return G({ step: Math.floor(5 * Math.random() + 1) });
              }, 500)),
              a('progress', G),
            ...
            a('load', function (e) {
              ...
              400 <= e.status
                ? i(e)
                : ((e = W[t] = { content: e.response, opt: { updatedAt: r.getResponseHeader('last-modified') } }),
                  n(e.content, e.opt));
            });
        },
        abort: function (e) {
  ...
  function ee(e, n, o, i) {
    ...
    null != (n = l(n)) && (t = k(n, 'a'));
    var a,
      r = decodeURI(e.toURL(e.getCurrentPath()));
    return (
      t
        .sort(function (e, n) {
        ...
        .forEach(function (e) {
          ...
          (e.title = e.title || e.innerText),
            0 !== r.indexOf(n) || a ? S(i, 'remove', 'active') : ((a = e), S(i, 'add', 'active'));
        }),
  ...
  var ie =
    ((function (e, n, i) {
      return n && ne(e.prototype, n), i && ne(e, i), e;
    })(oe, [
      {
  ...
  var ae =
    ((function (e, n, i) {
      return n && te(e.prototype, n), i && te(e, i), e;
    })(re, [
      {
        key: 'begin',
        value: function () {
      ...
      },
      {
        key: 'on',
        value: function (e, n) {
          return (this.events[e] = this.events[e] || []), this.events[e].push(n), this;
        },
      },
      {
        key: '_emit',
      ...
      },
      {
        key: '_shouldTick',
        value: function (e) {
          return { up: this.next < this.end && e <= this.next, down: this.next > this.end && e >= this.next }[
            this.direction
          ];
        },
      },
  ...
  function ue(e) {
    ...
    if (o) for (var t in i) !u.call(i, t) || (f((n = o.getAttribute('data-' + a(t)))) && (i[t] = '' === n || n));
    return (
      !0 === i.loadSidebar && (i.loadSidebar = '_sidebar' + i.ext),
    ...
    if (ge) {
      for (
        var n,
          ...
          c = ((r && r.scrollTop) || document.body.scrollTop) - se,
          u = 0,
          f = o.length;
        u < f;
        u += 1
      ...
      !n ||
        ((r = fe[ve(e, n.getAttribute('data-id'))]) &&
          r !== a &&
          (a && a.classList.remove('active'),
          r.classList.add('active'),
          (a = r),
          !pe &&
            h.classList.contains('sticky') &&
            ((e = i.clientHeight),
  ...
  var we = be(function (n) {
    ...
    ye = (we.defaults, we.getDefaults, we.changeDefaults, /[&<>"']/),
    xe = /[&<>"']/g,
    Se = /[<>"']|&(?!#?\w+;)/,
    Ae = /[<>"']|&(?!#?\w+;)/g,
    $e = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' };
  ...
  var Me = function (e, n) {
      if (n) {
        if (ye.test(e)) return e.replace(xe, ke);
      } else if (Se.test(e)) return e.replace(Ae, ke);
      return e;
    },
    Ie = Fe,
    Ne = function (i, e) {
      ...
      var o = {
        replace: function (e, n) {
          return (n = (n = n.source || n).replace(Ee, '$1')), (i = i.replace(e, n)), o;
        },
        getRegex: function () {
    ...
    He = function (e, n, i) {
      if (e) {
        ...
        if (0 === o.indexOf('javascript:') || 0 === o.indexOf('vbscript:') || 0 === o.indexOf('data:')) return null;
      }
    ...
    Ue = function (e) {
      for (var n, i, o = arguments, t = 1; t < arguments.length; t++)
        for (i in (n = o[t])) Object.prototype.hasOwnProperty.call(n, i) && (e[i] = n[i]);
      return e;
    },
    Ze = function (e, n) {
      var i = e
          .replace(/\|/g, function (e, n, i) {
            for (var o = !1, t = n; 0 <= --t && '\\' === i[t]; ) o = !o;
            return o ? '|' : ' |';
          })
          .split(/ \|/),
        o = 0;
      if (i.length > n) i.splice(n);
      else for (; i.length < n; ) i.push('');
      for (; o < i.length; o++) i[o] = i[o].trim().replace(/\\\|/g, '|');
      return i;
    },
    Be = Pe,
    Ve = function (e, n) {
  ...
  function en(e, n, i) {
    var o = n.href,
      ...
      n = e[1].replace(/\\([\[\]])/g, '$1');
    return '!' !== e[0].charAt(0)
      ? { type: 'link', raw: i, href: o, title: t, text: n }
      : { type: 'image', raw: i, href: o, title: t, text: Je(n) };
  }
  var nn = (function () {
      function e(e) {
        this.options = e || We;
      ...
      return (
        ...
        (e.prototype.code = function (e, n) {
          ...
          if (e) {
            n = n[n.length - 1];
            if (n && 'paragraph' === n.type) return { raw: e[0], text: e[0].trimRight() };
        ...
        (e.prototype.fences = function (e) {
          ...
          if (n) {
            ...
            return { type: 'code', raw: i, lang: n[2] && n[2].trim(), text: e };
          }
        }),
        (e.prototype.heading = function (e) {
          ...
          if (n) {
            var i = n[2].trim();
            return (
              /#$/.test(i) && ((e = Xe(i, '#')), (!this.options.pedantic && e && !/ $/.test(e)) || (i = e.trim())),
              { type: 'heading', raw: n[0], depth: n[1].length, text: i }
            );
          }
        }),
            ...
            if (n.header.length === n.align.length) {
              for (var i = n.align.length, o = 0; o < i; o++)
                /^ *-+: *$/.test(n.align[o])
                  ...
                  ? (n.align[o] = 'left')
                  : (n.align[o] = null);
              for (i = n.cells.length, o = 0; o < i; o++) n.cells[o] = Qe(n.cells[o], n.header.length);
              return n;
            }
          }
        }),
        ...
        (e.prototype.blockquote = function (e) {
          ...
          if (n) {
            e = n[0].replace(/^ *> ?/gm, '');
            return { type: 'blockquote', raw: n[0], text: e };
          }
        }),
          ...
          if (e) {
            for (
              var n,
                ...
                c = e[2],
                u = 1 < c.length,
                f = { type: 'list', raw: r, ordered: u, start: u ? +c.slice(0, -1) : '', loose: !1, items: [] },
                p = e[0].match(this.rules.block.item),
                d = !1,
                g = p.length,
                s = this.rules.block.listItemStart.exec(p[0]),
                l = 0;
              l < g;
              l++
            ) {
              if (((r = n = p[l]), l !== g - 1)) {
                if (
                  ((o = this.rules.block.listItemStart.exec(p[l + 1])),
                ...
                (!this.options.pedantic || this.options.smartLists
                  ? o[2][o[2].length - 1] !== c[c.length - 1]
                  : u == (1 === o[2].length)) &&
                  ((i = p.slice(l + 1).join('\n')), (f.raw = f.raw.substring(0, f.raw.length - i.length)), (l = g - 1)),
                  (s = o);
              }
              (o = n.length),
                ~(n = n.replace(/^ *([*+-]|\d+[.)]) ?/, '')).indexOf('\n ') &&
                  ...
                  (n = this.options.pedantic
                    ? n.replace(/^ {1,4}/gm, '')
                    : n.replace(new RegExp('^ {1,' + o + '}', 'gm'), ''))),
                (o = d || /\n\n(?!\s*$)/.test(n)),
                l !== g - 1 && ((d = '\n' === n.charAt(n.length - 1)), (o = o || d)),
                o && (f.loose = !0),
                this.options.gfm &&
                  ((a = void 0),
                  (t = /^\[[ xX]\] /.test(n)) && ((a = ' ' !== n[1]), (n = n.replace(/^\[[ xX]\] +/, '')))),
                f.items.push({ type: 'list_item', raw: r, task: t, checked: a, loose: o, text: n });
            }
            return f;
          }
        }),
            ...
            if (n.header.length === n.align.length) {
              ...
              for (var i = n.align.length, o = 0; o < i; o++)
                /^ *-+: *$/.test(n.align[o])
                  ...
                  ? (n.align[o] = 'left')
                  : (n.align[o] = null);
              for (i = n.cells.length, o = 0; o < i; o++)
        ...
        (e.prototype.text = function (e, n) {
          ...
          if (e) {
            n = n[n.length - 1];
            return n && 'text' === n.type ? { raw: e[0], text: e[0] } : { type: 'text', raw: e[0], text: e[0] };
          }
        }),
        (e.prototype.escape = function (e) {
          e = this.rules.inline.escape.exec(e);
          if (e) return { type: 'escape', raw: e[0], text: Je(e[1]) };
        }),
        (e.prototype.tag = function (e, n, i) {
          e = this.rules.inline.tag.exec(e);
          if (e)
            return (
              !n && /^<a /i.test(e[0]) ? (n = !0) : n && /^<\/a>/i.test(e[0]) && (n = !1),
              !i && /^<(pre|code|kbd|script)(\s|>)/i.test(e[0])
                ? (i = !0)
                : i && /^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0]) && (i = !1),
              {
        ...
        (e.prototype.link = function (e) {
          ...
          if (n) {
            ...
            if (!this.options.pedantic && /^</.test(e)) {
              ...
              if ((e.length - i.length) % 2 == 0) return;
            } else {
              var o = Ke(n[2], '()');
              -1 < o &&
                ((t = (0 === n[0].indexOf('!') ? 5 : 4) + n[1].length + o),
            ...
            return (
              ...
              en(
                ...
                {
                  href:
                    (i = /^</.test(i) ? (this.options.pedantic && !/>$/.test(e) ? i.slice(1) : i.slice(1, -1)) : i) &&
        ...
        (e.prototype.reflink = function (e, n) {
          if ((i = this.rules.inline.reflink.exec(e)) || (i = this.rules.inline.nolink.exec(e))) {
            ...
            if ((e = n[e.toLowerCase()]) && e.href) return en(i, e, i[0]);
            var i = i[0].charAt(0);
        ...
        (e.prototype.strong = function (e, n, i) {
          ...
          if (o && (!o[1] || (o[1] && ('' === i || this.rules.inline.punctuation.exec(i))))) {
            ...
            var t,
              a = '**' === o[0] ? this.rules.inline.strong.endAst : this.rules.inline.strong.endUnd;
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if ((t = this.rules.inline.strong.middle.exec(n.slice(0, o.index + 3))))
                return { type: 'strong', raw: e.slice(0, t[0].length), text: e.slice(2, t[0].length - 2) };
          }
        }),
        (e.prototype.em = function (e, n, i) {
          ...
          if (o && (!o[1] || (o[1] && ('' === i || this.rules.inline.punctuation.exec(i))))) {
            n = n.slice(-1 * e.length);
            var t,
              a = '*' === o[0] ? this.rules.inline.em.endAst : this.rules.inline.em.endUnd;
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if ((t = this.rules.inline.em.middle.exec(n.slice(0, o.index + 2))))
                return { type: 'em', raw: e.slice(0, t[0].length), text: e.slice(1, t[0].length - 1) };
          }
        }),
        (e.prototype.codespan = function (e) {
          ...
          if (n) {
            var i = n[2].replace(/\n/g, ' '),
              ...
              e = /^ /.test(i) && / $/.test(i);
            return (
              o && e && (i = i.substring(1, i.length - 1)), (i = Je(i, !0)), { type: 'codespan', raw: n[0], text: i }
            );
          }
        }),
        ...
        (e.prototype.autolink = function (e, n) {
          ...
          if (e) {
            var i,
              n = '@' === e[2] ? 'mailto:' + (i = Je(this.options.mangle ? n(e[1]) : e[1])) : (i = Je(e[1]));
        ...
        (e.prototype.url = function (e, n) {
          ...
          if ((i = this.rules.inline.url.exec(e))) {
            if ('@' === i[2]) t = 'mailto:' + (o = Je(this.options.mangle ? n(i[0]) : i[0]));
            else {
              for (; (a = i[0]), (i[0] = this.rules.inline._backpedal.exec(i[0])[0]), a !== i[0]; );
              (o = Je(i[0])), (t = 'www.' === i[1] ? 'http://' + o : o);
            }
            return { type: 'link', raw: i[0], text: o, href: t, tokens: [{ type: 'text', raw: o, text: o }] };
          }
        }),
            ...
            i = n
              ? this.options.sanitize
                ? this.options.sanitizer
                  ...
                  : Je(e[0])
                : e[0]
              : Je(this.options.smartypants ? i(e[0]) : e[0]);
            return { type: 'text', raw: e[0], text: i };
          }
        }),
        e
      );
  ...
  (Ne.def = Ve(Ne.def).replace('label', Ne._label).replace('title', Ne._title).getRegex()),
    ...
    (Ne.listItemStart = Ve(/^( *)(bull)/)
      .replace('bull', Ne.bullet)
      .getRegex()),
    (Ne.list = Ve(Ne.list)
      .replace(/bull/g, Ne.bullet)
      .replace('hr', '\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))')
      .replace('def', '\\n+(?=' + Ne.def.source + ')')
      .getRegex()),
    (Ne._tag =
    ...
    (Ne._comment = /<!--(?!-?>)[\s\S]*?(?:-->|$)/),
    (Ne.html = Ve(Ne.html, 'i')
      .replace('comment', Ne._comment)
      .replace('tag', Ne._tag)
      .replace('attribute', / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/)
      .getRegex()),
    (Ne.paragraph = Ve(Ne._paragraph)
      .replace('hr', Ne.hr)
    ...
    (Ne.gfm.nptable = Ve(Ne.gfm.nptable)
      .replace('hr', Ne.hr)
      .replace('heading', ' {0,3}#{1,6} ')
      .replace('blockquote', ' {0,3}>')
      .replace('code', ' {4}[^\\n]')
    ...
    (Ne.pedantic = De({}, Ne.normal, {
      ...
      heading: /^(#{1,6})(.*)(?:\n+|$)/,
      fences: Ze,
      paragraph: Ve(Ne.normal._paragraph)
        .replace('hr', Ne.hr)
        .replace('heading', ' *#{1,6} *[^\n]')
        .replace('lheading', Ne.lheading)
        .replace('blockquote', ' {0,3}>')
        .replace('|fences', '')
        .replace('|list', '')
        .replace('|html', '')
  ...
  (Ze.punctuation = Ve(Ze.punctuation)
    .replace(/punctuation/g, Ze._punctuation)
    .getRegex()),
    (Ze._blockSkip = '\\[[^\\]]*?\\]\\([^\\)]*?\\)|`[^`]*?`|<[^>]*?>'),
    (Ze._overlapSkip = '__[^_]*?__|\\*\\*\\[^\\*\\]*?\\*\\*'),
    (Ze._comment = Ve(Ne._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (Ze.em.start = Ve(Ze.em.start)
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    (Ze.em.middle = Ve(Ze.em.middle)
      .replace(/punctuation/g, Ze._punctuation)
      .replace(/overlapSkip/g, Ze._overlapSkip)
      .getRegex()),
    (Ze.em.endAst = Ve(Ze.em.endAst, 'g')
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    (Ze.em.endUnd = Ve(Ze.em.endUnd, 'g')
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    (Ze.strong.start = Ve(Ze.strong.start)
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    (Ze.strong.middle = Ve(Ze.strong.middle)
      .replace(/punctuation/g, Ze._punctuation)
      .replace(/overlapSkip/g, Ze._overlapSkip)
      .getRegex()),
    (Ze.strong.endAst = Ve(Ze.strong.endAst, 'g')
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    (Ze.strong.endUnd = Ve(Ze.strong.endUnd, 'g')
      .replace(/punctuation/g, Ze._punctuation)
      .getRegex()),
    ...
    (Ze.link = Ve(Ze.link)
      ...
      .replace('href', Ze._href)
      .replace('title', Ze._title)
      .getRegex()),
    (Ze.reflink = Ve(Ze.reflink).replace('label', Ze._label).getRegex()),
    (Ze.reflinkSearch = Ve(Ze.reflinkSearch, 'g')
      .replace('reflink', Ze.reflink)
      .replace('nolink', Ze.nolink)
      .getRegex()),
    (Ze.normal = De({}, Ze)),
  ...
  function un(e) {
    for (var n, i = '', o = e.length, t = 0; t < o; t++)
      (n = e.charCodeAt(t)), (i += '&#' + (n = 0.5 < Math.random() ? 'x' + n.toString(16) : n) + ';');
    return i;
  }
  var fn = (function () {
      function i(e) {
        ...
        e = { block: tn.normal, inline: an.normal };
        this.options.pedantic
          ? ((e.block = tn.pedantic), (e.inline = an.pedantic))
          : this.options.gfm &&
            ((e.block = tn.gfm), this.options.breaks ? (e.inline = an.breaks) : (e.inline = an.gfm)),
          (this.tokenizer.rules = e);
      }
      var e = { rules: { configurable: !0 } };
      return (
        (e.rules.get = function () {
          return { block: tn, inline: an };
        }),
        (i.lex = function (e, n) {
        ...
        (i.prototype.blockTokens = function (e, n, i) {
          var o, t, a, r;
          for (
            void 0 === n && (n = []), void 0 === i && (i = !0), this.options.pedantic && (e = e.replace(/^ +$/gm, ''));
            e;

          )
            if ((o = this.tokenizer.space(e))) (e = e.substring(o.raw.length)), o.type && n.push(o);
            else if ((o = this.tokenizer.code(e, n)))
              (e = e.substring(o.raw.length)),
                o.type ? n.push(o) : (((r = n[n.length - 1]).raw += '\n' + o.raw), (r.text += '\n' + o.text));
            else if ((o = this.tokenizer.fences(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if ((o = this.tokenizer.heading(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if ((o = this.tokenizer.nptable(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if ((o = this.tokenizer.hr(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if ((o = this.tokenizer.blockquote(e)))
              (e = e.substring(o.raw.length)), (o.tokens = this.blockTokens(o.text, [], i)), n.push(o);
            else if ((o = this.tokenizer.list(e))) {
              for (e = e.substring(o.raw.length), a = o.items.length, t = 0; t < a; t++)
                o.items[t].tokens = this.blockTokens(o.items[t].text, [], !1);
              n.push(o);
            } else if ((o = this.tokenizer.html(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if (i && (o = this.tokenizer.def(e)))
              (e = e.substring(o.raw.length)),
                this.tokens.links[o.tag] || (this.tokens.links[o.tag] = { href: o.href, title: o.title });
            else if ((o = this.tokenizer.table(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if ((o = this.tokenizer.lheading(e))) (e = e.substring(o.raw.length)), n.push(o);
            else if (i && (o = this.tokenizer.paragraph(e))) (e = e.substring(o.raw.length)), n.push(o);
          ...
          for (var n, i, o, t, a, r = e.length, c = 0; c < r; c++)
            switch ((a = e[c]).type) {
              ...
              case 'heading':
                ...
                break;
              case 'table':
                for (a.tokens = { header: [], cells: [] }, o = a.header.length, n = 0; n < o; n++)
                  (a.tokens.header[n] = []), this.inlineTokens(a.header[n], a.tokens.header[n]);
                for (o = a.cells.length, n = 0; n < o; n++)
                  for (t = a.cells[n], a.tokens.cells[n] = [], i = 0; i < t.length; i++)
                    (a.tokens.cells[n][i] = []), this.inlineTokens(t[i], a.tokens.cells[n][i]);
                break;
              case 'blockquote':
        ...
        (i.prototype.inlineTokens = function (e, n, i, o) {
          var t;
          void 0 === n && (n = []), void 0 === i && (i = !1), void 0 === o && (o = !1);
          var a,
            r,
            c,
            u = e;
          ...
          for (; e; )
            if ((r || (c = ''), (r = !1), (t = this.tokenizer.escape(e)))) (e = e.substring(t.raw.length)), n.push(t);
            else if ((t = this.tokenizer.tag(e, i, o)))
              (e = e.substring(t.raw.length)), (i = t.inLink), (o = t.inRawBlock), n.push(t);
              ...
              (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], i, o)), n.push(t);
              ...
              (e = e.substring(t.raw.length)), (t.tokens = this.inlineTokens(t.text, [], i, o)), n.push(t);
            else if ((t = this.tokenizer.autolink(e, un))) (e = e.substring(t.raw.length)), n.push(t);
            else if (i || !(t = this.tokenizer.url(e, un))) {
              if ((t = this.tokenizer.inlineText(e, o, cn)))
                (e = e.substring(t.raw.length)), (c = t.raw.slice(-1)), (r = !0), n.push(t);
              else if (e) {
    ...
    sn = (function () {
      ...
      return (
        (e.prototype.code = function (e, n, i) {
          var o = (n || '').match(/\S*/)[0];
          return (
            !this.options.highlight || (null != (n = this.options.highlight(e, o)) && n !== e && ((i = !0), (e = n))),
            (e = e.replace(/\n$/, '') + '\n'),
            o
              ? '<pre><code class="' +
        ...
        (e.prototype.heading = function (e, n, i, o) {
          return this.options.headerIds
            ? '<h' + n + ' id="' + this.options.headerPrefix + o.slug(i) + '">' + e + '</h' + n + '>\n'
            : '<h' + n + '>' + e + '</h' + n + '>\n';
        }),
        ...
        (e.prototype.link = function (e, n, i) {
          if (null === (e = dn(this.options.sanitize, this.options.baseUrl, e))) return i;
          e = '<a href="' + gn(e) + '"';
          return n && (e += ' title="' + n + '"'), (e += '>' + i + '</a>');
        }),
        (e.prototype.image = function (e, n, i) {
          if (null === (e = dn(this.options.sanitize, this.options.baseUrl, e))) return i;
          i = '<img src="' + e + '" alt="' + i + '"';
          return n && (i += ' title="' + n + '"'), (i += this.options.xhtml ? '/>' : '>');
        }),
    ...
    vn = (function () {
      ...
      return (
        ...
        (e.prototype.getNextSafeSlug = function (e, n) {
          var i = e,
            o = 0;
          if (this.seen.hasOwnProperty(i)) for (o = this.seen[e]; (i = e + '-' + ++o), this.seen.hasOwnProperty(i); );
          return n || ((this.seen[e] = o), (this.seen[i] = 0)), i;
        }),
            ...
            switch ((f = e[b]).type) {
              ...
              case 'heading':
                _ += this.renderer.heading(
                  ...
                  f.depth,
                  _n(this.parseInline(f.tokens, this.textRenderer)),
                  this.slugger,
                );
                continue;
              case 'code':
                ...
                continue;
              case 'table':
                for (c = p = '', t = f.header.length, i = 0; i < t; i++)
                  c += this.renderer.tablecell(this.parseInline(f.tokens.header[i]), { header: !0, align: f.align[i] });
                for (p += this.renderer.tablerow(c), u = '', t = f.cells.length, i = 0; i < t; i++) {
                  for (c = '', a = (r = f.tokens.cells[i]).length, o = 0; o < a; o++)
                    c += this.renderer.tablecell(this.parseInline(r[o]), { header: !1, align: f.align[o] });
                  u += this.renderer.tablerow(c);
                }
                _ += this.renderer.table(p, u);
                continue;
              case 'blockquote':
                (u = this.parse(f.tokens)), (_ += this.renderer.blockquote(u));
                continue;
              case 'list':
                for (p = f.ordered, k = f.start, d = f.loose, t = f.items.length, u = '', i = 0; i < t; i++)
                  (l = (s = f.items[i]).checked),
                    (v = s.task),
                    (g = ''),
                    s.task &&
                      ((h = this.renderer.checkbox(l)),
                      d
                        ? 0 < s.tokens.length && 'text' === s.tokens[0].type
                          ? ((s.tokens[0].text = h + ' ' + s.tokens[0].text),
                            s.tokens[0].tokens &&
                              0 < s.tokens[0].tokens.length &&
                              'text' === s.tokens[0].tokens[0].type &&
                              (s.tokens[0].tokens[0].text = h + ' ' + s.tokens[0].tokens[0].text))
                          : s.tokens.unshift({ type: 'text', text: h })
                        : (g += h)),
          ...
          for (var i, o = '', t = e.length, a = 0; a < t; a++)
            switch ((i = e[a]).type) {
              ...
              default:
                ...
                if (this.options.silent) return void console.error(r);
                throw new Error(r);
            }
          return o;
        }),
  ...
  function xn(e, i, o) {
    ...
    if (('function' == typeof i && ((o = i), (i = null)), (i = bn({}, xn.defaults, i || {})), kn(i), o)) {
      var t,
        a = i.highlight;
      try {
        t = fn.lex(e, i);
      ...
      function r(n) {
        ...
        return (i.highlight = a), n ? o(n) : o(null, e);
      }
      if (!a || a.length < 3) return r();
      if ((delete i.highlight, !t.length)) return r();
      var c = 0;
      return (
        xn.walkTokens(t, function (i) {
          'code' === i.type &&
            (c++,
            setTimeout(function () {
              a(i.text, i.lang, function (e, n) {
                return e
                  ? r(e)
                  : (null != n && n !== i.text && ((i.text = n), (i.escaped = !0)), void (0 === --c && r()));
              });
            }, 0));
        }),
        void (0 === c && r())
    ...
    try {
      var n = fn.lex(e, i);
      return i.walkTokens && xn.walkTokens(n, i.walkTokens), mn.parse(n, i);
    } catch (e) {
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), i.silent))
        return '<p>An error occurred:</p><pre>' + wn(e.message + '', !0) + '</pre>';
      throw e;
    }
  }
  (xn.options = xn.setOptions = function (e) {
    return bn(xn.defaults, e), yn(xn.defaults), xn;
  }),
    (xn.getDefaults = Me),
    (xn.defaults = we),
    (xn.use = function (a) {
      ...
      if (a.tokenizer) {
        var t,
          c = xn.defaults.tokenizer || new nn();
      ...
      a.walkTokens &&
        ((n = xn.defaults.walkTokens),
        (e.walkTokens = function (e) {
          a.walkTokens(e), n && n(e);
        })),
        xn.setOptions(e);
    }),
    ...
    (xn.parseInline = function (e, n) {
      ...
      (n = bn({}, xn.defaults, n || {})), kn(n);
      try {
        var i = fn.lexInline(e, n);
        return n.walkTokens && xn.walkTokens(i, n.walkTokens), mn.parseInline(i, n);
      } catch (e) {
  ...
  var Sn = (xn.parse = xn);
  function An(e, i) {
    if ((void 0 === i && (i = '<ul class="app-sub-sidebar">{inner}</ul>'), !e || !e.length)) return '';
    var o = '';
    return (
      e.forEach(function (e) {
  ...
  function zn(e, o) {
    ...
    return (
      e.forEach(function (e) {
        var n = e.level || 1,
          i = n - 1;
        o < n || (a[i] ? (a[i].children = (a[i].children || []).concat(e)) : t.push(e), (a[n] = e));
      }),
      t
    );
  }
  ...
  function jn(e, t) {
    return e
      .replace(/<(code|pre|script|template)[^>]*?>[\s\S]+?<\/(code|pre|script|template)>/g, function (e) {
            ...
            ? e && /unicode/.test(n)
              ? '<span class="emoji">' +
                n
                  ...
                  .concat('&#xFE0E;') +
                '</span>'
              : '<img src="' + Cn.baseURL + n + '.png" alt="' + o + '" class="emoji" loading="lazy">'
            : i)
        );
        var i, o;
      })
    ...
    return {
      str: (e =
        ...
        e
          .replace(/^('|")/, '')
          .replace(/('|")$/, '')
          .replace(/(?:^|\s):([\w-]+:?)=?([\w-%]+)?/g, function (e, n, i) {
            return -1 === n.indexOf(':') ? ((o[n] = (i && i.replace(/&quot;/g, '')) || !0), '') : e;
          })
          .trim()),
      config: o,
    };
    ...
    Pn = be(function (e) {
      var u,
        ...
        g = (function (u) {
            ...
            R = {
              ...
              util: {
                ...
                clone: function i(e, o) {
                  var t, n;
                  switch (((o = o || {}), R.util.type(e))) {
                    case 'Object':
                      if (((n = R.util.objId(e)), o[n])) return o[n];
                      for (var a in ((t = {}), (o[n] = t), e)) e.hasOwnProperty(a) && (t[a] = i(e[a], o));
                      return t;
                    case 'Array':
                      return ((n = R.util.objId(e)), o[n])
                        ? o[n]
                        : ((t = []),
                          (o[n] = t),
                ...
                setLanguage: function (e, n) {
                  (e.className = e.className.replace(RegExp(i, 'gi'), '')), e.classList.add('language-' + n);
                },
                currentScript: function () {
                  ...
                  try {
                    ...
                    if (n) {
                      ...
                      for (i in o) if (o[i].src == n) return o[i];
                    }
                    return null;
                  }
                },
                ...
                insertBefore: function (i, e, n, o) {
                  ...
                  for (t in a)
                    if (a.hasOwnProperty(t)) {
                      if (t == e) for (var c in n) n.hasOwnProperty(c) && (r[c] = n[c]);
                ...
                DFS: function e(n, i, o, t) {
                  ...
                  for (a in n)
                    n.hasOwnProperty(a) &&
                      (i.call(n, a, n[a], o || a),
                      (r = n[a]),
                      'Object' !== (c = R.util.type(r)) || t[u(r)]
                        ? 'Array' !== c || t[u(r)] || ((t[u(r)] = !0), e(r, i, a, t))
                        : ((t[u(r)] = !0), e(r, i, null, t)));
                },
              },
              plugins: {},
              ...
              highlightAllUnder: function (e, n, i) {
                ...
                for (var t, a = 0; (t = o.elements[a++]); ) R.highlightElement(t, !0 === n, o.callback);
              },
              highlightElement: function (e, n, i) {
                ...
                var r = { element: e, language: o, grammar: t, code: e.textContent };
                function c(e) {
                  (r.highlightedCode = e),
                ...
                if (
                  (R.hooks.run('before-sanity-check', r),
                  (a = r.element.parentElement) &&
                    'pre' === a.nodeName.toLowerCase() &&
                    !a.hasAttribute('tabindex') &&
                    a.setAttribute('tabindex', '0'),
                  !r.code)
                )
                  return R.hooks.run('complete', r), void (i && i.call(r.element));
                  ...
                  r.grammar
                    ? n && u.Worker
                      ? (((n = new Worker(R.filename)).onmessage = function (e) {
                        ...
                        n.postMessage(JSON.stringify({ language: r.language, code: r.code, immediateClose: !0 })))
                      : c(R.highlight(r.code, r.grammar, r.language))
                    : c(R.util.encode(r.code));
              },
              highlight: function (e, n, i) {
                i = { code: e, grammar: n, language: i };
                    ...
                    for (var c in o)
                      if (o.hasOwnProperty(c) && o[c]) {
                        ...
                        for (var f = 0; f < u.length; ++f) {
                          ...
                          l &&
                            !d.pattern.global &&
                            ((p = d.pattern.toString().match(/[imsuy]*$/)[0]),
                            (d.pattern = RegExp(d.pattern.source, p + 'g')));
                          for (
                            var h = d.pattern || d, _ = t.next, m = a;
                            _ !== i.tail && !(r && m >= r.reach);
                            m += _.value.length, _ = _.next
                          ) {
                            var b = _.value;
                            ...
                            if (!(b instanceof T)) {
                              var k,
                                w = 1;
                              if (l) {
                                if (!(k = C(h, m, n, s)) || k.index >= n.length) break;
                                var y = k.index,
                                  x = k.index + k[0].length,
                                  S = m;
                                for (S += _.value.length; S <= y; ) (_ = _.next), (S += _.value.length);
                                if (((S -= _.value.length), (m = S), _.value instanceof T)) continue;
                                for (var A = _; A !== i.tail && (S < x || 'string' == typeof A.value); A = A.next)
                                  w++, (S += A.value.length);
                                w--, (b = n.slice(m, S)), (k.index -= m);
                              } else if (!(k = C(h, 0, b, s))) continue;
                              var y = k.index,
                                $ = k[0],
                                z = b.slice(0, y),
                                F = b.slice(y + $.length),
                              ...
                              b = _.prev;
                              z && ((b = j(i, b, z)), (m += z.length)), L(i, b, w);
              ...
              hooks: {
                ...
                run: function (e, n) {
                  var i = R.hooks.all[e];
                  if (i && i.length) for (var o, t = 0; (o = i[t++]); ) o(n);
                },
              },
              Token: T,
            };
          function T(e, n, i, o) {
            (this.type = e), (this.content = n), (this.alias = i), (this.length = 0 | (o || '').length);
          }
          function C(e, n, i, o) {
            e.lastIndex = n;
            i = e.exec(i);
            return i && o && i[1] && ((o = i[1].length), (i.index += o), (i[0] = i[0].slice(o))), i;
          }
          function a() {
          ...
          function j(e, n, i) {
            var o = n.next,
              i = { value: i, prev: n, next: o };
            return (n.next = i), (o.prev = i), e.length++, i;
          }
          function L(e, n, i) {
            for (var o = n.next, t = 0; t < i && o !== e.tail; t++) o = o.next;
            ((n.next = o).prev = n), (e.length -= t);
          }
          if (
            ((u.Prism = R),
            (T.stringify = function n(e, i) {
              ...
              var a,
                r = '';
              for (a in t.attributes) r += ' ' + a + '="' + (t.attributes[a] || '').replace(/"/g, '&quot;') + '"';
                  ...
                  u.addEventListener(
                    ...
                    function (e) {
                      var n = JSON.parse(e.data),
                        ...
                        e = n.code,
                        n = n.immediateClose;
                      u.postMessage(R.highlight(e, R.languages[i], i)), n && u.close();
                    },
                    !1,
                  )),
              R
          ...
          return (
            o && ((R.filename = o.src), o.hasAttribute('data-manual') && (R.manual = !0)),
            R.manual ||
              ('loading' === (e = document.readyState) || ('interactive' === e && o && o.defer)
      ...
      e.exports && (e.exports = g),
        ...
        Object.defineProperty(g.languages.markup.tag, 'addInlined', {
          value: function (e, n) {
            ...
            (i['language-' + n] = {
              ...
              (i.cdata = /^<!\[CDATA\[|\]\]>$/i);
            i = { 'included-cdata': { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: i } };
            i['language-' + n] = { pattern: /[\s\S]+/, inside: g.languages[n] };
            n = {};
            (n[e] = {
              pattern: RegExp(
        ...
        (function (e) {
          ...
          (e.languages.css = {
            ...
            atrule: {
              pattern: RegExp(
                '@[\\w-](?:' + /[^;{\s"']|\s+(?!\s)/.source + '|' + n.source + ')*?' + /(?:;|(?=\s*\{))/.source,
              ),
              inside: {
                rule: /^@[\w-]+/,
        ...
        void 0 !== g &&
          ...
          (d =
            'pre[data-src]:not([' + (f = 'data-src-status') + '="loaded"]):not([' + f + '="' + (p = 'loading') + '"])'),
          ...
          g.hooks.add('before-sanity-check', function (e) {
            ...
            c.matches(d) &&
              ...
              'none' === (e = e.language) && ((n = (/\.(\w+)$/.exec(i) || [, 'none'])[1]), (e = u[n] || n)),
              ...
              (a = function (e) {
                c.setAttribute(f, 'failed'), (t.textContent = e);
              }),
          ...
          (n = !(g.plugins.fileHighlight = {
            highlight: function (e) {
              for (var n, i = (e || document).querySelectorAll(d), o = 0; (n = i[o++]); ) g.highlightElement(n);
            },
          })),
        ...
        value: function (o, t, e, a) {
          ...
          o.language === t &&
            ...
            (o.code = o.code.replace(e, function (e) {
              ...
              for (var n, i = r.length; -1 !== o.code.indexOf((n = Mn(t, i))); ) ++i;
              return (r[i] = e), n;
            })),
            ...
            (function e(n) {
              for (var i = 0; i < n.length && !(d >= g.length); i++) {
                var o,
                  ...
                  c,
                  u = n[i];
                'string' == typeof u || (u.content && 'string' == typeof u.content)
                  ? ((t = g[d]),
                    (a = f.tokenStack[t]),
                    ...
                    -1 < (r = o.indexOf(c)) &&
                      ...
                      'string' == typeof u ? n.splice.apply(n, [i, 1].concat(c)) : (u.content = c)))
                  : u.content && e(u.content);
              }
              return n;
            })(f.tokens));
        },
  ...
  function In(t, e) {
    ...
    var r = o((e = t.markdown || {})) ? e(Sn, n) : (Sn.setOptions(m(e, { renderer: m(n, e.renderer) })), Sn);
    (this._marked = r),
      (this.compile = function (i) {
        var o = !0,
          e = c(function (e) {
            o = !1;
            var n = '';
            return i && ((n = f(i) ? r(i) : r.parser(i)), (n = t.noEmoji ? n : jn(n, t.nativeEmoji)), Tn.clear(), n);
          })(i),
          n = a.router.parse().file;
        return o ? (a.toc = a.cacheTOC[n]) : (a.cacheTOC[n] = [].concat(a.toc)), e;
      });
  }
  var Nn = {},
    Hn = {
      ...
      iframe: function (e, n) {
        return { html: '<iframe src="' + e + '" ' + (n || 'width=100% height=400') + '></iframe>' };
      },
      video: function (e, n) {
        return { html: '<video src="' + e + '" ' + (n || 'controls') + '>Not Support</video>' };
      },
      audio: function (e, n) {
        return { html: '<audio src="' + e + '" ' + (n || 'controls') + '>Not Support</audio>' };
      },
      code: function (e, n) {
        var i = e.match(/\.(\w+)$/);
        return { url: e, lang: (i = 'md' === (i = n || (i && i[1])) ? 'markdown' : i) };
      },
    };
  (In.prototype.compileEmbed = function (e, n) {
    ...
    if (((n = a), t.include))
      return (
        R(e) || (e = q(this.contentBase, C(this.router.getCurrentPath()), e)),
        t.type && (o = Hn[t.type])
          ? ((i = o.call(this, e, n)).type = t.type)
          : ((o = 'code'),
            /\.(md|markdown)/.test(e)
              ? (o = 'markdown')
              : /\.mmd/.test(e)
    ...
    (In.prototype._matchNotCompileLink = function (e) {
      for (var n = this.config.noCompileLinks || [], i = 0; i < n.length; i++) {
        var o = n[i];
        if ((Nn[o] || (Nn[o] = new RegExp('^' + o + '$'))).test(e)) return e;
      }
    }),
    (In.prototype._initRenderer = function () {
      var r,
        ...
        t = {};
      return (
        (t.heading = e.heading = function (e, n) {
          var i = Ln(e),
            o = i.str,
            t = i.config,
            e = { level: n, title: On(o) };
          /<!-- {docsify-ignore} -->/g.test(o) &&
            ((o = o.replace('\x3c!-- {docsify-ignore} --\x3e', '')), (e.title = On(o)), (e.ignoreSubHeading = !0)),
            /{docsify-ignore}/g.test(o) &&
              ((o = o.replace('{docsify-ignore}', '')), (e.title = On(o)), (e.ignoreSubHeading = !0)),
            /<!-- {docsify-ignore-all} -->/g.test(o) &&
              ((o = o.replace('\x3c!-- {docsify-ignore-all} --\x3e', '')), (e.title = On(o)), (e.ignoreAllSubs = !0)),
            /{docsify-ignore-all}/g.test(o) &&
              ((o = o.replace('{docsify-ignore-all}', '')), (e.title = On(o)), (e.ignoreAllSubs = !0));
          (i = Tn(t.id || o)), (t = a.toURL(a.getCurrentPath(), { id: i }));
          return (
            (e.slug = t),
            g.toc.push(e),
            '<h' +
        ...
        (t.code = { renderer: e }.renderer.code = function (e, n) {
        ...
        (t.link =
          ((i = (n = { renderer: e, router: a, linkTarget: n, linkRel: i, compilerClass: g }).renderer),
          (c = n.router),
          (u = n.linkTarget),
          n.linkRel,
          (f = n.compilerClass),
          (i.link = function (e, n, i) {
            ...
            return (
              ...
              (n = a),
              R(e) || f._matchNotCompileLink(e) || t.ignore
                ? (R(e) ||
                    './' !== e.slice(0, 2) ||
                    (e = document.URL.replace(/\/(?!.*\/).*/, '/').replace('#/./', '') + e),
                  o.push(0 === e.indexOf('mailto:') ? '' : 'target="' + u + '"'),
                  o.push(0 !== e.indexOf('mailto:') && '' !== r ? ' rel="' + r + '"' : ''))
                : (e === f.config.homepage && (e = 'README'), (e = c.toURL(e, null, c.getCurrentPath()))),
              t.disabled && (o.push('disabled'), (e = 'javascript:void(0)')),
        ...
        (t.paragraph = { renderer: e }.renderer.paragraph = function (e) {
          e = /^!&gt;/.test(e) ? $n('tip', e) : /^\?&gt;/.test(e) ? $n('warn', e) : '<p>' + e + '</p>';
          return e;
        }),
        (t.image =
          ((o = (i = { renderer: e, contentBase: o, router: a }).renderer),
          (p = i.contentBase),
          (d = i.router),
          (o.image = function (e, n, i) {
            ...
            return (
              ...
              n && t.push('title="' + n + '"'),
              a.size &&
                ((n = (r = a.size.split('x'))[0]),
                (r = r[1]) ? t.push('width="' + n + '" height="' + r + '"') : t.push('width="' + n + '"')),
              a.class && t.push('class="' + a.class + '"'),
              a.id && t.push('id="' + a.id + '"'),
              R(e) || (o = q(p, C(d.getCurrentPath()), e)),
              0 < t.length
                ? '<img src="' + o + '" data-origin="' + e + '" alt="' + i + '" ' + t.join(' ') + ' />'
                : '<img src="' + o + '" data-origin="' + e + '" alt="' + i + '"' + t + '>'
            );
          }))),
        (t.list = { renderer: e }.renderer.list = function (e, n, i) {
          n = n ? 'ol' : 'ul';
          return (
            '<' +
            n +
        ...
        (t.listitem = { renderer: e }.renderer.listitem = function (e) {
    ...
    (In.prototype.sidebar = function (e, n) {
      var i = this.toc,
        ...
        t = '';
      if (e) t = this.compile(e);
      else {
        for (var a = 0; a < i.length; a++)
          if (i[a].ignoreSubHeading) {
            var r = i[a].level;
            i.splice(a, 1);
            for (var c = a; c < i.length && r < i[c].level; c++) i.splice(c, 1) && c-- && a++;
            a--;
          }
        (n = this.cacheTree[o] || zn(i, n)), (t = An(n, '<ul>{inner}</ul>'));
        this.cacheTree[o] = n;
      }
      return t;
    }),
    (In.prototype.subSidebar = function (e) {
      if (e) {
        var n = this.router.getCurrentPath(),
          i = this.cacheTree,
          o = this.toc;
        o[0] && o[0].ignoreAllSubs && o.splice(0), o[0] && 1 === o[0].level && o.shift();
        for (var t = 0; t < o.length; t++) o[t].ignoreSubHeading && o.splice(t, 1) && t--;
        e = i[n] || zn(o, e);
        return (i[n] = e), (this.toc = []), An(e);
      }
      this.toc = [];
    }),
    ...
    (In.prototype.cover = function (e) {
      var n = this.toc.slice(),
        e = this.compile(e);
      return (this.toc = n.slice()), e;
    });
  function Dn(e) {
    var n = Zn(e);
    return 0 === n ? e : ((n = new RegExp('^[ \\t]{' + n + '}', 'gm')), e.replace(n, ''));
  }
  var Un,
    Zn = function (e) {
      e = e.match(/^[ \t]*(?=\S)/gm);
  ...
  function Vn(e, o) {
    ...
    r.forEach(function (e, t) {
      'paragraph' === e.type &&
        (e.text = e.text.replace(new RegExp(u.source, 'g'), function (e, n, i, o) {
          o = a.compileEmbed(i, o);
          return o && c.push({ index: t, embed: o }), e;
        }));
    });
    var p = [];
    !(function (e, a) {
      ...
      for (; (n = i[c++]); ) {
        var o = (function (t) {
          return function (e) {
            var n, i, o;
            e &&
              ('markdown' === t.embed.type
                ? ((i = t.embed.url.split('/')).pop(),
                  (i = i.join('/')),
                ...
                : 'mermaid' === t.embed.type
                ? ((n = [{ type: 'html', text: '<div class="mermaid">\n' + e + '\n</div>' }]).links = {})
                : ((n = [{ type: 'html', text: e }]).links = {})),
              a({ token: t, embedToken: n }),
              ++u >= c && a({});
          };
        })(n);
        n.embed.url ? X(n.embed.url).then(o) : o(n.embed.html);
      }
    })({ compile: i, embedTokens: c, fetch: n }, function (e) {
      var n,
        i = e.embedToken,
        e = e.token;
      e
        ? ((n = e.index),
          ...
          p.push({ start: n, length: i.length - 1 }))
        : ((Bn[t] = r.concat()), (r.links = Bn[t].links = f), o(r));
    });
  }
  function Yn(e, n, i) {
    var o, t, a, r;
  ...
  function Gn(e) {
    ...
    if (
      ...
      (i.executeScript || ('Vue' in window && !1 !== i.executeScript)) &&
        ...
        (i.vueGlobalOptions || d.length) &&
          ...
          p.push.apply(
            ...
            k('.markdown-section > *')
              ...
              .filter(function (e) {
                return (
                  e.tagName.toLowerCase() in (i.vueComponents || {}) ||
                  e.querySelector(d.join(',') || null) ||
                  u.test(e.outerHTML) ||
                  f.test(e.outerHTML)
                );
              })
      ...
      for (var g = 0, s = p; g < s.length; g += 1) {
        var l,
          ...
          _ = v[1],
          v = 'data-isvue';
        h.matches('pre, script') ||
          n(h) ||
          h.querySelector('[' + v + ']') ||
          (h.setAttribute(v, ''),
          2 === t
            ? ((_.el = void 0), new window.Vue(_).$mount(h))
            : 3 === t &&
              ((l = window.Vue.createApp(_)),
              d.forEach(function (e) {
  ...
  function Wn(n, i, o, t, a, e) {
    (n = e ? n : n.replace(/\/$/, '')),
      (n = C(n)) &&
        X(a.router.getFile(n + o) + i, !1, a.config.requestHeaders).then(t, function (e) {
          return Wn(n, i, o, t, a);
        });
  }
  function Xn() {
  ...
  var Qn,
    Jn = (function (e) {
        ...
        (((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype.initPlugin = function () {
          ...
          [].concat(this.config.plugins).forEach(function (e) {
            try {
              ...
              if (!n.config.catchPluginErrors) throw e;
      ...
      (function (e) {
        ...
        return (
          e && (n.__proto__ = e),
          (((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype._loadSideAndNav = function (
            e,
            n,
            i,
            o,
          ...
          (n.prototype._fetch = function (i) {
            ...
            g(p)
              ...
              : ((t = E(f, ['id'])),
                ...
                this.isRemoteUrl
                  ? Kn(r + t, 0, n).then(c, u)
                  : this.matchVirtualRoute(p).then(function (e) {
          ...
          (n.prototype._fetchCover = function () {
            ...
            if (i) {
              ...
              'string' == typeof i
                ? '/' === e && (r = i)
                : (r = Array.isArray(i) ? -1 < i.indexOf(e) && '_coverpage' : !0 === (e = i[e]) ? '_coverpage' : e);
              var c = Boolean(r) && this.config.onlyCover;
              return (
                r
                  ? ((r = this.router.getFile(a + r)),
          ...
          (n.prototype.$fetch = function (e, n) {
            var i = this;
            void 0 === e && (e = d), void 0 === n && (n = this.$resetEvents.bind(this));
            function o() {
              i.callHook('doneEach'), e();
            }
            this._fetchCover()
              ? o()
          ...
          (n.prototype._fetch404 = function (e, n, i) {
            ...
            if (t) {
              ...
              return (
                Kn(this.router.getFile(e), 0, r).then(
                  function (e, n) {
            ...
            return this._renderMain(null, {}, c), !1;
          }),
          (n.prototype.initFetch = function () {
            var e,
              n = this,
              i = this.config.loadSidebar;
            this.rendered
              ? ((e = ee(this.router, '.sidebar-nav', !0, !0)),
        ...
        (function (e) {
          ...
          return (
            ...
            (((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype.$resetEvents = function (e) {
              ...
              'history' !== e &&
                (n.route.query.id && he(n.route.path, n.route.query.id),
                'navigate' === e && i && ((i = i), (_e.scrollTop = !0 === (i = void 0 === i ? 0 : i) ? 0 : Number(i)))),
          ...
          (function (e) {
            ...
            return (
              e && (n.__proto__ = e),
              (((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype._renderTo = function (
                e,
                n,
                i,
              ) {
              ...
              (n.prototype._renderSidebar = function (e) {
                ...
                if (n.hideSidebar)
                  return (
                    [document.querySelector('aside.sidebar'), document.querySelector('button.sidebar-toggle')]
                      .filter(function (e) {
                        return !!e;
                      })
                      .forEach(function (e) {
              ...
              (n.prototype._bindEventOnRendered = function (e) {
                var n,
                  i = this.config.autoHeader;
                !(function (e) {
                  var n = b('.cover.show');
                  se = n ? n.offsetHeight : 0;
                  for (
                    var i, n = l('.sidebar'), o = [], t = 0, a = (o = null != n ? k(n, 'li') : o).length;
                    t < a;
                    t += 1
                  ) {
                    var r,
                      ...
                      f = u.querySelector('a');
                    f &&
                      ('/' !== (r = f.getAttribute('href')) &&
                        ((f = (c = e.parse(r)).query.id), (c = c.path), f && (r = ve(c, f))),
                      r && (fe[decodeURIComponent(r)] = u));
                  }
                  s ||
                    ((i = T(e.getCurrentPath())),
                    x('scroll', function () {
                      return le(i);
                    }),
                    p('scroll', function () {
                  ...
                  i &&
                    e &&
                    (i = (n = l('#main')).children[0]) &&
                    'H1' !== i.tagName &&
                    y(n, w('div', this.compiler.header(e.innerText, 1)).children[0]);
              }),
              (n.prototype._renderNav = function (e) {
                e && this._renderTo('nav', this.compiler.compile(e)), this.config.loadNavbar && ee(this.router, 'nav');
              }),
              (n.prototype._renderMain = function (o, t, a) {
                var r = this;
                if ((void 0 === t && (t = {}), !o)) return Gn.call(this, o);
                this.callHook('beforeEach', o, function (e) {
                  ...
                  r.isHTML
                    ? ((i = r.result = o), n())
                    : Vn({ compiler: r.compiler, raw: e }, function (e) {
                        (i = r.compiler.compile(e)), n();
                      });
                });
              }),
              (n.prototype._renderCover = function (e, n) {
                ...
                S(l('main'), n ? 'add' : 'remove', 'hidden'),
                  e
                    ? (S(o, 'add', 'show'),
                      (n = (i = this.coverIsHTML ? e : this.compiler.cover(e))
                        .trim()
                        .match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$')) &&
                        ('color' === n[2]
                          ? (o.style.background = n[1] + (n[3] || ''))
                          : ((e = n[1]),
                            S(o, 'add', 'has-mask'),
              ...
              (n.prototype.initRender = function () {
                var e = this.config;
                (this.compiler = new In(e, this.router)), (window.__current_docsify_compiler__ = this.compiler);
                var n,
                  i,
                  o,
                  t,
                ...
                u
                  ? (e.repo &&
                      (f +=
                        ...
                        t
                          ? '<a href="' +
                            (t = (t = !/\/\//.test(t) ? 'https://github.com/' + t : t).replace(/^git\+/, '')) +
                            '" target="' +
                            (r = r || '_blank') +
                    ...
                    this._renderTo(u, f, !0))
                  : (this.rendered = !0),
                  e.mergeNavbar && s
                    ? (p = b('.sidebar'))
                    : (c.classList.add('app-nav'), e.repo || c.classList.add('no-badge')),
                  e.loadNavbar && y(p, c),
                  e.themeColor &&
                    (v.head.appendChild(
                      w('div', '<style>:root{--theme-color: ' + e.themeColor + ';}</style>').firstElementChild,
                    ),
                    (a = e.themeColor),
            ...
            (function (e) {
              ...
              return (
                ...
                (n.prototype.matchVirtualRoute = function (t) {
                  ...
                  function u() {
                    var e = r.shift();
                    if (!e) return c(null);
                    var n = A((o = ((i = '^'), 0 === (o = e).indexOf(i) ? o : '^' + o)), '$') ? o : o + '$',
                      i = t.match(n);
                    if (!i) return u();
                    var o = a[e];
                    if ('string' == typeof o) return c(o);
              ...
              (function (i) {
                function e() {
                  for (var e = [], n = arguments.length; n--; ) e[n] = arguments[n];
                  i.apply(this, e), (this.route = {});
                }
                return (
                  i && (e.__proto__ = i),
                  (((e.prototype = Object.create(
                    i && i.prototype,
                  )).constructor = e).prototype.updateRender = function () {
                    ...
                    (this.router = e),
                      ...
                      e.onchange(function (e) {
                        n.updateRender(),
                          n._updateRender(),
                          U.path !== n.route.path
                            ? (n.$fetch(d, n.$resetEvents.bind(n, e.source)), (U = n.route))
                            : n.$resetEvents(e.source);
                      });
                  }),
                  e
                );
                ...
                (function (e) {
                  ...
                  return (
                    ...
                    (((n.prototype = Object.create(
                      e && e.prototype,
                    )).constructor = n).prototype.initLifecycle = function () {
                      var i = this;
                      (this._hooks = {}),
                        (this._lifecycle = {}),
                          ...
                          if (n >= r.length) a(t);
                            ...
                            if (2 === e.length)
                              try {
                                ...
                                if (!c) throw e;
                                console.error(i, e), u(n + 1);
                              }
                            else
                              try {
                                var o = e(t);
                                (t = void 0 === o ? t : o), u(n + 1);
                              } catch (e) {
                                if (!c) throw e;
                                console.error(i, e), u(n + 1);
                              }
  ...
  function Kn(e, n, i) {
    return Qn && Qn.abort && Qn.abort(), (Qn = X(e, !0, i));
  }
  (window.Docsify = { util: Me, dom: n, get: X, slugify: Tn, version: '4.13.1' }),
