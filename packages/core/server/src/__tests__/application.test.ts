...
describe('application', () => {
  ...
  describe('serving', () => {
    ...
    it('configure as default (empty)', () => {
      expect(Application.serving()).toBe(true);
      expect(Application.serving('a')).toBe(true);
    });
    ...
    it('configure as dispatcher only', () => {
      ...
      expect(Application.serving()).toBe(true);
      expect(Application.serving('a')).toBe(false);
    });
    ...
    it('configure as multiple services', () => {
      ...
      expect(Application.serving()).toBe(false);
      expect(Application.serving('a')).toBe(true);
      expect(Application.serving('b')).toBe(true);
      expect(Application.serving('c')).toBe(false);
    });
    ...
    it('configure as any services', () => {
      ...
      expect(Application.serving('a')).toBe(true);
      expect(Application.serving('b')).toBe(true);
      expect(Application.serving('c')).toBe(true);
    });
    ...
    it('configure as dispatcher and specific services', () => {
      ...
      expect(Application.serving()).toBe(true);
      expect(Application.serving('a')).toBe(true);
      expect(Application.serving('b')).toBe(false);
    });
