...
export const JS_TEMPLATE_BLOCK_FULL_SOURCE_FIELD = JS_BLOCK_LIGHT_EXTENSION_FULL_SOURCE_FIELD;
export const JS_TEMPLATE_BLOCK_SETTINGS_STEP_FIELD = JS_BLOCK_LIGHT_EXTENSION_SETTINGS_STEP_FIELD;
