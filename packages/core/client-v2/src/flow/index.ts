...
import { ensureMarkdownRegistry } from './common/Markdown/Markdown';
...
> {
  async load() {
    ...
    ensureMarkdownRegistry(this.flowEngine.context);
...
export { ensureMarkdownRegistry, MarkdownRegistry } from './common/Markdown/Markdown';
