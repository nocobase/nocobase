...
export const CodeEditor: React.FC<CodeEditorProps> = ({
  ...
  const editorExtensionPayload = useMemo(
    () => ({
      editorUid,
      name,
      scene: resolvedScene,
  ...
  useEffect(() => {
    CodeEditorExtension.notifyMount(editorExtensionPayload);
    return () => {
      CodeEditorExtension.notifyUnmount(editorExtensionPayload);
    };
  }, [editorExtensionPayload]);

  useEffect(() => {
    CodeEditorExtension.notifyUpdate(editorExtensionPayload);
  }, [editorExtensionPayload]);
