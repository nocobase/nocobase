...
describe('parse date', () => {
  ...
  it('should parse year', async () => {
    ...
    expectDate('2023', {
      timezone: '+08:00',
    }).toEqual(['2022-12-31T16:00:00.000Z', '2023-12-31T16:00:00.000Z']);
  });
  it('should parse quarter', async () => {
    ...
    expectDate('2023Q1', {
      timezone: '+08:00',
    }).toEqual(['2022-12-31T16:00:00.000Z', '2023-03-31T16:00:00.000Z']);
    expectDate('2023Q2', {
      timezone: '+08:00',
    }).toEqual(['2023-03-31T16:00:00.000Z', '2023-06-30T16:00:00.000Z']);
  });
  it('should parse iso week', async () => {
    ...
    expectDate('2023W01', {
      timezone: '+08:00',
    }).toEqual(['2023-01-01T16:00:00.000Z', '2023-01-08T16:00:00.000Z']);
  });
  it('should parse week', async () => {
    ...
    expectDate('2023w01', {
      timezone: '+08:00',
    }).toEqual(['2022-12-31T16:00:00.000Z', '2023-01-07T16:00:00.000Z']);
  });
  it('should parse month', () => {
    ...
    expectDate('2023-03', {
      timezone: '+08:00',
    }).toEqual(['2023-02-28T16:00:00.000Z', '2023-03-31T16:00:00.000Z']);
  });
  it('should parse day', () => {
    ...
    expectDate('2023-01-12', {
      timezone: '+08:00',
    }).toEqual(['2023-01-11T16:00:00.000Z', '2023-01-12T16:00:00.000Z']);
  });
  it('should parse hour', () => {
    ...
    expectDate('2023-01-12T12', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:00:00.000Z', '2023-01-12T05:00:00.000Z']);
  ...
  it('should parse minute', () => {
    ...
    expectDate('2023-01-12T12:23', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:23:00.000Z', '2023-01-12T04:24:00.000Z']);
  ...
  it('should parse second', () => {
    ...
    expectDate('2023-01-12T12:23:59', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:23:59.000Z', '2023-01-12T04:24:00.000Z']);
    ...
    expectDate('2023-01-12 12:23:59', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:23:59.000Z', '2023-01-12T04:24:00.000Z']);
  });
  it('should parse millisecond', () => {
    ...
    expectDate('2023-01-12T12:23:59.326', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:23:59.326Z', '2023-01-12T04:23:59.327Z']);
    ...
    expectDate('2023-01-12 12:23:59.326', {
      timezone: '+08:00',
    }).toEqual(['2023-01-12T04:23:59.326Z', '2023-01-12T04:23:59.327Z']);
  });
  it('should parse utc', () => {
    ...
    expectDate('2023-01-12T12:23:59.326Z', {
      timezone: '+08:00',
    }).toEqual('2023-01-12T12:23:59.326Z');
  });
