import { parseDate, parseDateBetween } from '../parse-date';

describe('parse date', () => {
  const expectDate = (date: string, options?: any) => {
...
describe('parse date between', () => {
  const expectDateBetween = (date: any, options?: any) => {
    const r = parseDateBetween(date, options);
    console.log(date, r);
    return expect(r);
  };

  it('should parse year', async () => {
    expectDateBetween('[2023,2024]').toEqual(['2023-01-01T00:00:00.000Z', '2025-01-01T00:00:00.000Z']);
    expectDateBetween('(2023,2024]').toEqual(['2024-01-01T00:00:00.000Z', '2025-01-01T00:00:00.000Z']);
    expectDateBetween('[2023,2024)').toEqual(['2023-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z']);
    expectDateBetween('(2023,2026)').toEqual(['2024-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z']);
    expectDateBetween(['2023', '2024']).toEqual(['2023-01-01T00:00:00.000Z', '2025-01-01T00:00:00.000Z']);
    expectDateBetween(['2023', '2024', '[]']).toEqual(['2023-01-01T00:00:00.000Z', '2025-01-01T00:00:00.000Z']);
    expectDateBetween(['2023', '2024', '(]']).toEqual(['2024-01-01T00:00:00.000Z', '2025-01-01T00:00:00.000Z']);
    expectDateBetween(['2023', '2024', '[)']).toEqual(['2023-01-01T00:00:00.000Z', '2024-01-01T00:00:00.000Z']);
    expectDateBetween(['2023', '2026', '()']).toEqual(['2024-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z']);
    expectDateBetween('[2023,2024]+08:00').toEqual(['2022-12-31T16:00:00.000Z', '2024-12-31T16:00:00.000Z']);
    expectDateBetween('(2023,2024]+08:00').toEqual(['2023-12-31T16:00:00.000Z', '2024-12-31T16:00:00.000Z']);
    expectDateBetween('[2023,2024)+08:00').toEqual(['2022-12-31T16:00:00.000Z', '2023-12-31T16:00:00.000Z']);
    expectDateBetween('(2023,2026)+08:00').toEqual(['2023-12-31T16:00:00.000Z', '2025-12-31T16:00:00.000Z']);
    expectDateBetween(['2023', '2024', '[]', '+08:00']).toEqual([
    ...
    expectDateBetween(['2023', '2026', '()', '+08:00']).toEqual([
      '2023-12-31T16:00:00.000Z',
  ...
  it('should parse day', async () => {
    expectDateBetween('[2023-01-12,2023-09-12]').toEqual(['2023-01-12T00:00:00.000Z', '2023-09-13T00:00:00.000Z']);
    expectDateBetween('[2023-01-12,2023-09-12)').toEqual(['2023-01-12T00:00:00.000Z', '2023-09-12T00:00:00.000Z']);
    expectDateBetween('(2023-01-12,2023-09-12]').toEqual(['2023-01-13T00:00:00.000Z', '2023-09-13T00:00:00.000Z']);
    expectDateBetween('(2023-01-12,2023-09-12)').toEqual(['2023-01-13T00:00:00.000Z', '2023-09-12T00:00:00.000Z']);
    expectDateBetween('[2023-01-12,2023-09-12]+08:00').toEqual([
      '2023-01-11T16:00:00.000Z',
      '2023-09-12T16:00:00.000Z',
    ]);
    expectDateBetween('[2023-01-12,2023-09-12)+08:00').toEqual([
      '2023-01-11T16:00:00.000Z',
      '2023-09-11T16:00:00.000Z',
    ]);
    expectDateBetween('(2023-01-12,2023-09-12]+08:00').toEqual([
      '2023-01-12T16:00:00.000Z',
      '2023-09-12T16:00:00.000Z',
    ]);
    expectDateBetween('(2023-01-12,2023-09-12)+08:00').toEqual([
      '2023-01-12T16:00:00.000Z',
