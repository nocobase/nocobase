export default {
    ...
    "Meet <1><0>All</0><1>Any</1></1> conditions in the group": "Cumplir <1><0>Todas</0><1>Cualquier</1></1> condición del grupo",
    ...
    "{{count}} more items": "{{count}} elementos más",
    ...
    "Next week": "Próximo semana",
    "Last month": "Mes pasado",
    "Next month": "Próximo mes",
    "Last quarter": "cuarto pasado",
    "This quarter": "Este cuarto",
    "Next quarter": "Próximo cuarto",
    ...
    "Logo": "Logo",
    "Add menu item": "Añadir elemento del menú",
    "Page": "Página",
    "Name": "Nombre",
    "Icon": "Icono",
    "Group": "Grupo",
    ...
    "Move to": "Mover a",
    "Insert left": "Insertar izquierda",
    "Insert right": "Insertar derecha",
    "Insert inner": "Insertar interior",
    "Delete": "Borrar",
    "UI editor": "IU editor",
    "Collection": "Colección",
    "Collections & Fields": "Colecciones & Campos",
    ...
    "Custom field display name": "Personalizar nombre para mostrar de campo",
    ...
    "Inherits": "Hereda",
    "Generate ID field automatically": "Generar campo ID automáticamente",
    ...
    "Source collections": "Fuente colecciones",
    ...
    "Source collection": "Colección fuente",
    "Source key": "Clave de origen",
    "Target collection": "Recogida de destino",
    ...
    "Many to one description": "Se utiliza para crear relaciones de uno a varios. Por ejemplo, una ciudad puede pertenecer a un solo país y un país puede tener muchas ciudades. Cuando está presente como campo, es una selección desplegable que se utiliza para seleccionar un registro de la colección asociada. Una vez creado, se genera automáticamente un campo uno a varios en la colección asociada",
    ...
    "Toggles the subfield mode": "Conmuta el modo de subcampo",
    ...
    "Custom name": "Nombre customizado",
    ...
    "Start date field": "Campo de fecha de comienzo",
    ...
    "Convert reference to duplicate": "Convertir referencia en duplicado",
    ...
    "Middle": "Medio",
    "Large": "Grande",
    "Menu item title": "Título del elemento de menú",
    "Menu item icon": "Icono del elemento de menú",
    "Target": "Objetivo",
    "Position": "Posición",
    ...
    "Custom column title": "Título customizado de la columna",
    ...
    "Leave it blank, unless you need a custom intermediate table": "Déjelo en blanco, a menos que necesite una tabla intermedia customizada",
    "Fields": "Campos",
    ...
    "Single select and radio fields can be used as the grouping field": "Los campos de selección única y radio se pueden utilizar como campo de agrupación",
    ...
    "Inverse field display name": "Nombre de mostrado del campo inverso",
