export default {
  ...
  "This is likely a NocoBase internals bug. Please open an issue at <0>here</0>": "Это, вероятно, ошибка внутреннего устройства NocoBase. Пожалуйста, откройте проблему <0>здесь</0>",
