export default {
  ...
  "Excel Function": "Excel Functions",
  "Excel description": "Compute a value based on the other fields using Excel functions",
  "Input @ to open field variables.": "Input @ to open field variables.",
  "Choices": "Choices",
  "Checkbox": "Checkbox",
