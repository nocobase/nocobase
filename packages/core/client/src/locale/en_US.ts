export default {
  ...
  "Upgrade": "Upgrade",
  "Dependencies check failed": "Dependencies check failed",
  ...
  "If the compatibility check fails, you should change the dependent version to meet the version requirements.": "If the compatibility check fails, you should change the dependent version to meet the version requirements.",
