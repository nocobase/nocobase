export default {
  ...
  'Request API URL': 'Request URL',
  'Request API method': 'Request method',
  'Request API parameters': 'Request query parameters(JSON)',
  'Request API headers': 'Request headers(JSON)',
  'Request API body': 'Request body(JSON)',
