export default {
  ...
  'Drag and drop the file here or click to upload, file size should not exceed 10M': "Faites glisser et déposez le fichier ici ou cliquez pour télécharger, la taille du fichier ne doit pas dépasser 10M",
