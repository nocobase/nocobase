export default {
  ...
  "New plugin": "新增插件",
  "Upgrade": "可供更新",
  "Dependencies check failed": "依赖检查失败",
  "More details": "更多详情",
  ...
  "If the compatibility check fails, you should change the dependent version to meet the version requirements.": "如果兼容性检查失败，你应该修改依赖版本以满足版本要求。",
  "Version range": "版本范围",
