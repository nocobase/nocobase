...
import { useCollectionManagerV2, useCompile, useRecord } from '../..';
...
export const RolesResourcesActions = connect((props) => {
  ...
  const collection = cm.getCollection(roleCollection.collectionName);
  const collectionFields = cm.getCollectionFields(roleCollection.collectionName);
