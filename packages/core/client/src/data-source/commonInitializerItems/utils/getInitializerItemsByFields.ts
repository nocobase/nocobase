import { CollectionFieldsProps, CollectionFieldDefaultSchema, CollectionFieldDefaultInitializerItem } from "./type";
...
export function getInitializerItemsByFields(props: CollectionFieldsProps, fields: CollectionFieldOptions[], context: CollectionFieldContext) {
  const {
    block,
