...
// 表格操作配置
export const TreeActionInitializers = {
  ...
  items: [
          ...
          visible: function useVisible() {
            ...
            return (
              (collection.template !== 'view' &&
                ...
                collection.template !== 'external') ||
              collection?.writableView
            );
          },
        },
        {
    ...
    },
    {
      ...
      visible: function useVisible() {
        const collection = useCollection();
        return (collection.template !== 'view' && collection.template !== 'external') || collection?.writableView;
      },
    },
  ],
};
