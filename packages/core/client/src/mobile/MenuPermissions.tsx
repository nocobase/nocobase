...
export const MenuPermissions: React.FC<{ active: boolean }> = ({ active }) => {
          ...
          [
            ...
            },
            {
              ...
              render: (_, record: MenuItem) => {
                return (
                  <Checkbox
                    checked={IDList.includes(record.id)}
                    onChange={(value) => {
                      handleChange(value.target.checked, record);
                    }}
                  ></Checkbox>
                );
              },
...
export const MobileAllRoutesProvider: React.FC<{ children?: React.ReactNode; active?: boolean }> = ({
  children,
  active,
}) => {
  return (
    <MobileRoutesProvider action="list" manual={!active}>
