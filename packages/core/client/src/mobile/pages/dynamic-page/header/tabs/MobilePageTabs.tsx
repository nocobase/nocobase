...
export const MobilePageTabs: FC = () => {
  ...
  const { displayTabs: displayTabsSetting } = useMobilePage();
  const displayTabs = activeTabBarItem?.enableTabs === undefined ? displayTabsSetting : activeTabBarItem.enableTabs;
