...
describe('RichText edit mode sanitization', () => {
  ...
  it('sanitizes stored HTML before passing it to ReactQuill', async () => {
  ...
  it('preserves Delta values', async () => {
  ...
  it('does not normalize active editor feedback', async () => {
  ...
  it('sanitizes subsequent external values', async () => {
    ...
    act(() => form.setValuesIn('content', payload));
