    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        ...
        >
          ...
          >
            <div
              class="ant-color-picker-trigger css-dev-only-do-not-override-1dcofz2"
            >
              <div
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        ...
        >
          ...
          >
            <div
              class="ant-color-picker-trigger ant-color-picker-sm css-dev-only-do-not-override-1dcofz2 ant-color-picker-trigger-disabled"
            >
              <div
                class="ant-color-picker-color-block"
              >
