...
describe('CollectionSelect', () => {
  it('should works', async () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        <div
          class="css-dev-only-do-not-override-1dcofz2 ant-app"
          style="height: 100%;"
        >
          <div
          ...
          >
            <div
              class="css-1yh5po ant-formily-item ant-formily-item-layout-horizontal ant-formily-item-feedback-layout-loose ant-formily-item-label-align-right ant-formily-item-control-align-left css-dev-only-do-not-override-1dcofz2"
            >
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      class="ant-select ant-select-outlined css-dev-only-do-not-override-1dcofz2 ant-select-focused ant-select-single ant-select-show-arrow ant-select-show-search"
              ...
              >
                ...
                >
                  ...
                  >
                    <div>
                      <span
                        class="ant-tag css-dev-only-do-not-override-1dcofz2"
                      >
                        Users
                      </span>
                    </div>
