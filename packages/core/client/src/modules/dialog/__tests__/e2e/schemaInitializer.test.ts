...
test('dialog opened by the add new button', async ({ page, mockPage }) => {
...
test('dialog opened by the add record button', async ({ page, mockPage }) => {
  await mockPage(oneEmptyTableBlockWithActions).goto();
...
test('dialog opened by the view button', async ({ page, mockPage, mockRecord }) => {
...
test('dialog opened by the bulk edit button', async ({ page, mockPage }) => {
...
test('dialog opened by the association link', async ({ page, mockPage, mockRecord }) => {
...
test('dialog opened by the data picker', async ({ page, mockPage }) => {
