...
import { FormFieldGridModel, FormModel } from '../../../data-blocks/form';
...
export class FilterEditableFieldModel<T extends DefaultStructure = DefaultStructure> extends FieldModel<T> {
...
FilterEditableFieldModel.registerFlow({
