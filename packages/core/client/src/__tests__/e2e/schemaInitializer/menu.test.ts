...
test.describe('Menu', () => {
  ...
  test('sidebar', async ({ page, mockPage }) => {
    ...
    await page
      ...
      .click();
    await expect(
      page.getByText('page group side', {
        exact: true,
      }),
    ).toBeVisible();
