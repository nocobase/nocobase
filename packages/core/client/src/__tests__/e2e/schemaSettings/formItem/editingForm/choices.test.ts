  ...
  test('pattern', async ({ page, mockPage, mockRecord }) => {
    ...
    await testPattern({
      ...
      expectEasyReading: async () => {
        ...
        ).toHaveText(`checkboxGroup:${record.checkboxGroup.join('')}`, {
          ignoreCase: true,
        });
      },
    });
  ...
  test('pattern', async ({ page, mockPage, mockRecord }) => {
    ...
    await testPattern({
      ...
      expectEditable: async () => {
        ...
        ).toHaveText(`${record.multipleSelect.join('')}`, {
          ignoreCase: true,
        });
      },
      expectReadonly: async () => {
      ...
      expectEasyReading: async () => {
        ...
        ).toHaveText(`multipleSelect:${record.multipleSelect.join('')}`, {
          ignoreCase: true,
        });
      },
    });
  ...
  test('pattern', async ({ page, mockPage, mockRecord }) => {
    ...
    await testPattern({
      ...
      expectEasyReading: async () => {
        ...
        ).toHaveText(`radioGroup:${record.radioGroup}`, {
          ignoreCase: true,
        });
      },
    });
  ...
  test('pattern', async ({ page, mockPage, mockRecord }) => {
    ...
    await testPattern({
      ...
      expectEditable: async () => {
        ...
        ).toHaveText(record.singleSelect, {
          ignoreCase: true,
        });
      },
      expectReadonly: async () => {
      ...
      expectEasyReading: async () => {
        ...
        ).toHaveText(`singleSelect:${record.singleSelect}`, {
          ignoreCase: true,
        });
      },
    });
