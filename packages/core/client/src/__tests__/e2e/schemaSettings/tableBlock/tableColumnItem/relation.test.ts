import { expect, oneTableBlockWithAddNewAndViewAndEditAndRelationFields, test } from '@nocobase/test/client';
...
test.describe('many to one', () => {
  testSupportedOptions({
    ...
    template: oneTableBlockWithAddNewAndViewAndEditAndRelationFields,
  });
