...
test.describe('set default value', () => {
  ...
  test('subtable: basic fields', async ({ page, mockPage }) => {
    ...
    await page
      .getByRole('button', {
        name: 'designer-schema-settings-TableV2.Column-TableV2.Column.Designer-users',
      })
      .hover();
    await page
      .getByRole('menuitem', {
    ...
    await expect(
      page
        .getByRole('cell', {
          name: 'block-item-CollectionField-users-form-users.nickname-Nickname',
        })
        .getByRole('textbox'),
    ).toHaveValue('test default value');
    ...
    await expect(
      page
        .getByRole('cell', {
          name: 'block-item-CollectionField-users-form-users.username-Username',
        })
        .getByRole('textbox'),
    ).toHaveValue('test default value');
