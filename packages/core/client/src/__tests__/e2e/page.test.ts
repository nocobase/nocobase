...
test.describe('page tabs', () => {
  test('enable & disabled page tab', async ({ page, mockPage }) => {
    ...
    await page
      ...
      .click();
    await expect(
      page.getByRole('tab').locator('div').filter({
        hasText: 'Unnamed',
      }),
    ).toBeVisible();
    ...
    await page
      ...
      .getByLabel('designer-schema-settings-Page')
      .hover();
    await page
      .getByRole('menuitem', {
        name: 'Edit',
    ...
    await page
      ...
      .click();
    const tabMenuItem1 = await page.getByRole('tab').getByText('page tab', {
      exact: true,
    });
    ...
    await page
      .getByRole('tab', {
        name: 'page tab designer-drag-handler',
      })
    ...
    await page
      ...
      .click();
    await expect(
      page.getByRole('tab').getByText('page tab', {
        exact: true,
      }),
    ).not.toBeVisible();
    ...
    await page
      .getByRole('button', {
        name: 'designer-schema-settings-Page',
      })
      .hover();
    await page
      .getByRole('menuitem', {
