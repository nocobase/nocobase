...
interface GlobalThemeContextValueType {
  theme: ThemeConfig;
...
const GlobalThemeContext = createContext<GlobalThemeContextValueType>(null);

export const useGlobalTheme = () => {
  return React.useContext(GlobalThemeContext) || ({} as GlobalThemeContextValueType);
};
