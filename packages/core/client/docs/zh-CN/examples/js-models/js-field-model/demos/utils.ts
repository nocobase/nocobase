...
export async function registerJsFieldDemoModels(engine: any) {
  ...
  const all: Record<string, any> = {
    ...
    TableJSFieldItemModel: c.TableJSFieldItemModel,
    ...
    JSItemModel: c.JSItemModel,
    FormJSFieldItemModel: c.FormJSFieldItemModel,
    ...
    DetailsJSFieldItemModel: c.DetailsJSFieldItemModel,
