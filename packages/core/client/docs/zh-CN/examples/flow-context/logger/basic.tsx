...
class HelloModel extends FlowModel {
  render() {
    // this.context.logger.fatal('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    this.context.logger.debug('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    // this.context.logger.trace('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    // this.context.logger.error('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    // this.context.logger.info('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    // this.context.logger.warn('HelloModel rendered', { a: 'a' }); // 使用日志记录渲染事件
    return (
      <div>
