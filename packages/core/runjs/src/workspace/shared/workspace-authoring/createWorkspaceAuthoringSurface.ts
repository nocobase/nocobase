...
import type {
  PreparedRunJSAuthoringChangeSet as PreparedCodeAuthoringChangeSet,
  RunJSAuthoringDiagnostic as CodeAuthoringDiagnostic,
  RunJSAuthoringFile as CodeAuthoringFile,
  RunJSAuthoringSearchMatch as CodeAuthoringSearchMatch,
  RunJSAuthoringSearchOptions as CodeAuthoringSearchOptions,
  RunJSAuthoringSnapshot as CodeAuthoringSnapshot,
  RunJSAuthoringSurface as CodeAuthoringSurface,
