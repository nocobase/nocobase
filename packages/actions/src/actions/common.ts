 ...
 * @param next 
 */
export const list: ActionOptions = {
  parameterTypes: ['fields', 'filter', 'page'],
 ...
 * @param next 
 */
export const create: ActionOptions = {
  parameterTypes: ['fields', 'payload'],
  async handler(ctx: Context, next: Next) {
    const {
      associated,
      resourceField,
 ...
 * @param next 
 */
export const get: ActionOptions = {
  parameterTypes: ['fields', 'filter', 'page'],
  async handler(ctx: Context, next: Next) {
    const {
      associated,
 ...
 * @param next 
 */
export const update: ActionOptions = {
  parameterTypes: ['fields', 'payload'],
  async handler(ctx: Context, next: Next) {
    const {
      associated,
 ...
 * @param next 
 */
export const destroy: ActionOptions = {
 ...
 * @param next 
 */
export const sort: ActionOptions = {
